...
这些示例立即展示了“功能特定示例”中显示的 Accelerate 中的每个功能
...
* Ayaan Haque、Matthew Tancik、Alexei A. Efros、Aleksander Holynski、Angjoo Kanazawa：“Instruct-NeRF2NeRF：使用指令编辑 3D 场景”，2023 年； [arXiv:2303.12789](http://huggingface.co/papers/2303.12789)。
...
* 杨悦、姚文林、张宏明、王晓阳、于冬、陈建树：“Z-LaVI：视觉想象力推动的零样本语言求解器”，2022； [arXiv:2210.12261](http://huggingface.co/papers/2210.12261)。
...
* 陈浩宇、王志华、杨阳、孙奇林、马科德：“学习摄影图像的深层色差度量”，2023； [arXiv:2303.14964](http://huggingface.co/papers/2303.14964)。
...
* Hila Chefer、Yuval Alaluf、Yael Vinker、Lior Wolf、Daniel Cohen-Or：“参与和激励：文本到图像扩散模型的基于注意力的语义指导”，2023 年； [arXiv:2301.13826](http://huggingface.co/papers/2301.13826)。
...
* 彭宝林、Michel Galley、何鹏程、Chris Brockett、Lars Liden、Elnaz Nouri、周宇、Bill Dolan、高剑峰：“GODEL：目标导向对话的大规模预训练”，2022 年； [arXiv:2206.11309](http://huggingface.co/papers/2206.11309)。
* Egil Rønningstad、Erik Velldal、Lilja Øvrelid：“实体级情感分析 (ELSA)：探索性任务调查”，2023 年，第 29 届国际计算语言学会议论文集，2022 年，第 6773-6783 页； [arXiv:2304.14241](http://huggingface.co/papers/2304.14241)。
