...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/dataclasses.py#L56)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/dataclasses.py#L286)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/dataclasses.py#L426)
...
```python
huggingface_hub.dataclasses.validated_field(validator: list[collections.abc.Callable[[typing.Any], None]] | collections.abc.Callable[[typing.Any], None], default: typing.Any = <dataclasses._MISSING_TYPE object at 0x7fa3cec496c0>, default_factory: typing.Any = <dataclasses._MISSING_TYPE object at 0x7fa3cec496c0>, init: bool = True, repr: bool = True, hash: bool | None = None, compare: bool = True, metadata: dict | None = None, **kwargs: typing.Any)
```

[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/dataclasses.py#L383)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/errors.py#L528)

严格数据类的基本异常。

#### Huggingface_hub.errors.StrictDataclassDefinitionError[[huggingface_hub.errors.StrictDataclassDefinitionError]]

[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/errors.py#L532)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/errors.py#L536)
...
### 警告
https://huggingface.co/docs/huggingface_hub/v1.32.0/package_reference/cli.md