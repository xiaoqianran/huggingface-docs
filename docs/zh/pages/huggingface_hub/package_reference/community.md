...
查看[HfApi](/docs/huggingface_hub/v1.31.0.rc0/en/package_reference/hf_api#huggingface_hub.HfApi)文档页面以获取启用方法的参考
...
events (`list` of [DiscussionEvent](/docs/huggingface_hub/v1.31.0.rc0/en/package_reference/community#huggingface_hub.DiscussionEvent)) ：此讨论或 Pull 请求中的 `DiscussionEvents` 列表。
...
[Discussion](/docs/huggingface_hub/v1.31.0.rc0/en/package_reference/community#huggingface_hub.Discussion) 的子类。
...
[DiscussionEvent](/docs/huggingface_hub/v1.31.0.rc0/en/package_reference/community#huggingface_hub.DiscussionEvent) 的子类。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.31.0.rc0/src/huggingface_hub/community.py#L298)**参数：**
