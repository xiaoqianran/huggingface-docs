...
`RepoCard`对象是[ModelCard](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.ModelCard)、[DatasetCard](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.DatasetCard)和`SpaceCard`的父类。
...
**返回：** [huggingface_hub.repocard.RepoCard](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.RepoCard)
...
使用该功能需要联网，所以只调用
内部由[huggingface_hub.repocard.RepoCard.push_to_hub()](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.RepoCard.push_to_hub)。
...
[CardData](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.CardData)对象是[ModelCardData](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.ModelCardData)和[DatasetCardData](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.DatasetCardData)的父类。
...
[CardData](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.CardData)是[ModelCardData](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.ModelCardData)和[DatasetCardData](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.DatasetCardData)的父类。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/repocard_data.py#L228)获取给定元数据键的值。
...
**返回：** [huggingface_hub.ModelCard](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.ModelCard)
...
**返回：** [huggingface_hub.DatasetCard](/docs/huggingface_hub/v1.32.0/en/package_reference/cards#huggingface_hub.DatasetCard)
