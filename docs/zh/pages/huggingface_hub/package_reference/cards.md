...
`RepoCard`对象是[ModelCard](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.ModelCard)、[DatasetCard](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.DatasetCard)和`SpaceCard`的父类。
...
**返回：** [huggingface_hub.repocard.RepoCard](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.RepoCard)
...
使用该功能需要联网，所以只调用
内部由[huggingface_hub.repocard.RepoCard.push_to_hub()](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.RepoCard.push_to_hub)。
...
[CardData](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.CardData)对象是[ModelCardData](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.ModelCardData)和[DatasetCardData](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.DatasetCardData)的父类。
...
[CardData](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.CardData)是[ModelCardData](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.ModelCardData)和[DatasetCardData](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.DatasetCardData)的父类。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/repocard_data.py#L228)获取给定元数据键的值。
...
**返回：** [huggingface_hub.ModelCard](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.ModelCard)

具有指定卡片数据和内容的 ModelCard 实例
模板。

从模板初始化 ModelCard。默认情况下，它使用默认模板，可以在此处找到：
...
**返回：** [huggingface_hub.DatasetCard](/docs/huggingface_hub/v2.0.0/en/package_reference/cards#huggingface_hub.DatasetCard)

具有指定卡片数据和内容的 DatasetCard 实例
模板。

从模板初始化 DatasetCard。默认情况下，它使用默认模板，可以在此处找到：
