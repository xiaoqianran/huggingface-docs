...
以下是如何使用 [export_folder_as_dduf()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.export_folder_as_dduf) 导出包含扩散模型不同部分的文件夹：
...
为了获得更大的灵活性，您可以使用 [export_entries_as_dduf()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.export_entries_as_dduf) 并传递要包含在最终 DDUF 文件中的文件列表：
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_dduf.py#L160)
...
这是一个比 [export_folder_as_dduf()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.export_folder_as_dduf) 更低级别的帮助程序，在序列化数据时提供更大的灵活性。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_dduf.py#L249)
...
A在引擎盖下使用[export_entries_as_dduf()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.export_entries_as_dduf)。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_dduf.py#L91)
...
按文件名索引的[DDUFEntry](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.DDUFEntry)字典。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_dduf.py#L36)
...
有关如何读取 DDUF 文件，请参阅[read_dduf_file()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.read_dduf_file)。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_dduf.py#L58)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_dduf.py#L75)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/errors.py#L521)

与 DDUF 格式相关的错误的基本异常。

#### Huggingface_hub.errors.DDUFCorruptedFileError[[huggingface_hub.errors.DDUFCorruptedFileError]]

[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/errors.py#L525)

DDUF 文件损坏时抛出异常。

#### Huggingface_hub.errors.DDUFExportError[[huggingface_hub.errors.DDUFExportError]]

[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/errors.py#L529)

DDUF 导出期间错误的基本异常。#### Huggingface_hub.errors.DDUFInvalidEntryNameError[[huggingface_hub.errors.DDUFInvalidEntryNameError]]

[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/errors.py#L533)

当条目名称无效时抛出异常。

## 保存张量

`serialization`模块的主要助手将火炬`nn.Module`作为输入并将其保存到磁盘。它处理保存共享张量的逻辑（参见[safetensors explanation](https://huggingface.co/docs/safetensors/torch_shared_tensors)）以及将状态字典分割成分片的逻辑，在底层使用[split_torch_state_dict_into_shards()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.split_torch_state_dict_into_shards)。目前仅支持`torch`框架。

如果您想保存状态字典（例如层名称和相关张量之间的映射）而不是`nn.Module`，您可以使用[save_torch_state_dict()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.save_torch_state_dict)，它提供相同的功能。例如，如果您想在保存之前将自定义逻辑应用于状态字典，这非常有用。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L47)
...
另请参阅[save_torch_state_dict()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.save_torch_state_dict)以更灵活地保存状态字典。
...
[split_torch_state_dict_into_shards()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.split_torch_state_dict_into_shards) 在引擎盖下。如果`safe_serialization`是`True`，则分片保存为
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L141)
...
另请参阅[save_torch_model()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.save_torch_model)直接保存 PyTorch 模型。
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L302)
...
> [!提示]
> 要将模型状态字典保存到磁盘，请参阅[save_torch_state_dict()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.save_torch_state_dict)。这个助手使用
...
```python
huggingface_hub.split_state_dict_into_shards_factory(state_dict: dict, get_storage_size: Callable, filename_pattern: str, get_storage_id: Callable = <function <lambda> at 0x7f7714d99630>, max_shard_size: int | str = '5GB')
```

[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_base.py#L50)
...
加载助手支持 safetensors 或 pickle 格式的单文件和分片检查点。 [load_torch_model()](/docs/huggingface_hub/v2.0.0/en/package_reference/serialization#huggingface_hub.load_torch_model) 采用 `nn.Module` 和检查点路径（单个文件或目录）作为输入，并将权重加载到模型中。> [!警告]
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L375)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L633)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L878)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/serialization/_torch.py#L895)
...
### Mixins 和序列化方法
https://huggingface.co/docs/huggingface_hub/v2.0.0/package_reference/mixins.md