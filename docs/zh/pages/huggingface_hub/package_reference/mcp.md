...
我们还提供更高级别的[Agent](/docs/huggingface_hub/v2.0.0/en/package_reference/mcp#huggingface_hub.Agent)课程。这个“小代理”通过管理聊天循环和状态来简化会话代理的创建，充当[MCPClient](/docs/huggingface_hub/v2.0.0/en/package_reference/mcp#huggingface_hub.MCPClient)的包装器。
...
[ChatCompletionStreamOutput](/docs/huggingface_hub/v2.0.0/en/package_reference/inference_types#huggingface_hub.ChatCompletionStreamOutput) 块或 [ChatCompletionInputMessage](/docs/huggingface_hub/v2.0.0/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputMessage) 对象
...
简单代理的实现，这是一个构建在 [MCPClient](/docs/huggingface_hub/v2.0.0/en/package_reference/mcp#huggingface_hub.MCPClient) 之上的简单 while 循环。
