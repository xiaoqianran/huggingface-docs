...
## 大学构建、教授和发布人工智能的地方。
对于大学来说，是经过设计的。一次订阅即可为您的学生、教师和研究人员提供与世界领先的人工智能团队使用的相同工具：开放、可审核并由您的机构管理。

学术中心为大学提供了工具和生态系统，将开源人工智能置于学生学习、实验和构建的中心。
...
🔬 研究与出版
- 存储私人检查点和数据集，然后使用 DOI 发布最终工件。
- 将代码、数据和权重放在一起以获得可重现的结果。
- 在 Hugging Face 社区博客上展示作品。
