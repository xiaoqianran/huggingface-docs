...
TensorBoard 提供了用于跟踪和可视化指标以及可视化模型的工具。所有包含 TensorBoard 跟踪的存储库都有一个带有托管 TensorBoard 实例的自动选项卡，任何人都可以轻松查看它，而无需任何额外的努力！
...
Hub 自动检测 TensorBoard 痕迹（例如 `tfevents`）。将 TensorBoard 文件推送到 Hub 后，它们将自动启动一个实例。
