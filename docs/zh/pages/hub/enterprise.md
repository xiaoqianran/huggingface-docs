...
### 推理与计算学分|特色|免费|团队|企业 |企业增强版 |
| -------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------- | --------------------------------- | --------------------------------- |
|通过推理提供程序提供模型服务 | ✅ 付费 | ✅ 付费 | ✅ 付费 | ✅ 付费 |
|包含每月计算积分\* | ❌ | $2/座位/月 | $2/座位/月 | $2/座位/月 |
| [Usage & billing control](https://huggingface.co/docs/inference-providers/pricing#inference-providers-usage-breakdown) | ❌ | ✅ | ✅ | ✅ ||使用推理端点扩展部署 | ✅ 付费 | ✅ 付费 | ✅ 付费 | ✅ 付费 |
|计划中包含额外计算积分\* | ❌ | ❌（可批量购买）| ❌（可批量购买）|含 ACV 5% |

\* 计算积分可用于推理提供程序、推理端点、作业、空间升级、ZeroGPU 配额扩展。在对任何即用即付使用量进行计费之前，会自动应用包含的每月积分。

### 空间和工作|特色 |免费|团队|企业 |企业增强版 |
| -------------------------------------- | --------- | ----------- | ----------- | ---------------- |
...
† 包括每日配额；付费计划可以使用每 10 分钟 GPU 时间 1 美元的积分超出配额

### 回购规则、访问控制、可见性|特色 |                 免费|      团队|   企业 |      企业增强版 |
| -------------------------------------- | :----------------------------------: | :-------------: | :-------------: | :------------------------: |
...
|默认私人仓库 |                  ❌ |       ✅ |       ✅ |             ✅ |
|禁用公共存储库（组织范围）|                  ❌ |       ✅ |       ✅ |             ✅ |
| [Data residency](./storage-regions) |                  ❌ |       ✅ |       ✅ |             ✅ || Data Studio（私有数据集）|                  ❌ |       ✅ |       ✅ |             ✅ |
|门控组集合|                  ❌ |       ✅ |       ✅ |             ✅ |
...
| [Content access / policy controls](./enterprise-network-security) |  ❌ |     ❌ |     ❌ |       ✅ || [Network access controls](./enterprise-network-security) |  ❌ |     ❌ |     ❌ |       ✅ |
