...
- `UnslothTrainer` extends TRL's [SFTTrainer](https://huggingface.co/docs/trl/v1.12.0/en/sft_trainer#trl.SFTTrainer). Unsloth patches [compute_loss()](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer.compute_loss) and [training_step()](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer.training_step) to fix gradient accumulation in older Transformers versions.
...
### TensorRT-LLM
https://huggingface.co/docs/transformers/v5.17.0/community_integrations/tensorrt-llm.md
