...
3. [AutoTokenizer](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoTokenizer) or [AutoProcessor](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoProcessor) loads the tokenizer or processor files and runs during inference.
...
### MLX
https://huggingface.co/docs/transformers/v5.17.0/community_integrations/mlx.md
