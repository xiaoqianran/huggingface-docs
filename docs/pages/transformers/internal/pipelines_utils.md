...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L382)

Base interface for handling arguments for each [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/zero_shot_classification.py#L13)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L392)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L469)
...
**Returns:** [PipelineDataFormat](/docs/transformers/v5.17.0/en/internal/pipelines_utils#transformers.PipelineDataFormat)

The proper data format.

Creates an instance of the right subclass of [PipelineDataFormat](/docs/transformers/v5.17.0/en/internal/pipelines_utils#transformers.PipelineDataFormat) depending on `format`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L441)

**Parameters:**

data (`dict` or list of `dict`) : The data to store.

Save the provided data object with the representation for the current [PipelineDataFormat](/docs/transformers/v5.17.0/en/internal/pipelines_utils#transformers.PipelineDataFormat).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L451)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L505)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L535)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L549)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L580)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L591)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L620)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/pipelines/base.py#L365)
...
Raised by a [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) when handling __call__.

### Utilities for Trainer
https://huggingface.co/docs/transformers/v5.17.0/internal/trainer_utils.md
