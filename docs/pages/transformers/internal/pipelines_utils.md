...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L383)

Base interface for handling arguments for each [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/zero_shot_classification.py#L13)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L393)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L470)
...
**Returns:** [PipelineDataFormat](/docs/transformers/v5.15.0/en/internal/pipelines_utils#transformers.PipelineDataFormat)

The proper data format.

Creates an instance of the right subclass of [PipelineDataFormat](/docs/transformers/v5.15.0/en/internal/pipelines_utils#transformers.PipelineDataFormat) depending on `format`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L442)

**Parameters:**

data (`dict` or list of `dict`) : The data to store.

Save the provided data object with the representation for the current [PipelineDataFormat](/docs/transformers/v5.15.0/en/internal/pipelines_utils#transformers.PipelineDataFormat).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L452)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L506)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L536)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L550)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L581)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L592)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L621)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/pipelines/base.py#L366)
...
Raised by a [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline) when handling __call__.

### Utilities for Trainer
https://huggingface.co/docs/transformers/v5.15.0/internal/trainer_utils.md
