...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/time_series_utils.py#L179)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/time_series_utils.py#L164)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/time_series_utils.py#L193)
...
https://huggingface.co/docs/transformers/v5.17.0/internal/audio_utils.md
