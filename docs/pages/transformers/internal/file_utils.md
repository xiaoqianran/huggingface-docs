...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/generic.py#L567)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/generic.py#L579)

Possible values for the `padding` argument in [PreTrainedTokenizerBase.__call__()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__). Useful for tab-completion in an
IDE.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/generic.py#L590)

Possible values for the `return_tensors` argument in [PreTrainedTokenizerBase.__call__()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__). Useful for
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/doc.py#L38)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/doc.py#L46)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/doc.py#L82)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/doc.py#L969)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/doc.py#L1063)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/import_utils.py#L2395)

Module class that surfaces all objects but only performs associated imports when the objects are requested.

### Utilities for image processors
https://huggingface.co/docs/transformers/v5.17.0/internal/image_processing_utils.md
