...
This page lists all the utility functions used by [generate()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin.generate).

## Generate Outputs[[transformers.generation.GenerateDecoderOnlyOutput]]

The output of [generate()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin.generate) is an instance of a subclass of
[ModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.utils.ModelOutput). This output is a data structure containing all the information returned
by [generate()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin.generate), but that can also be used as tuple or dictionary.
...
The `generation_output` object is a [GenerateDecoderOnlyOutput](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.generation.GenerateDecoderOnlyOutput), as we can
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/utils.py#L171)
...
past_key_values (`Cache`, *optional*, returned when `use_cache=True`) : Returns the model cache, used to speed up decoding. Different models have a different cache format, check the model's documentation. Usually, a [Cache](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.Cache) instance.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/utils.py#L207)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/utils.py#L255)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/utils.py#L299)
...
A [LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) can be used to modify the prediction scores of a language model head for
generation.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2179)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) enforcing alternated generation between the two codebooks of Bark.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2208)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2115)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) for classifier free guidance (CFG). The scores are split over the batch dimension,
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2163)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1142)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that works similarly to [NoRepeatNGramLogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.NoRepeatNGramLogitsProcessor), but applied exclusively to prevent
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1191)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L416)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that works similarly to [RepetitionPenaltyLogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.RepetitionPenaltyLogitsProcessor), but with an *inverse* penalty
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L462)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L868)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that performs epsilon-sampling, i.e. restricting to tokens with `prob >= epsilon`. Takes the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L923)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L937)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that performs eta-sampling, a technique to filter out tokens with probabilities below a dynamic
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1006)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1678)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that exponentially increases the score of the `eos_token_id` after `start_index` has been
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1764)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1556)

**Parameters:**

bos_token_id (`int`) : The id of the token to force as the first generated token.

[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that enforces the specified token as the first generated token. Used with encoder-decoder
models.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1591)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1601)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that enforces the specified token as the last generated token when `max_length` is reached.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1647)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1657)

[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that removes all `nan` and `inf` values to avoid the generation method to fail. Note that using
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1666)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1779)

[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) for normalizing the scores using log-softmax. It's important to normalize
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1810)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L49)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L56)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L63)

This class can be used to create a list of [LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) to subsequently process a `scores` input tensor.
This class inherits from list and adds a specific *__call__* method to apply each [LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) to the
inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L101)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) enforcing a min-length by setting EOS probability to 0. Note that, for decoder-only models
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L154)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L164)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) enforcing a min-length of new tokens by setting EOS (End-Of-Sequence) token probability to 0.
Contrarily to [MinLengthLogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.MinLengthLogitsProcessor), this processor ignores the prompt.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L226)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L704)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that performs min-p, i.e. keeps all tokens that are above a minimum probability, scaled by the
...
Often used together with [TemperatureLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TemperatureLogitsWarper). Used as an alternative to [TopPLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TopPLogitsWarper) and
[TopKLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TopKLogitsWarper).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L761)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1395)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that enforces that specified sequences will never be selected.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1287)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1073)
...
avoiding repetitions of word sequences provides a more diverse output. This [LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) enforces no
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1120)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1484)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that enforces constrained generation and is useful for prefix-conditioned constrained
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1535)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L306)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that prevents the repetition of previous tokens through a penalty. This penalty is applied at
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L372)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1211)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that applies an additive bias on sequences. The bias is applied to the last token of a sequence
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1816)

[SuppressTokensAtBeginLogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.SuppressTokensAtBeginLogitsProcessor) suppresses a list of tokens as soon as the `generate` function starts
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1858)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1869)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1901)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2562)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2700)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L238)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) for temperature (exponential scaling output probability distribution), which effectively means
that it can control the randomness of the predicted tokens. Often used together with [TopPLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TopPLogitsWarper) and
[TopKLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TopKLogitsWarper).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L300)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L598)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that implements Top-H sampling, a decoding method which adaptively selects a subset of
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L649)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L542)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that performs top-k, i.e. restricting to the k highest probability elements. Often used
together with [TemperatureLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TemperatureLogitsWarper) and [TopPLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TopPLogitsWarper).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L589)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L473)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that performs top-p, i.e. restricting to top tokens summing to prob_cut_off <= prob_cut_off.
Often used together with [TemperatureLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TemperatureLogitsWarper) and [TopKLogitsWarper](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.TopKLogitsWarper).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L526)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L780)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that performs typical decoding. Inspired on how humans use language, it prioritizes tokens
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L844)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2224)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2330)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1909)
...
[LogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.LogitsProcessor) that modifies the logits for the generation of timestamps in the transcription. When the input
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L1999)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2389)
...
The text generated by this `LogitsProcessor` can be detected using `WatermarkDetector`. See [__call__()](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.WatermarkDetector.__call__) for details,
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/logits_process.py#L2511)
...
A [StoppingCriteria](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.StoppingCriteria) can be used to change when to stop generation (other than EOS token). Please note that this is exclusively available to our PyTorch implementations.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L48)
...
```python
__call__(input_ids: LongTensor, scores: tuple[torch.FloatTensor] | None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L55)
...
scores (`tuple(torch.FloatTensor)`) : Prediction scores of a language modeling head, as a tuple with one tensor per generation step, each of shape `(batch_size, config.vocab_size)`. These can be scores for each vocabulary token before SoftMax or scores for each vocabulary token after SoftMax. If this stopping criteria depends on the `scores` input, make sure you pass `return_dict_in_generate=True, output_scores=True` to `generate`, otherwise `None` is passed.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L618)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L619)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L62)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L78)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L93)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L118)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L481)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L543)
...
```python
__call__(input_ids: LongTensor, scores: tuple[torch.FloatTensor] | None, new_token_length: int = 1, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/stopping_criteria.py#L560)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L42)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L114)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L128)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L80)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L157)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L209)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L226)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L289)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L314)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L403)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L398)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/streamers.py#L376)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L56)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L64)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L61)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L67)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L88)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L101)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L53)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L114)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L129)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L123)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L166)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L198)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L400)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L457)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L419)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L506)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L527)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L781)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L733)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L836)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1283)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1370)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1469)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1506)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1576)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1530)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1613)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1618)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1623)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1633)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1638)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1756)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1848)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1903)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L1966)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L2084)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L2090)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L2076)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L2051)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L2047)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/cache_utils.py#L2061)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L1453)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L71)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L191)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L243)
...
This is the configuration class to store the configuration of a [BayesianDetectorModel](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.BayesianDetectorModel). It is used to
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L350)

**Parameters:**

config ([BayesianDetectorConfig](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.BayesianDetectorConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L439)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L1531)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L483)

**Parameters:**

detector_module ([BayesianDetectorModel](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.BayesianDetectorModel)) : Bayesian detector module object initialized with parameters. Check https://github.com/huggingface/transformers-research-projects/tree/main/synthid_text for usage.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/watermarking.py#L530)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L1621)
...
### Importing utilities
https://huggingface.co/docs/transformers/v5.17.0/internal/import_utils.md
