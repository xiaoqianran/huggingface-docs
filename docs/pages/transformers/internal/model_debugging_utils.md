...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/model_debugging_utils.py#L391)
...
https://huggingface.co/docs/transformers/v5.17.0/internal/modeling_utils.md
