...
Load a VPTQ quantized model with [from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained).
...
### Overview
https://huggingface.co/docs/transformers/v5.17.0/quantization/overview.md
