...
Load an AQLM-quantized model with [from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained).
...
### NVFP4
https://huggingface.co/docs/transformers/v5.17.0/quantization/nvfp4.md
