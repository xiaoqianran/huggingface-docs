...
Create a [HiggsConfig](/docs/transformers/v5.17.0/en/main_classes/quantization#transformers.HiggsConfig) with the number of bits to quantize a model to.
...
### torchao
https://huggingface.co/docs/transformers/v5.17.0/quantization/torchao.md
