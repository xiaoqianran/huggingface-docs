...
1. Mapping all tokens to their corresponding word with the [word_ids](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.BatchEncoding.word_ids) method.
...
You're ready to start training your model now! Load DistilBERT with [AutoModelForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModelForTokenClassification) along with the number of expected labels, and the label mappings:
...
The simplest way to try out your finetuned model for inference is to use it in a [pipeline()](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.pipeline). Instantiate a `pipeline` for NER with your model, and pass your text to it:
...
### Mask generation
https://huggingface.co/docs/transformers/v5.17.0/tasks/mask_generation.md
