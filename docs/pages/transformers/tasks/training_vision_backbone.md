...
Initialize the [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) and set up [TrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments) for model convergence. Pass datasets, data collator, arguments, and model to `Trainer` to start training.
...
https://huggingface.co/docs/transformers/v5.17.0/tasks/zero_shot_object_detection.md
