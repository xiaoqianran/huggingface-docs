...
The example script downloads and preprocesses a dataset, and then fine-tunes it with [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) with a supported model architecture.
...
https://huggingface.co/docs/transformers/v5.17.0/chat_content_patterns.md
