...
The `v1/chat/completions` API is based on the [Chat Completions API](https://platform.openai.com/docs/api-reference/chat). It supports text, image, audio, and video requests for LLMs, VLMs, and multimodal models. Use it with `curl`, the [InferenceClient](https://huggingface.co/docs/huggingface_hub/v1.30.0/en/package_reference/inference_client#huggingface_hub.InferenceClient), or the [OpenAI](https://platform.openai.com/docs/quickstart) client.
...
The [InferenceClient](https://huggingface.co/docs/huggingface_hub/v1.30.0/en/package_reference/inference_client#huggingface_hub.InferenceClient) returns a printed string.
...
Customize generation by passing [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) parameters to the `extra_body` argument in [create](https://platform.openai.com/docs/api-reference/responses/create).
...
### Cursor
https://huggingface.co/docs/transformers/v5.17.0/serve-cli/cursor.md
