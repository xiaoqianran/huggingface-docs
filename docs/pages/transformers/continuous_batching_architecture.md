...
Set the scheduler in [ContinuousBatchingConfig](/docs/transformers/v5.17.0/en/main_classes/continuous_batching#transformers.ContinuousBatchingConfig).
...
You can pin the values explicitly in [ContinuousBatchingConfig](/docs/transformers/v5.17.0/en/main_classes/continuous_batching#transformers.ContinuousBatchingConfig).
...
### DeepSpeed ZeRO
https://huggingface.co/docs/transformers/v5.17.0/deepspeed.md
