...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/monkey_patching.py#L85)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/monkey_patching.py#L158)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/monkey_patching.py#L209)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/monkey_patching.py#L198)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/monkey_patching.py#L233)
...
### Experts backends
https://huggingface.co/docs/transformers/v5.17.0/experts_interface.md
