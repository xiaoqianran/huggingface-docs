...
- PyTorch [generate()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin.generate) is implemented in [GenerationMixin](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin).

You can parameterize the generate method with a [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) class instance. Please refer to this class for the complete list of generation parameters, which control the behavior of the generation method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L100)
...
cache_implementation (`str`, *optional*) : Name of the cache class that will be instantiated in `generate`, for faster decoding. Possible values are:  - `"dynamic"`: [DynamicCache](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.DynamicCache) - `"static"`: [StaticCache](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.StaticCache) - `"offloaded"`: `DynamicCache(offloaded=True)` - `"offloaded_static"`: `StaticCache(offloaded=True)` - `"quantized"`: [QuantizedCache](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.QuantizedCache)  If none is specified, we will use the default cache for the model (which is often [DynamicCache](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.DynamicCache)). See our [cache documentation](https://huggingface.co/docs/transformers/en/kv_cache) for further information.
...
bad_words_ids (`list[list[int]]`, *optional*) : List of list of token ids that are not allowed to be generated. Check [NoBadWordsLogitsProcessor](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.NoBadWordsLogitsProcessor) for further documentation and examples.
...
return_dict_in_generate (`bool`) : Whether or not to return a [ModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.utils.ModelOutput), as opposed to returning exclusively the generated sequence. This flag must be set to `True` to return the generation cache (when `use_cache` is `True`) or optional outputs (see flags starting with `output_`)
...
**Returns:** [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig)

The configuration object instantiated from this pretrained model.

Instantiate a [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) from a generation configuration file.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L1283)
...
Instantiates a [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) from a [PreTrainedConfig](/docs/transformers/v5.17.0/en/main_classes/configuration#transformers.PreTrainedConfig). This function is useful to convert legacy
[PreTrainedConfig](/docs/transformers/v5.17.0/en/main_classes/configuration#transformers.PreTrainedConfig) objects, which may contain generation parameters, into a stand-alone [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L890)
...
[from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig.from_pretrained) class method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L1333)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L647)
...
Validates the values of the attributes of the [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) instance. Raises exceptions in the presence
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L534)
...
Returns the generation mode triggered by the [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) instance.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/utils.py#L482)
...
The class exposes [generate()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin.generate), which can be used for:
- *greedy decoding* if `num_beams=1` and `do_sample=False`
- *multinomial sampling* if `num_beams=1` and `do_sample=True`
- *beam-search decoding* if `num_beams>1` and `do_sample=False`
- *beam-search multinomial sampling* if `num_beams>1` and `do_sample=True`
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/utils.py#L1562)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L1118)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L1196)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L1189)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L1130)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L574)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L782)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L840)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L875)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L773)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L884)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L695)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L758)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L921)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L908)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L699)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L708)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L651)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/continuous_api.py#L685)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L22)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L61)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L99)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L81)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L88)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L77)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L116)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L49)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L66)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L94)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L331)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/continuous_batching/scheduler.py#L380)
...
### Video processor
https://huggingface.co/docs/transformers/v5.17.0/main_classes/video_processor.md
