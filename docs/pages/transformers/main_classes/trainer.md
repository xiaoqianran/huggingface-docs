...
The [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) class provides an API for feature-complete training in PyTorch, and it supports distributed training on multiple GPUs/TPUs, mixed precision for [NVIDIA GPUs](https://nvidia.github.io/apex/), [AMD GPUs](https://rocm.docs.amd.com/en/latest/rocm.html), and [`torch.amp`](https://pytorch.org/docs/stable/amp.html) for PyTorch. [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) goes hand-in-hand with the [TrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments) class, which offers a wide range of options to customize how a model is trained. Together, these two classes provide a complete training API.

[Seq2SeqTrainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Seq2SeqTrainer) and [Seq2SeqTrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Seq2SeqTrainingArguments) inherit from the [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) and [TrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments) classes and they're adapted for training models for sequence-to-sequence tasks such as summarization or translation.

The [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) class is optimized for 🤗 Transformers models and can have surprising behaviors
when used with other models. When using it with your own model, make sure:

- your model always return tuples or subclasses of [ModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.utils.ModelOutput)
- your model can compute the loss if a `labels` argument is provided and that loss is returned as the first
  element of the tuple (if your model returns tuples)
- your model can accept multiple label arguments (use `label_names` in [TrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments) to indicate their name to the [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer)) but none of them should be named `"label"`
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L259)

**Parameters:**

model ([PreTrainedModel](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel) or `torch.nn.Module`, *optional*) : The model to train, evaluate or use for predictions. If not provided, a `model_init` must be passed.    [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) is optimized to work with the [PreTrainedModel](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel) provided by the library. You can still use your own models defined as `torch.nn.Module` as long as they work the same way as the 🤗 Transformers models.   

args ([TrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments), *optional*) : The arguments to tweak for training. Will default to a basic instance of [TrainingArguments](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments) with the `output_dir` set to a directory named *tmp_trainer* in the current directory if not provided.

data_collator (`DataCollator`, *optional*) : The function to use to form a batch from a list of elements of `train_dataset` or `eval_dataset`. Will default to [default_data_collator()](/docs/transformers/v5.17.0/en/main_classes/data_collator#transformers.default_data_collator) if no `processing_class` is provided, an instance of [DataCollatorWithPadding](/docs/transformers/v5.17.0/en/main_classes/data_collator#transformers.DataCollatorWithPadding) otherwise if the processing_class is a feature extractor or tokenizer.
...
- **model** -- Always points to the core model. If using a transformers model, it will be a [PreTrainedModel](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel)
  subclass.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4528)

**Parameters:**

callback (`type` or [`~transformers.TrainerCallback]`) : A [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) class or an instance of a [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback). In the first case, will instantiate a member of that class.

Add a callback to the current list of [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2149)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4419)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2048)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2137)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L774)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4103)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1229)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1218)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1305)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2688)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2787)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4064)
...
For models that inherit from [PreTrainedModel](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel), uses that method to compute the number of floating point
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2207)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2508)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1366)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L904)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1305)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1297)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1335)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1315)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2500)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L943)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2482)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2516)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L884)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4338)
...
To use this method, you need to have provided a `model_init` when initializing your [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer): we need to
reinitialize the model at each new run. This is incompatible with the `optimizers` argument, so you need to
subclass [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) and override the method [create_optimizer_and_scheduler()](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer.create_optimizer_and_scheduler) for custom
optimizer/scheduler.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4085)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4568)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4575)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4029)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1153)
...
Note that this tracker doesn't account for memory allocations outside of [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer)'s `__init__`, `train`,
...
This also means that if any other tool that is used along the [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) calls
`torch.cuda.reset_peak_memory_stats`, the gpu peak memory stats could be invalid. And the [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer) will disrupt
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1126)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L961)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4539)

**Parameters:**

callback (`type` or [`~transformers.TrainerCallback]`) : A [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) class or an instance of a [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback). In the first case, will pop the first member of that class found in the list of callbacks.

**Returns:** [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback)

The callback removed, if found.

Remove a callback from the current list of [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) and returns it.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2994)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L3055)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4177)
...
kwargs (`dict[str, Any]`, *optional*) : Additional keyword arguments passed along to [create_model_card()](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer.create_model_card).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4555)

**Parameters:**

callback (`type` or [`~transformers.TrainerCallback]`) : A [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) class or an instance of a [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback). In the first case, will remove the first member of that class found in the list of callbacks.

Remove a callback from the current list of [TrainerCallback](/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1244)
...
To understand the metrics please read the docstring of [log_metrics()](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer.log_metrics). The only difference is that raw
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L3930)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_pt_utils.py#L1283)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L2412)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L4053)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1408)

**Parameters:**

resume_from_checkpoint (`str` or `bool`, *optional*) : If a `str`, local path to a saved checkpoint as saved by a previous instance of [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer). If a `bool` and equals `True`, load the last checkpoint in *args.output_dir* as saved by a previous instance of [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer). If present, training will resume from the model/optimizer/scheduler states loaded here.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer.py#L1975)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_seq2seq.py#L55)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_seq2seq.py#L139)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/trainer_seq2seq.py#L195)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L180)
...
lr_scheduler_type (`str` or [SchedulerType](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.SchedulerType), *optional*, defaults to `"linear"`) : The learning rate scheduler type to use. See [SchedulerType](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.SchedulerType) for all possible values. Common choices: - "linear" = [get_linear_schedule_with_warmup()](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.get_linear_schedule_with_warmup) - "cosine" = [get_cosine_schedule_with_warmup()](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.get_cosine_schedule_with_warmup) - "constant" =  [get_constant_schedule()](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.get_constant_schedule) - "constant_with_warmup" = [get_constant_schedule_with_warmup()](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.get_constant_schedule_with_warmup)
...
gradient_checkpointing_kwargs (`dict`, *optional*, defaults to `None`) : Keyword arguments passed to `gradient_checkpointing_enable()`. `every_n_layers` checkpoints only every n-th decoder layer instead of all of them; `1` is the usual all-or-nothing behavior, and larger values give some memory back to speed. `offload` holds the saved activations in pinned host memory, which frees `layers x sequence x hidden` bytes of device memory and makes the step slower. Any other key is forwarded to `torch.utils.checkpoint.checkpoint`.
...
eval_strategy (`str` or [IntervalStrategy](/docs/transformers/v5.17.0/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"no"`) : When to run evaluation. Options: - `"no"`: No evaluation during training - `"steps"`: Evaluate every `eval_steps` - `"epoch"`: Evaluate at the end of each epoch
...
train_sampling_strategy (`str`, *optional*, defaults to `"random"`) : The sampler to use for the training dataloader. Possible values are:  - `"random"`: Uses `RandomSampler` (default). - `"sequential"`: Uses `SequentialSampler`. - `"group_by_length"`: Uses `LengthGroupedSampler` to group samples of roughly the same length together (to minimize padding and be more efficient). - `"batch_rebalance"`: Uses `BatchRebalanceSampler` to balance padded-token cost across devices and gradient-accumulation steps within each effective batch, reducing padding waste and peak memory vs `"group_by_length"`. Currently only supported for data-parallel training (tensor parallelism is not yet supported).  Note: When using an `IterableDataset`, this argument is ignored.

length_column_name (`str`, *optional*, defaults to `"length"`) : Column name for precomputed lengths. If the column exists, grouping by length will use these values rather than computing them on train startup. Ignored unless `train_sampling_strategy` is `"group_by_length"`or `"batch_rebalance"` and the dataset is an instance of `Dataset`.
...
[HfArgumentParser](/docs/transformers/v5.17.0/en/internal/trainer_utils#transformers.HfArgumentParser) can turn this class into
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2033)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2122)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2071)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2653)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2270)

**Parameters:**

strategy (`str` or [IntervalStrategy](/docs/transformers/v5.17.0/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"no"`) : The evaluation strategy to adopt during training. Possible values are:  - `"no"`: No evaluation is done during training. - `"steps"`: Evaluation is done (and logged) every `steps`. - `"epoch"`: Evaluation is done at the end of each epoch.  Setting a `strategy` different from `"no"` will set `self.do_eval` to `True`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2412)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2610)

**Parameters:**

name (`str` or [SchedulerType](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.SchedulerType), *optional*, defaults to `"linear"`) : The scheduler type to use. See the documentation of [SchedulerType](/docs/transformers/v5.17.0/en/main_classes/optimizer_schedules#transformers.SchedulerType) for all possible values.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2559)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2487)
...
triggered (depending on your `self.save_strategy`). Calling [save_model()](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer.save_model) will also trigger a push.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2363)

**Parameters:**

strategy (`str` or [IntervalStrategy](/docs/transformers/v5.17.0/en/internal/trainer_utils#transformers.IntervalStrategy), *optional*, defaults to `"steps"`) : The checkpoint save strategy to adopt during training. Possible values are:  - `"no"`: No save is done during training. - `"epoch"`: Save is done at the end of each epoch. - `"steps"`: Save is done every `save_steps`. 
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2327)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2193)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2143)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2173)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args.py#L2179)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args_seq2seq.py#L29)
...
generation_config (`str` or `Path` or [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig), *optional*) : Allows to load a [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) from the `from_pretrained` method. This can be either:  - a string, the *model id* of a pretrained model configuration hosted inside a model repo on huggingface.co. - a path to a *directory* containing a configuration file saved using the [save_pretrained()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig.save_pretrained) method, e.g., `./my_model_directory/`. - a [GenerationConfig](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig) object.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/training_args_seq2seq.py#L84)

Serializes this instance while replace `Enum` by their values and `GenerationConfig` by dictionaries (for JSON
serialization support). It obfuscates the token values by removing their value.

### Generation
https://huggingface.co/docs/transformers/v5.17.0/main_classes/text_generation.md
