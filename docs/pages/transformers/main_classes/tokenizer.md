...
The base classes [PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend) and [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend)
implement the common methods for encoding string inputs in model inputs (see below) and instantiating/saving python and
"Fast" tokenizers either from a local file or directory or from a pretrained tokenizer provided by the library
(downloaded from HuggingFace's AWS S3 repository). They both rely on
[PreTrainedTokenizerBase](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase) that contains the common methods.

[PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend) and [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) thus implement the main
...
[BatchEncoding](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.BatchEncoding) holds the output of the
[PreTrainedTokenizerBase](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase)'s encoding methods (`__call__`,
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L400)
...
Inherits from [PreTrainedTokenizerBase](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L1209)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L1102)
...
In order to do that, please use the [resize_token_embeddings()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings) method.
...
[BertTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutlm#transformers.BertTokenizer) `cls_token` is already registered to be `'[CLS]'` and XLM's one is also registered to be
`'</s>'`).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L2989)
...
return_tensors (`str` or [TensorType](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.TensorType), *optional*) : If set, will return tensors of a particular framework. Has no effect if tokenize is `False`. Acceptable values are: - `'pt'`: Return PyTorch `torch.Tensor` objects. - `'np'`: Return NumPy `np.ndarray` objects.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L2853)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L2231)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L865)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L1298)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L488)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L969)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L602)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L1121)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L841)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L1362)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L625)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_python.py#L1231)

Truncates sequences according to the specified strategy.

## PreTrainedTokenizerFast[[transformers.TokenizersBackend]]

The [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) depends on the [tokenizers](https://huggingface.co/docs/tokenizers) library. The tokenizers obtained from the 🤗 tokenizers library can be
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L88)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L105)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L750)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L847)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L569)
...
Extends [save_pretrained()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained) with
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L897)

**Parameters:**

padding_strategy ([PaddingStrategy](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.utils.PaddingStrategy)) : The kind of padding that will be applied to the input

truncation_strategy ([TruncationStrategy](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy)) : The kind of truncation that will be applied to the input
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_tokenizers.py#L1193)
...
**Returns:** [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_sentencepiece.py#L45)
...
Inherits from [PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_sentencepiece.py#L232)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_sentencepiece.py#L104)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_sentencepiece.py#L237)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L195)
...
Holds the output of the [__call__()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__),
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L541)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L626)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L665)

**Parameters:**

tensor_type (`str` or [TensorType](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.TensorType), *optional*) : The type of tensors to use. If `str`, should be one of the values of the enum [TensorType](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.TensorType). If `None`, no modification is done.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L335)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L759)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L502)
...
**Returns:** [CharSpan](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.CharSpan)
...
Character spans are returned as a [CharSpan](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.CharSpan) with:
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L372)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L411)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L320)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L356)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L581)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/tokenization_utils_base.py#L449)
...
**Returns:** ([TokenSpan](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.TokenSpan), *optional*)
...
Token spans are returned as a [TokenSpan](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.TokenSpan) with:
...
### Continuous batching
https://huggingface.co/docs/transformers/v5.17.0/main_classes/continuous_batching.md
