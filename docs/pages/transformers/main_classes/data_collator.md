...
[DataCollatorForLanguageModeling](/docs/transformers/v5.17.0/en/main_classes/data_collator#transformers.DataCollatorForLanguageModeling)) also apply some random data augmentation (like random masking)
on the formed batch.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L71)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L95)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L191)

**Parameters:**

tokenizer ([PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend) or [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend)) : The tokenizer used for encoding the data.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L243)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L489)

**Parameters:**

tokenizer ([PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend) or [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend)) : The tokenizer used for encoding the data.

model ([PreTrainedModel](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel), *optional*) : The model that is being trained. If set and has the *prepare_decoder_input_ids_from_labels*, use it to prepare the *decoder_input_ids*  This is useful when using *label_smoothing* to avoid calculating loss twice.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L621)
...
BatchEncoding, with the `"special_tokens_mask"` key, as returned by a [PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend) or a
[PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) with the argument `return_special_tokens_mask=True`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L892)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L798)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L1021)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L1141)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L1267)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L1168)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L1366)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/data_collator.py#L422)
...
### Model outputs
https://huggingface.co/docs/transformers/v5.17.0/main_classes/output.md
