...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/generation/configuration_utils.py#L1674)
...
### Feature extractor
https://huggingface.co/docs/transformers/v5.17.0/main_classes/feature_extractor.md
