...
A backbone is a model used for feature extraction for higher level computer vision tasks such as object detection and image classification. Transformers provides an [AutoBackbone](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.AutoBackbone) class for initializing a Transformers backbone from pretrained model weights, and two utility classes:

* [BackboneMixin](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.BackboneMixin) enables initializing a backbone from Transformers or [timm](https://hf.co/docs/timm/index) and includes functions for returning the output features and indices.
* [BackboneConfigMixin](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.BackboneConfigMixin) sets the output features and indices of the backbone configuration.

[timm](https://hf.co/docs/timm/index) models are loaded with the [TimmBackbone](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.TimmBackbone) and [TimmBackboneConfig](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.TimmBackboneConfig) classes.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/auto/modeling_auto.py#L2523)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/backbone_utils.py#L192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/backbone_utils.py#L218)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/backbone_utils.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/backbone_utils.py#L38)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/backbone_utils.py#L147)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/backbone_utils.py#L74)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_backbone/modeling_timm_backbone.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_backbone/configuration_timm_backbone.py#L26)
...
### Quantization
https://huggingface.co/docs/transformers/v5.17.0/main_classes/quantization.md
