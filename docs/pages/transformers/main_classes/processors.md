...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L602)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L717)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L747)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L820)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L925)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L438)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L166)

**Parameters:**

add_special_tokens (`bool`, *optional*) : Whether or not to add special tokens when encoding the sequences.

padding (`bool`, `str` or [PaddingStrategy](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.utils.PaddingStrategy), *optional*) : Activates and controls padding.

truncation (`bool`, `str` or [TruncationStrategy](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy), *optional*) : Activates and controls truncation.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L235)
...
size (`dict[str, int]`, *optional*) : Resize using one of the supported size dictionaries. Pixel-area bounds use `{"min_pixels": int, "max_pixels": int}`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L309)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L386)
...
return_attention_mask (`bool`, *optional*) : Whether or not [__call__()](/docs/transformers/v5.17.0/en/model_doc/audio-spectrogram-transformer#transformers.ASTFeatureExtractor.__call__) should return `attention_mask`.

device (`str` or `torch.device`, *optional*) : The device to compute the audio features on (e.g. "cpu", "cuda"), only relevant for feature extractors that compute them with torch.
...
[DataProcessor](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.DataProcessor). The processor returns a list of
[InputExample](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputExample). These
[InputExample](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputExample) can be converted to
[InputFeatures](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputFeatures) in order to be fed to the model.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L78)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L95)

Gets a collection of [InputExample](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputExample) for the dev set.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L81)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L103)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L99)

Gets a collection of [InputExample](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputExample) for the test set.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L91)

Gets a collection of [InputExample](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputExample) for the train set.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L107)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L47)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L53)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/utils.py#L73)
...
[InputExample](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.InputExample).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/glue.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/squad.py#L433)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/squad.py#L521)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/squad.py#L466)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/squad.py#L499)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/data/processors/squad.py#L313)

**Parameters:**

examples : list of `SquadExample`

tokenizer : an instance of a child of [PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend)
...
### Configuration
https://huggingface.co/docs/transformers/v5.17.0/main_classes/configuration.md
