...
sure the input has mean of 0 and std of 0.5). [ASTFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/audio-spectrogram-transformer#transformers.ASTFeatureExtractor) takes care of this. Note that it uses the AudioSet
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/configuration_audio_spectrogram_transformer.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/feature_extraction_audio_spectrogram_transformer.py#L38)
...
return_attention_mask (`bool`, *optional*, defaults to `False`) : Whether or not [__call__()](/docs/transformers/v5.17.0/en/model_doc/audio-spectrogram-transformer#transformers.ASTFeatureExtractor.__call__) should return `attention_mask`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/feature_extraction_audio_spectrogram_transformer.py#L160)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/modeling_audio_spectrogram_transformer.py#L257)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/modeling_audio_spectrogram_transformer.py#L273)
...
elements depending on the configuration ([ASTConfig](/docs/transformers/v5.17.0/en/model_doc/audio-spectrogram-transformer#transformers.ASTConfig)) and inputs.

The [ASTModel](/docs/transformers/v5.17.0/en/model_doc/audio-spectrogram-transformer#transformers.ASTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/modeling_audio_spectrogram_transformer.py#L327)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/audio_spectrogram_transformer/modeling_audio_spectrogram_transformer.py#L340)
...
The [ASTForAudioClassification](/docs/transformers/v5.17.0/en/model_doc/audio-spectrogram-transformer#transformers.ASTForAudioClassification) forward method, overrides the `__call__` special method.
...
### dots.llm1
https://huggingface.co/docs/transformers/v5.17.0/model_doc/dots1.md
