...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite_swa/configuration_granite_swa.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite_swa/modeling_granite_swa.py#L384)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite_swa/modeling_granite_swa.py#L410)
...
elements depending on the configuration ([GraniteSWAConfig](/docs/transformers/v5.17.0/en/model_doc/granite_swa#transformers.GraniteSWAConfig)) and inputs.

The [GraniteSWAModel](/docs/transformers/v5.17.0/en/model_doc/granite_swa#transformers.GraniteSWAModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite_swa/modeling_granite_swa.py#L483)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite_swa/modeling_granite_swa.py#L498)
...
The [GraniteSWAForCausalLM](/docs/transformers/v5.17.0/en/model_doc/granite_swa#transformers.GraniteSWAForCausalLM) forward method, overrides the `__call__` special method.
...
### MetaCLIP 2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/metaclip_2.md
