...
The example below demonstrates how to detect privacy-sensitive tokens with [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModelForTokenClassification](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoModelForTokenClassification) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/openai_privacy_filter/configuration_openai_privacy_filter.py#L48)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/openai_privacy_filter/modeling_openai_privacy_filter.py#L439)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/openai_privacy_filter/modeling_openai_privacy_filter.py#L454)
...
elements depending on the configuration ([OpenAIPrivacyFilterConfig](/docs/transformers/v5.15.0/en/model_doc/openai_privacy_filter#transformers.OpenAIPrivacyFilterConfig)) and inputs.

The [OpenAIPrivacyFilterModel](/docs/transformers/v5.15.0/en/model_doc/openai_privacy_filter#transformers.OpenAIPrivacyFilterModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/openai_privacy_filter/modeling_openai_privacy_filter.py#L497)
...
### MusicGen
https://huggingface.co/docs/transformers/v5.15.0/model_doc/musicgen.md
