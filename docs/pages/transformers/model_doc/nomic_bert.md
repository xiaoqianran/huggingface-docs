...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/configuration_nomic_bert.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L371)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L398)
...
elements depending on the configuration ([NomicBertConfig](/docs/transformers/v5.17.0/en/model_doc/nomic_bert#transformers.NomicBertConfig)) and inputs.

The [NomicBertModel](/docs/transformers/v5.17.0/en/model_doc/nomic_bert#transformers.NomicBertModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L486)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L508)
...
The [NomicBertForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/nomic_bert#transformers.NomicBertForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L558)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L573)
...
The [NomicBertForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/nomic_bert#transformers.NomicBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L638)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nomic_bert/modeling_nomic_bert.py#L653)
...
The [NomicBertForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/nomic_bert#transformers.NomicBertForTokenClassification) forward method, overrides the `__call__` special method.
...
### ShieldGemma 2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/shieldgemma2.md
