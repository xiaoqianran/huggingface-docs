...
In cases where the language code is needed, the regular [__call__()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) will encode source text format
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/configuration_plbart.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/tokenization_plbart.py#L48)
...
Adapted from [RobertaTokenizer](/docs/transformers/v5.17.0/en/model_doc/roberta#transformers.RobertaTokenizer) and [XLNetTokenizer](/docs/transformers/v5.17.0/en/model_doc/xlnet#transformers.XLNetTokenizer). Based on
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L632)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L658)
...
elements depending on the configuration ([PLBartConfig](/docs/transformers/v5.17.0/en/model_doc/plbart#transformers.PLBartConfig)) and inputs.

The [PLBartModel](/docs/transformers/v5.17.0/en/model_doc/plbart#transformers.PLBartModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L743)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L774)
...
The [PLBartForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/plbart#transformers.PLBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L908)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L922)
...
The [PLBartForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/plbart#transformers.PLBartForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L1054)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/plbart/modeling_plbart.py#L1076)
...
The [PLBartForCausalLM](/docs/transformers/v5.17.0/en/model_doc/plbart#transformers.PLBartForCausalLM) forward method, overrides the `__call__` special method.
...
### UnivNet
https://huggingface.co/docs/transformers/v5.17.0/model_doc/univnet.md
