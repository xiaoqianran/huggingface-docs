...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xglm/configuration_xglm.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xglm/tokenization_xglm.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xglm/modeling_xglm.py#L358)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xglm/modeling_xglm.py#L389)
...
elements depending on the configuration ([XGLMConfig](/docs/transformers/v5.17.0/en/model_doc/xglm#transformers.XGLMConfig)) and inputs.

The [XGLMModel](/docs/transformers/v5.17.0/en/model_doc/xglm#transformers.XGLMModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xglm/modeling_xglm.py#L494)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xglm/modeling_xglm.py#L506)
...
The [XGLMForCausalLM](/docs/transformers/v5.17.0/en/model_doc/xglm#transformers.XGLMForCausalLM) forward method, overrides the `__call__` special method.
...
### EXAONE 4.5
https://huggingface.co/docs/transformers/v5.17.0/model_doc/exaone4_5.md
