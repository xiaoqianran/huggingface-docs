...
For training, the [ReformerModelWithLMHead](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerModelWithLMHead) should be used as follows:
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/configuration_reformer.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/tokenization_reformer.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L1931)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L1951)
...
num_hashes (`int`, *optional*) : The number of hashing rounds that should be performed during bucketing. Setting this argument overwrites the default defined in `config.num_hashes`.  For more information, see `num_hashes` in [ReformerConfig](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerConfig).
...
elements depending on the configuration ([ReformerConfig](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerConfig)) and inputs.

The [ReformerModel](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2150)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2176)
...
The [ReformerModelWithLMHead](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerModelWithLMHead) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2288)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2308)
...
The [ReformerForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2426)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2440)
...
The [ReformerForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2577)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/reformer/modeling_reformer.py#L2589)
...
The [ReformerForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/reformer#transformers.ReformerForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### Table Transformer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/table-transformer.md
