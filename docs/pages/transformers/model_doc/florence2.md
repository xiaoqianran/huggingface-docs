...
The example below demonstrates how to perform object detection with [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/configuration_florence2.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/configuration_florence2.py#L88)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/processing_florence2.py#L47)
...
[~CLIPImageProcessor](/docs/transformers/v5.15.0/en/model_doc/clip#transformers.CLIPImageProcessor) and [~BartTokenizer](/docs/transformers/v5.15.0/en/model_doc/roberta#transformers.RobertaTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L666)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L715)
...
elements depending on the configuration ([Florence2Config](/docs/transformers/v5.15.0/en/model_doc/florence2#transformers.Florence2Config)) and inputs.

The [Florence2Model](/docs/transformers/v5.15.0/en/model_doc/florence2#transformers.Florence2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L675)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L808)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L828)
...
The [Florence2ForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/florence2#transformers.Florence2ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L822)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L504)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/florence2/modeling_florence2.py#L551)

### RoBERTa
https://huggingface.co/docs/transformers/v5.15.0/model_doc/roberta.md
