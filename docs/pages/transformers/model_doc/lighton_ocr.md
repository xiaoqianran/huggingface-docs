...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/configuration_lighton_ocr.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/processing_lighton_ocr.py#L101)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/modeling_lighton_ocr.py#L158)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/modeling_lighton_ocr.py#L209)
...
elements depending on the configuration ([LightOnOcrConfig](/docs/transformers/v5.17.0/en/model_doc/lighton_ocr#transformers.LightOnOcrConfig)) and inputs.

The [LightOnOcrModel](/docs/transformers/v5.17.0/en/model_doc/lighton_ocr#transformers.LightOnOcrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/modeling_lighton_ocr.py#L168)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/modeling_lighton_ocr.py#L292)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/modeling_lighton_ocr.py#L310)
...
The [LightOnOcrForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/lighton_ocr#transformers.LightOnOcrForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lighton_ocr/modeling_lighton_ocr.py#L304)
...
### Florence-2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/florence2.md
