...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/configuration_gemma2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/modeling_gemma2.py#L381)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/modeling_gemma2.py#L400)
...
elements depending on the configuration ([Gemma2Config](/docs/transformers/v5.15.0/en/model_doc/gemma2#transformers.Gemma2Config)) and inputs.

The [Gemma2Model](/docs/transformers/v5.15.0/en/model_doc/gemma2#transformers.Gemma2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/modeling_gemma2.py#L466)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/modeling_gemma2.py#L481)
...
The [Gemma2ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/gemma2#transformers.Gemma2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/modeling_gemma2.py#L545)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gemma2/modeling_gemma2.py#L549)
...
### SeamlessM4T-v2
https://huggingface.co/docs/transformers/v5.15.0/model_doc/seamless_m4t_v2.md
