...
The example below demonstrates how to transcribe speech into text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/processing_moonshine_streaming.py#L37)
...
[MoonshineStreamingProcessor](/docs/transformers/v5.17.0/en/model_doc/moonshine_streaming#transformers.MoonshineStreamingProcessor) offers all the functionalities of `feature_extractor_class` and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/processing_moonshine_streaming.py#L74)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/configuration_moonshine_streaming.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/configuration_moonshine_streaming.py#L81)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/modeling_moonshine_streaming.py#L881)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/modeling_moonshine_streaming.py#L909)
...
elements depending on the configuration ([MoonshineStreamingConfig](/docs/transformers/v5.17.0/en/model_doc/moonshine_streaming#transformers.MoonshineStreamingConfig)) and inputs.

The [MoonshineStreamingModel](/docs/transformers/v5.17.0/en/model_doc/moonshine_streaming#transformers.MoonshineStreamingModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/modeling_moonshine_streaming.py#L1002)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine_streaming/modeling_moonshine_streaming.py#L1022)
...
The [MoonshineStreamingForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/moonshine_streaming#transformers.MoonshineStreamingForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### SigLIP2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/siglip2.md
