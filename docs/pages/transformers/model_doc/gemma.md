...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class, and from the command line.
...
- The original Gemma models support standard kv-caching used in many transformer-based language models. You can use the default [DynamicCache](/docs/transformers/v5.17.0/en/internal/generation_utils#transformers.DynamicCache) instance or a tuple of tensors for past key values during generation. This makes it compatible with typical autoregressive generation workflows.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/configuration_gemma.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/tokenization_gemma.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/modeling_gemma.py#L367)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/modeling_gemma.py#L386)
...
elements depending on the configuration ([GemmaConfig](/docs/transformers/v5.17.0/en/model_doc/gemma#transformers.GemmaConfig)) and inputs.

The [GemmaModel](/docs/transformers/v5.17.0/en/model_doc/gemma#transformers.GemmaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/modeling_gemma.py#L443)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/modeling_gemma.py#L458)
...
The [GemmaForCausalLM](/docs/transformers/v5.17.0/en/model_doc/gemma#transformers.GemmaForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/modeling_gemma.py#L517)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma/modeling_gemma.py#L521)
...
### MVP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mvp.md
