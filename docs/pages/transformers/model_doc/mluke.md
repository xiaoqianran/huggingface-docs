...
Note that mLUKE has its own tokenizer, [MLukeTokenizer](/docs/transformers/v5.17.0/en/model_doc/mluke#transformers.MLukeTokenizer). You can initialize it as follows:
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mluke/tokenization_mluke.py#L129)
...
Adapted from [XLMRobertaTokenizer](/docs/transformers/v5.17.0/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer) and [LukeTokenizer](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeTokenizer). Based on
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mluke/tokenization_mluke.py#L463)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mluke/tokenization_mluke.py#L1701)

Save only the entity vocabulary file. The tokenizer.json is saved by the parent TokenizersBackend.

### V-JEPA 2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vjepa2.md
