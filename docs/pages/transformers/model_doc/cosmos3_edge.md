...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/configuration_cosmos3_edge.py#L142)
...
defaults will yield a similar configuration to that of the [nvidia/Cosmos3-Edge](https://huggingface.co/nvidia/Cosmos3-Edge)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/configuration_cosmos3_edge.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/configuration_cosmos3_edge.py#L119)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/processing_cosmos3_edge.py#L33)
...
[~Cosmos3EdgeImageProcessor](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeImageProcessor), `~tokenizer_class`, and [~Cosmos3EdgeVideoProcessor](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeVideoProcessor) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/processing_utils.py#L1981)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/image_processing_cosmos3_edge.py#L85)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/image_processing_cosmos3_edge.py#L102)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/image_processing_pil_cosmos3_edge.py#L84)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/image_processing_pil_cosmos3_edge.py#L101)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/video_processing_cosmos3_edge.py#L90)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L768)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L1063)
...
elements depending on the configuration ([Cosmos3EdgeConfig](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeConfig)) and inputs.

The [Cosmos3EdgeModel](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L956)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L944)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L641)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L661)
...
The [Cosmos3EdgeTextModel](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L720)

**Parameters:**

config ([Cosmos3EdgeVisionConfig](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeVisionConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L732)
...
The [Cosmos3EdgeVisionModel](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L1128)

**Parameters:**

config ([Cosmos3EdgeForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeForConditionalGeneration)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.

The Cosmos3 Edge Model for token generation conditioned on other modalities (e.g. image-text-to-text generation).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L1166)
...
The [Cosmos3EdgeForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/cosmos3_edge#transformers.Cosmos3EdgeForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L1153)
...
>>> model = Cosmos3EdgeForConditionalGeneration.from_pretrained("nvidia/Cosmos3-Edge")
>>> processor = AutoProcessor.from_pretrained("nvidia/Cosmos3-Edge")
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_edge/modeling_cosmos3_edge.py#L1140)
...
### HuBERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/hubert.md
