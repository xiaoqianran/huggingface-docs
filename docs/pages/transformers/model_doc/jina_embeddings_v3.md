...
The example below demonstrates how to extract features (embeddings) with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/configuration_jina_embeddings_v3.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L354)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L381)
...
elements depending on the configuration ([JinaEmbeddingsV3Config](/docs/transformers/v5.17.0/en/model_doc/jina_embeddings_v3#transformers.JinaEmbeddingsV3Config)) and inputs.

The [JinaEmbeddingsV3Model](/docs/transformers/v5.17.0/en/model_doc/jina_embeddings_v3#transformers.JinaEmbeddingsV3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L462)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L483)
...
The [JinaEmbeddingsV3ForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/jina_embeddings_v3#transformers.JinaEmbeddingsV3ForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L566)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L578)
...
The [JinaEmbeddingsV3ForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/jina_embeddings_v3#transformers.JinaEmbeddingsV3ForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L651)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L666)
...
The [JinaEmbeddingsV3ForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/jina_embeddings_v3#transformers.JinaEmbeddingsV3ForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L722)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jina_embeddings_v3/modeling_jina_embeddings_v3.py#L733)
...
The [JinaEmbeddingsV3ForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/jina_embeddings_v3#transformers.JinaEmbeddingsV3ForQuestionAnswering) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vibevoice_acoustic_tokenizer.md
