...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoe_swa/configuration_granitemoe_swa.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoe_swa/modeling_granitemoe_swa.py#L495)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoe_swa/modeling_granitemoe_swa.py#L521)
...
elements depending on the configuration ([GraniteMoeSWAConfig](/docs/transformers/v5.17.0/en/model_doc/granitemoe_swa#transformers.GraniteMoeSWAConfig)) and inputs.

The [GraniteMoeSWAModel](/docs/transformers/v5.17.0/en/model_doc/granitemoe_swa#transformers.GraniteMoeSWAModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoe_swa/modeling_granitemoe_swa.py#L663)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoe_swa/modeling_granitemoe_swa.py#L682)
...
The [GraniteMoeSWAForCausalLM](/docs/transformers/v5.17.0/en/model_doc/granitemoe_swa#transformers.GraniteMoeSWAForCausalLM) forward method, overrides the `__call__` special method.
...
### Gemma 4 Assistant
https://huggingface.co/docs/transformers/v5.17.0/model_doc/gemma4_assistant.md
