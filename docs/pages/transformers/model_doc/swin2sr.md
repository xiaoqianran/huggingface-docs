...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/image_processing_swin2sr.py#L41)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/image_processing_swin2sr.py#L58)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/image_processing_pil_swin2sr.py#L42)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/image_processing_pil_swin2sr.py#L59)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/configuration_swin2sr.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/modeling_swin2sr.py#L710)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/modeling_swin2sr.py#L752)
...
elements depending on the configuration ([Swin2SRConfig](/docs/transformers/v5.17.0/en/model_doc/swin2sr#transformers.Swin2SRConfig)) and inputs.

The [Swin2SRModel](/docs/transformers/v5.17.0/en/model_doc/swin2sr#transformers.Swin2SRModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/modeling_swin2sr.py#L943)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/swin2sr/modeling_swin2sr.py#L970)
...
The [Swin2SRForImageSuperResolution](/docs/transformers/v5.17.0/en/model_doc/swin2sr#transformers.Swin2SRForImageSuperResolution) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/kimi_k25.md
