...
- This implementation is the same as [RobertaModel](/docs/transformers/v5.17.0/en/model_doc/roberta#transformers.RobertaModel) with the addition of entity embeddings as well
...
- LUKE treats entities as input tokens; therefore, it takes `entity_ids`, `entity_attention_mask`,
  ...
  [LukeTokenizer](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeTokenizer).
- [LukeTokenizer](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeTokenizer) takes `entities` and `entity_spans` (character-based start and end
...
- There are three head models for the former use case:
  ...
  - [LukeForEntityClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntityClassification), for tasks to classify a single entity in an input text such as
  ...
  - [LukeForEntityPairClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntityPairClassification), for tasks to classify the relationship between two entities
  ...
  - [LukeForEntitySpanClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntitySpanClassification), for tasks to classify the sequence of entity spans, such as
    named entity recognition (NER). This model places a linear head on top of the output entity representations. You
    can address NER using this model by inputting all possible entity spans in the text to the model.

  [LukeTokenizer](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeTokenizer) has a `task` argument, which enables you to easily create an input to these
...
- [A demo notebook on how to fine-tune [LukeForEntityPairClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntityPairClassification) for relation classification](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/LUKE)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/configuration_luke.py#L24)
...
entity_vocab_size (`int`, *optional*, defaults to 500000) : Entity vocabulary size of the LUKE model. Defines the number of different entities that can be represented by the `entity_ids` passed when calling [LukeModel](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/tokenization_luke.py#L131)
...
```python
__call__(text: str | list[str], text_pair: str | list[str] | None = None, entity_spans: list[tuple[int, int]] | list[list[tuple[int, int]]] | None = None, entity_spans_pair: list[tuple[int, int]] | list[list[tuple[int, int]]] | None = None, entities: list[str] | list[list[str]] | None = None, entities_pair: list[str] | list[list[str]] | None = None, add_special_tokens: bool = True, padding: bool | str | transformers.utils.generic.PaddingStrategy = False, truncation: bool | str | transformers.tokenization_utils_base.TruncationStrategy | None = None, max_length: int | None = None, max_entity_length: int | None = None, stride: int = 0, is_split_into_words: bool | None = False, pad_to_multiple_of: int | None = None, padding_side: str | None = None, return_tensors: str | transformers.utils.generic.TensorType | None = None, return_token_type_ids: bool | None = None, return_attention_mask: bool | None = None, return_overflowing_tokens: bool = False, return_special_tokens_mask: bool = False, return_offsets_mapping: bool = False, return_length: bool = False, verbose: bool = True, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/tokenization_luke.py#L425)
...
automatically.
padding (`bool`, `str` or [PaddingStrategy](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.utils.PaddingStrategy), *optional*, defaults to `False`):
...
- `False` or `'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of different
  lengths).
truncation (`bool`, `str` or [TruncationStrategy](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy), *optional*, defaults to `False`):
...
return_tensors (`str` or [TensorType](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.TensorType), *optional*):
...
This is only available on fast tokenizers inheriting from [PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend), if using
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L788)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L818)
...
elements depending on the configuration ([LukeConfig](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeConfig)) and inputs.

The [LukeModel](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1019)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1044)
...
The [LukeForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1166)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1179)
...
The [LukeForEntityClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntityClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1295)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1308)
...
The [LukeForEntityPairClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntityPairClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1429)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1442)
...
The [LukeForEntitySpanClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForEntitySpanClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1587)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1600)
...
The [LukeForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1934)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1947)
...
The [LukeForMultipleChoice](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForMultipleChoice) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1713)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1727)
...
The [LukeForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1816)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/luke/modeling_luke.py#L1828)
...
The [LukeForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/luke#transformers.LukeForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### FNet
https://huggingface.co/docs/transformers/v5.17.0/model_doc/fnet.md
