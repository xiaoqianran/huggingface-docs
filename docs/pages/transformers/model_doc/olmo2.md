...
- Load specific intermediate checkpoints by adding the `revision` parameter to [from_pretrained()](/docs/transformers/v5.17.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo2/configuration_olmo2.py#L35)
...
defaults will yield a similar configuration to that of the [allenai/OLMo-2-1124-7B](https://huggingface.co/allenai/OLMo-2-1124-7B)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo2/modeling_olmo2.py#L346)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo2/modeling_olmo2.py#L363)
...
elements depending on the configuration ([Olmo2Config](/docs/transformers/v5.17.0/en/model_doc/olmo2#transformers.Olmo2Config)) and inputs.

The [Olmo2Model](/docs/transformers/v5.17.0/en/model_doc/olmo2#transformers.Olmo2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo2/modeling_olmo2.py#L420)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo2/modeling_olmo2.py#L435)
...
The [Olmo2ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/olmo2#transformers.Olmo2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo2/modeling_olmo2.py#L494)
...
### GPTBigCode
https://huggingface.co/docs/transformers/v5.17.0/model_doc/gpt_bigcode.md
