...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/video_processing_videomt.py#L146)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/video_processing_videomt.py#L177)
...
Converts the output of [VideomtForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/videomt#transformers.VideomtForUniversalSegmentation) into semantic segmentation predictions.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/video_processing_videomt.py#L233)
...
Converts the output of [VideomtForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/videomt#transformers.VideomtForUniversalSegmentation) into instance segmentation predictions.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/video_processing_videomt.py#L304)
...
Converts the output of [VideomtForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/videomt#transformers.VideomtForUniversalSegmentation) into panoptic segmentation predictions.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/configuration_videomt.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/modeling_videomt.py#L934)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/modeling_videomt.py#L1054)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/videomt/modeling_videomt.py#L1113)
...
elements depending on the configuration ([VideomtConfig](/docs/transformers/v5.17.0/en/model_doc/videomt#transformers.VideomtConfig)) and inputs.

The [VideomtForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/videomt#transformers.VideomtForUniversalSegmentation) forward method, overrides the `__call__` special method.
...
### Conditional DETR
https://huggingface.co/docs/transformers/v5.17.0/model_doc/conditional_detr.md
