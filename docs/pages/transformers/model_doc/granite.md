...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granite/configuration_granite.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granite/modeling_granite.py#L360)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granite/modeling_granite.py#L378)
...
elements depending on the configuration ([GraniteConfig](/docs/transformers/v5.15.0/en/model_doc/granite#transformers.GraniteConfig)) and inputs.

The [GraniteModel](/docs/transformers/v5.15.0/en/model_doc/granite#transformers.GraniteModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granite/modeling_granite.py#L438)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granite/modeling_granite.py#L453)
...
The [GraniteForCausalLM](/docs/transformers/v5.15.0/en/model_doc/granite#transformers.GraniteForCausalLM) forward method, overrides the `__call__` special method.
...
### Reformer
https://huggingface.co/docs/transformers/v5.15.0/model_doc/reformer.md
