...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/configuration_pix2struct.py#L142)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/configuration_pix2struct.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/configuration_pix2struct.py#L87)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/processing_pix2struct.py#L47)
...
[~Pix2StructImageProcessor](/docs/transformers/v5.17.0/en/model_doc/pix2struct#transformers.Pix2StructImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/processing_pix2struct.py#L52)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/image_processing_pix2struct.py#L151)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/image_processing_pix2struct.py#L331)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/image_processing_pil_pix2struct.py#L163)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/image_processing_pil_pix2struct.py#L321)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/modeling_pix2struct.py#L926)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/modeling_pix2struct.py#L955)
...
elements depending on the configuration ([Pix2StructConfig](/docs/transformers/v5.17.0/en/model_doc/pix2struct#transformers.Pix2StructConfig)) and inputs.

The [Pix2StructTextModel](/docs/transformers/v5.17.0/en/model_doc/pix2struct#transformers.Pix2StructTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/modeling_pix2struct.py#L393)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/modeling_pix2struct.py#L415)
...
The [Pix2StructVisionModel](/docs/transformers/v5.17.0/en/model_doc/pix2struct#transformers.Pix2StructVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/modeling_pix2struct.py#L1147)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pix2struct/modeling_pix2struct.py#L1174)
...
The [Pix2StructForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/pix2struct#transformers.Pix2StructForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### DistilBERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/distilbert.md
