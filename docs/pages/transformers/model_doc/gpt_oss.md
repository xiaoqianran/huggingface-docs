...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/configuration_gpt_oss.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L422)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L439)
...
elements depending on the configuration ([GptOssConfig](/docs/transformers/v5.15.0/en/model_doc/gpt_oss#transformers.GptOssConfig)) and inputs.

The [GptOssModel](/docs/transformers/v5.15.0/en/model_doc/gpt_oss#transformers.GptOssModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L582)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L600)
...
The [GptOssForCausalLM](/docs/transformers/v5.15.0/en/model_doc/gpt_oss#transformers.GptOssForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L685)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L689)
...
### Depth Anything
https://huggingface.co/docs/transformers/v5.15.0/model_doc/depth_anything.md
