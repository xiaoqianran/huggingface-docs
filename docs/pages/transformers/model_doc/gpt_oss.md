...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/configuration_gpt_oss.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L422)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L439)
...
elements depending on the configuration ([GptOssConfig](/docs/transformers/v5.17.0/en/model_doc/gpt_oss#transformers.GptOssConfig)) and inputs.

The [GptOssModel](/docs/transformers/v5.17.0/en/model_doc/gpt_oss#transformers.GptOssModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L569)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L587)
...
The [GptOssForCausalLM](/docs/transformers/v5.17.0/en/model_doc/gpt_oss#transformers.GptOssForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L672)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L676)
...
### Depth Anything
https://huggingface.co/docs/transformers/v5.17.0/model_doc/depth_anything.md
