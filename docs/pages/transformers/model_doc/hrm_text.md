...
> not follow the `flash_attention_*` naming convention — is rejected by [HrmTextModel](/docs/transformers/v5.15.0/en/model_doc/hrm_text#transformers.HrmTextModel)
...
See [HrmTextModel.forward()](/docs/transformers/v5.15.0/en/model_doc/hrm_text#transformers.HrmTextModel.forward) for the accepted shape.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/hrm_text/configuration_hrm_text.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/hrm_text/modeling_hrm_text.py#L410)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/hrm_text/modeling_hrm_text.py#L434)
...
elements depending on the configuration ([HrmTextConfig](/docs/transformers/v5.15.0/en/model_doc/hrm_text#transformers.HrmTextConfig)) and inputs.

The [HrmTextModel](/docs/transformers/v5.15.0/en/model_doc/hrm_text#transformers.HrmTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/hrm_text/modeling_hrm_text.py#L548)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/hrm_text/modeling_hrm_text.py#L563)
...
The [HrmTextForCausalLM](/docs/transformers/v5.15.0/en/model_doc/hrm_text#transformers.HrmTextForCausalLM) forward method, overrides the `__call__` special method.
...
### GLM-4.6V
https://huggingface.co/docs/transformers/v5.15.0/model_doc/glm46v.md
