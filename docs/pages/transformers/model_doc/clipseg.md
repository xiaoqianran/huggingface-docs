...
- [CLIPSegForImageSegmentation](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegForImageSegmentation) can generate image segmentations based on arbitrary prompts at test time. A prompt can be either a text
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/configuration_clipseg.py#L124)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/configuration_clipseg.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/configuration_clipseg.py#L80)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/processing_clipseg.py#L24)
...
[~ViTImageProcessor](/docs/transformers/v5.17.0/en/model_doc/vit#transformers.ViTImageProcessor) and [~CLIPTokenizer](/docs/transformers/v5.17.0/en/model_doc/clip#transformers.CLIPTokenizer) for more information.

#### __call__[[transformers.CLIPSegProcessor.__call__]]

```python
__call__(text = None, images = None, visual_prompt = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/processing_clipseg.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L783)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L877)
...
elements depending on the configuration ([CLIPSegConfig](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegConfig)) and inputs.

The [CLIPSegModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegModel) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, image_batch_size)`) -- The scaled dot product scores between `text_embeds` and `image_embeds`. This represents the text-image
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [CLIPSegTextModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegTextModel).
- **image_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The image embeddings obtained by applying the projection layer to the pooled output of [CLIPSegVisionModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegVisionModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [CLIPSegTextModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegTextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [CLIPSegVisionModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegVisionModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L804)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L839)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L594)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L610)
...
The [CLIPSegTextModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L694)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L710)
...
The [CLIPSegVisionModel](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L961)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/clipseg/modeling_clipseg.py#L1001)
...
The [CLIPSegForImageSegmentation](/docs/transformers/v5.17.0/en/model_doc/clipseg#transformers.CLIPSegForImageSegmentation) forward method, overrides the `__call__` special method.
...
### SolarOpen
https://huggingface.co/docs/transformers/v5.17.0/model_doc/solar_open.md
