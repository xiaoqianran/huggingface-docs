...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/d_fine/configuration_d_fine.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/d_fine/modeling_d_fine.py#L1540)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/d_fine/modeling_d_fine.py#L1666)
...
The [DFineModel](/docs/transformers/v5.17.0/en/model_doc/d_fine#transformers.DFineModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/d_fine/modeling_d_fine.py#L1950)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/d_fine/modeling_d_fine.py#L1989)
...
The [DFineForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/d_fine#transformers.DFineForObjectDetection) forward method, overrides the `__call__` special method.
...
### XLM-RoBERTa-XL
https://huggingface.co/docs/transformers/v5.17.0/model_doc/xlm-roberta-xl.md
