...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/configuration_deepseek_vl_hybrid.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/processing_deepseek_vl_hybrid.py#L37)
...
[~DeepseekVLHybridImageProcessor](/docs/transformers/v5.15.0/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/image_processing_deepseek_vl_hybrid.py#L62)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/image_processing_pil_deepseek_vl_hybrid.py#L68)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/image_processing_pil_deepseek_vl_hybrid.py#L98)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L253)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L322)
...
high_res_pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size), *optional*) : The tensors corresponding to the input images. Pixel values can be obtained using [AutoImageProcessor](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoImageProcessor).
...
elements depending on the configuration ([DeepseekVLHybridConfig](/docs/transformers/v5.15.0/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridConfig)) and inputs.

The [DeepseekVLHybridModel](/docs/transformers/v5.15.0/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L276)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L414)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_vl_hybrid/modeling_deepseek_vl_hybrid.py#L428)
...
The [DeepseekVLHybridForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/deepseek_vl_hybrid#transformers.DeepseekVLHybridForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### Phi
https://huggingface.co/docs/transformers/v5.15.0/model_doc/phi.md
