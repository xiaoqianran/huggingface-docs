...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/youtu/configuration_youtu.py#L36)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/youtu/modeling_youtu.py#L480)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/youtu/modeling_youtu.py#L497)
...
elements depending on the configuration ([YoutuConfig](/docs/transformers/v5.17.0/en/model_doc/youtu#transformers.YoutuConfig)) and inputs.

The [YoutuModel](/docs/transformers/v5.17.0/en/model_doc/youtu#transformers.YoutuModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/youtu/modeling_youtu.py#L554)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/youtu/modeling_youtu.py#L569)
...
The [YoutuForCausalLM](/docs/transformers/v5.17.0/en/model_doc/youtu#transformers.YoutuForCausalLM) forward method, overrides the `__call__` special method.
...
### FastVLM
https://huggingface.co/docs/transformers/v5.17.0/model_doc/fast_vlm.md
