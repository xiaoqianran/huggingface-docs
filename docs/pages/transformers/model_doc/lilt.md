...
- As [lilt-roberta-en-base](https://huggingface.co/SCUT-DLVCLab/lilt-roberta-en-base) uses the same vocabulary as [LayoutLMv3](layoutlmv3), one can use [LayoutLMv3TokenizerFast](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3Tokenizer) to prepare data for the model.
The same is true for [lilt-roberta-en-base](https://huggingface.co/SCUT-DLVCLab/lilt-infoxlm-base): one can use [LayoutXLMTokenizerFast](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer) for that model.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/configuration_lilt.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L506)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L530)
...
elements depending on the configuration ([LiltConfig](/docs/transformers/v5.17.0/en/model_doc/lilt#transformers.LiltConfig)) and inputs.

The [LiltModel](/docs/transformers/v5.17.0/en/model_doc/lilt#transformers.LiltModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L646)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L659)
...
The [LiltForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/lilt#transformers.LiltForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L759)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L775)
...
The [LiltForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/lilt#transformers.LiltForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L880)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lilt/modeling_lilt.py#L892)
...
The [LiltForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/lilt#transformers.LiltForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### PP-OCRv6_small_det
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_ocrv6_small_det.md
