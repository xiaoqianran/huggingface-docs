...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and how to chat with Llama 2-Chat from the command line.
...
### XLNet
https://huggingface.co/docs/transformers/v5.17.0/model_doc/xlnet.md
