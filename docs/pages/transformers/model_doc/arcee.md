...
The example below demonstrates how to generate text with Arcee using [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/configuration_arcee.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L343)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L360)
...
elements depending on the configuration ([ArceeConfig](/docs/transformers/v5.17.0/en/model_doc/arcee#transformers.ArceeConfig)) and inputs.

The [ArceeModel](/docs/transformers/v5.17.0/en/model_doc/arcee#transformers.ArceeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L417)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L432)
...
The [ArceeForCausalLM](/docs/transformers/v5.17.0/en/model_doc/arcee#transformers.ArceeForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L492)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L497)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/arcee/modeling_arcee.py#L502)
...
### Zamba
https://huggingface.co/docs/transformers/v5.17.0/model_doc/zamba.md
