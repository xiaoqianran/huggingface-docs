...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/processing_x_clip.py#L23)
...
[XCLIPProcessor](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPProcessor) offers all the functionalities of `image_processor_class` and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/processing_x_clip.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/configuration_x_clip.py#L119)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/configuration_x_clip.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/configuration_x_clip.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L914)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L981)
...
elements depending on the configuration ([XCLIPConfig](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPConfig)) and inputs.

The [XCLIPModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPModel) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, video_batch_size)`) -- The scaled dot product scores between `text_embeds` and `video_embeds`. This represents the text-video
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [XCLIPTextModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPTextModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [XCLIPTextModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPTextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [XCLIPVisionModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPVisionModel).
...
- **video_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The video embeddings obtained by applying the projection layer to the pooled output of
  [XCLIPVisionModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPVisionModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L946)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L1141)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L549)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L563)
...
The [XCLIPTextModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L647)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/x_clip/modeling_x_clip.py#L663)
...
The [XCLIPVisionModel](/docs/transformers/v5.17.0/en/model_doc/xclip#transformers.XCLIPVisionModel) forward method, overrides the `__call__` special method.
...
### PoolFormer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/poolformer.md
