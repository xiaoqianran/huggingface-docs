...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/configuration_mistral4.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L564)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L594)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L611)
...
elements depending on the configuration ([Mistral4Config](/docs/transformers/v5.17.0/en/model_doc/mistral4#transformers.Mistral4Config)) and inputs.

The [Mistral4Model](/docs/transformers/v5.17.0/en/model_doc/mistral4#transformers.Mistral4Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L668)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L683)
...
The [Mistral4ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/mistral4#transformers.Mistral4ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L742)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mistral4/modeling_mistral4.py#L746)

### Step3p7 (Step-3.7-Flash)
https://huggingface.co/docs/transformers/v5.17.0/model_doc/step3p7.md
