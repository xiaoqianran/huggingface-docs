...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/configuration_gpt_bigcode.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L371)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L400)
...
elements depending on the configuration ([GPTBigCodeConfig](/docs/transformers/v5.15.0/en/model_doc/gpt_bigcode#transformers.GPTBigCodeConfig)) and inputs.

The [GPTBigCodeModel](/docs/transformers/v5.15.0/en/model_doc/gpt_bigcode#transformers.GPTBigCodeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L511)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L522)
...
The [GPTBigCodeForCausalLM](/docs/transformers/v5.15.0/en/model_doc/gpt_bigcode#transformers.GPTBigCodeForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L603)
...
[GPTBigCodeForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/gpt_bigcode#transformers.GPTBigCodeForSequenceClassification) uses the last token in order to do the classification, as other causal
models (e.g. GPT-1) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L613)
...
The [GPTBigCodeForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/gpt_bigcode#transformers.GPTBigCodeForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L716)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_bigcode/modeling_gpt_bigcode.py#L734)
...
The [GPTBigCodeForTokenClassification](/docs/transformers/v5.15.0/en/model_doc/gpt_bigcode#transformers.GPTBigCodeForTokenClassification) forward method, overrides the `__call__` special method.
...
### BARThez
https://huggingface.co/docs/transformers/v5.15.0/model_doc/barthez.md
