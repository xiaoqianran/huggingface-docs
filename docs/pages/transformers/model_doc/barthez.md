...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/barthez/tokenization_barthez.py#L32)
...
Adapted from [CamembertTokenizer](/docs/transformers/v5.17.0/en/model_doc/camembert#transformers.CamembertTokenizer) and [BartTokenizer](/docs/transformers/v5.17.0/en/model_doc/roberta#transformers.RobertaTokenizer). Construct a "fast" BARThez tokenizer. Based on
...
### LASR
https://huggingface.co/docs/transformers/v5.17.0/model_doc/lasr.md
