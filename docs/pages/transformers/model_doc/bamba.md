...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bamba/configuration_bamba.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bamba/modeling_bamba.py#L922)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bamba/modeling_bamba.py#L942)
...
elements depending on the configuration ([BambaConfig](/docs/transformers/v5.15.0/en/model_doc/bamba#transformers.BambaConfig)) and inputs.

The [BambaModel](/docs/transformers/v5.15.0/en/model_doc/bamba#transformers.BambaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bamba/modeling_bamba.py#L1004)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bamba/modeling_bamba.py#L1020)
...
The [BambaForCausalLM](/docs/transformers/v5.15.0/en/model_doc/bamba#transformers.BambaForCausalLM) forward method, overrides the `__call__` special method.
...
### Audio Flamingo 3
https://huggingface.co/docs/transformers/v5.15.0/model_doc/audioflamingo3.md
