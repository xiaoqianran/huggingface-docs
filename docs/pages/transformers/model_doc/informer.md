...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/informer/configuration_informer.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/informer/modeling_informer.py#L994)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/informer/modeling_informer.py#L1132)
...
elements depending on the configuration ([InformerConfig](/docs/transformers/v5.15.0/en/model_doc/informer#transformers.InformerConfig)) and inputs.

The [InformerModel](/docs/transformers/v5.15.0/en/model_doc/informer#transformers.InformerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/informer/modeling_informer.py#L1357)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/informer/modeling_informer.py#L1392)
...
The [InformerForPrediction](/docs/transformers/v5.15.0/en/model_doc/informer#transformers.InformerForPrediction) forward method, overrides the `__call__` special method.
...
### Llama 2
https://huggingface.co/docs/transformers/v5.15.0/model_doc/llama2.md
