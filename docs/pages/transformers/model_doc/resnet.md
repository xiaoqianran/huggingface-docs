...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/resnet/configuration_resnet.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/resnet/configuration_resnet.py#L72)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/resnet/modeling_resnet.py#L291)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/resnet/modeling_resnet.py#L301)
...
elements depending on the configuration ([ResNetConfig](/docs/transformers/v5.17.0/en/model_doc/resnet#transformers.ResNetConfig)) and inputs.

The [ResNetModel](/docs/transformers/v5.17.0/en/model_doc/resnet#transformers.ResNetModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/resnet/modeling_resnet.py#L340)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/resnet/modeling_resnet.py#L353)
...
The [ResNetForImageClassification](/docs/transformers/v5.17.0/en/model_doc/resnet#transformers.ResNetForImageClassification) forward method, overrides the `__call__` special method.
...
### RoCBert
https://huggingface.co/docs/transformers/v5.17.0/model_doc/roc_bert.md
