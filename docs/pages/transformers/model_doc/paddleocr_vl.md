...
min_pixels (`int`, *kwargs*, *optional*, defaults to `384 * 384`) : The min pixels of the image to resize the image.

max_pixels (`int`, *kwargs*, *optional*, defaults to `1536 * 1536`) : The max pixels of the image to resize the image.
