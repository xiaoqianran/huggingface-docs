...
The example below demonstrates how to generate text with PaddleOCRVL using [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1301)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1325)
...
elements depending on the configuration ([PaddleOCRVLConfig](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRVLConfig)) and inputs.

The [PaddleOCRVLForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRVLForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1312)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/configuration_paddleocr_vl.py#L141)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/configuration_paddleocr_vl.py#L37)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/configuration_paddleocr_vl.py#L73)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L462)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L479)
...
The [PaddleOCRTextModel](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L927)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L940)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/image_processing_paddleocr_vl.py#L90)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/image_processing_paddleocr_vl.py#L129)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/image_processing_pil_paddleocr_vl.py#L88)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/image_processing_pil_paddleocr_vl.py#L190)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L981)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1244)
...
The [PaddleOCRVLModel](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRVLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1153)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1171)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L1049)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L997)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/processing_paddleocr_vl.py#L38)

**Parameters:**

image_processor ([PaddleOCRVLImageProcessor](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRVLImageProcessor), *optional*) : The image processor is a required input.

tokenizer (`LLamaTokenizerFast`, *optional*) : The tokenizer is a required input.

chat_template (`str`, *optional*) : A Jinja template which will be used to convert lists of messages in a chat into a tokenizable string.

[PaddleOCRVLProcessor](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRVLProcessor) offers all the functionalities of [PaddleOCRVLImageProcessor](/docs/transformers/v5.15.0/en/model_doc/paddleocr_vl#transformers.PaddleOCRVLImageProcessor) and `LLamaTokenizerFast`. See the
[__call__()](/docs/transformers/v5.15.0/en/main_classes/processors#transformers.ProcessorMixin.__call__) and [decode()](/docs/transformers/v5.15.0/en/model_doc/donut#transformers.DonutProcessor.decode) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L872)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paddleocr_vl/modeling_paddleocr_vl.py#L892)
...
### ModernBERT
https://huggingface.co/docs/transformers/v5.15.0/model_doc/modernbert.md
