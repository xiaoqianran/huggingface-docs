...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/configuration_cosmos3_omni.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L391)
...
The [Cosmos3OmniModel](/docs/transformers/v5.17.0/en/model_doc/cosmos3_omni#transformers.Cosmos3OmniModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L269)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Cosmos3OmniConfig](/docs/transformers/v5.17.0/en/model_doc/cosmos3_omni#transformers.Cosmos3OmniConfig)) and inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L281)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L504)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L542)
...
The [Cosmos3OmniForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/cosmos3_omni#transformers.Cosmos3OmniForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L516)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cosmos3_omni/modeling_cosmos3_omni.py#L529)
...
### DeepseekVLHybrid
https://huggingface.co/docs/transformers/v5.17.0/model_doc/deepseek_vl_hybrid.md
