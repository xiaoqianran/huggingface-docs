...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/exaone_moe/configuration_exaone_moe.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/exaone_moe/modeling_exaone_moe.py#L465)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/exaone_moe/modeling_exaone_moe.py#L482)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/exaone_moe/modeling_exaone_moe.py#L549)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/exaone_moe/modeling_exaone_moe.py#L564)
...
elements depending on the configuration ([ExaoneMoeConfig](/docs/transformers/v5.17.0/en/model_doc/exaone_moe#transformers.ExaoneMoeConfig)) and inputs.

The [ExaoneMoeForCausalLM](/docs/transformers/v5.17.0/en/model_doc/exaone_moe#transformers.ExaoneMoeForCausalLM) forward method, overrides the `__call__` special method.
...
### ColModernVBert
https://huggingface.co/docs/transformers/v5.17.0/model_doc/colmodernvbert.md
