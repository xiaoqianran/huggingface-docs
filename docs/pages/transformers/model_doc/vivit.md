...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/configuration_vivit.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/image_processing_vivit.py#L63)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/image_processing_vivit.py#L285)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/video_processing_vivit.py#L20)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/video_processing_vivit.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/modeling_vivit.py#L318)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/modeling_vivit.py#L333)
...
elements depending on the configuration ([VivitConfig](/docs/transformers/v5.17.0/en/model_doc/vivit#transformers.VivitConfig)) and inputs.

The [VivitModel](/docs/transformers/v5.17.0/en/model_doc/vivit#transformers.VivitModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/modeling_vivit.py#L447)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vivit/modeling_vivit.py#L460)
...
The [VivitForVideoClassification](/docs/transformers/v5.17.0/en/model_doc/vivit#transformers.VivitForVideoClassification) forward method, overrides the `__call__` special method.
...
### Canary
https://huggingface.co/docs/transformers/v5.17.0/model_doc/canary.md
