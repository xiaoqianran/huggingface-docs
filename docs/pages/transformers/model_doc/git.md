...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/configuration_git.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/modeling_git.py#L634)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/modeling_git.py#L652)
...
elements depending on the configuration ([GitConfig](/docs/transformers/v5.17.0/en/model_doc/git#transformers.GitConfig)) and inputs.

The [GitVisionModel](/docs/transformers/v5.17.0/en/model_doc/git#transformers.GitVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/configuration_git.py#L62)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/processing_git.py#L23)
...
[~CLIPImageProcessor](/docs/transformers/v5.17.0/en/model_doc/clip#transformers.CLIPImageProcessor) and [~BertTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutlm#transformers.BertTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/modeling_git.py#L707)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/modeling_git.py#L738)
...
The [GitModel](/docs/transformers/v5.17.0/en/model_doc/git#transformers.GitModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/modeling_git.py#L892)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/git/modeling_git.py#L910)
...
The [GitForCausalLM](/docs/transformers/v5.17.0/en/model_doc/git#transformers.GitForCausalLM) forward method, overrides the `__call__` special method.
...
### MobileNet V2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mobilenet_v2.md
