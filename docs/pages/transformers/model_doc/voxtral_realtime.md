...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/configuration_voxtral_realtime.py#L124)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/configuration_voxtral_realtime.py#L73)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/configuration_voxtral_realtime.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/feature_extraction_voxtral_realtime.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L512)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L543)
...
elements depending on the configuration ([VoxtralRealtimeConfig](/docs/transformers/v5.15.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeConfig)) and inputs.

The [VoxtralRealtimeEncoder](/docs/transformers/v5.15.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeEncoder) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L876)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L933)
...
The [VoxtralRealtimeModel](/docs/transformers/v5.15.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L1023)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L1035)
...
num_delay_tokens (`int` or `torch.Tensor`, *optional*) : Number of delay tokens used when preparing inputs, see [~VoxtralRealtimeProcessor](/docs/transformers/v5.15.0/en/model_doc/voxtral_realtime#transformers.models.voxtral_realtime.processing_voxtral_realtime._LazyModule.__getattr__..Placeholder) for more details.
...
The [VoxtralRealtimeForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/voxtral_realtime#transformers.VoxtralRealtimeForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral_realtime/modeling_voxtral_realtime.py#L1032)

### OneFormer
https://huggingface.co/docs/transformers/v5.15.0/model_doc/oneformer.md
