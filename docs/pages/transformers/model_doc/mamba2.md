...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mamba2/configuration_mamba2.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mamba2/modeling_mamba2.py#L720)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mamba2/modeling_mamba2.py#L745)
...
elements depending on the configuration ([Mamba2Config](/docs/transformers/v5.17.0/en/model_doc/mamba2#transformers.Mamba2Config)) and inputs.

The [Mamba2Model](/docs/transformers/v5.17.0/en/model_doc/mamba2#transformers.Mamba2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mamba2/modeling_mamba2.py#L823)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mamba2/modeling_mamba2.py#L864)
...
The [Mamba2ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/mamba2#transformers.Mamba2ForCausalLM) forward method, overrides the `__call__` special method.
...
### Mixtral
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mixtral.md
