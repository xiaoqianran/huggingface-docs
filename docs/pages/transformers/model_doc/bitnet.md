...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bitnet/configuration_bitnet.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bitnet/modeling_bitnet.py#L341)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bitnet/modeling_bitnet.py#L358)
...
elements depending on the configuration ([BitNetConfig](/docs/transformers/v5.15.0/en/model_doc/bitnet#transformers.BitNetConfig)) and inputs.

The [BitNetModel](/docs/transformers/v5.15.0/en/model_doc/bitnet#transformers.BitNetModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bitnet/modeling_bitnet.py#L415)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/bitnet/modeling_bitnet.py#L430)
...
The [BitNetForCausalLM](/docs/transformers/v5.15.0/en/model_doc/bitnet#transformers.BitNetForCausalLM) forward method, overrides the `__call__` special method.
...
### GraniteMoeHybrid
https://huggingface.co/docs/transformers/v5.15.0/model_doc/granitemoehybrid.md
