...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/configuration_qwen2_moe.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L438)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L455)
...
elements depending on the configuration ([Qwen2MoeConfig](/docs/transformers/v5.15.0/en/model_doc/qwen2_moe#transformers.Qwen2MoeConfig)) and inputs.

The [Qwen2MoeModel](/docs/transformers/v5.15.0/en/model_doc/qwen2_moe#transformers.Qwen2MoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L602)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L621)
...
The [Qwen2MoeForCausalLM](/docs/transformers/v5.15.0/en/model_doc/qwen2_moe#transformers.Qwen2MoeForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L706)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L709)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen2_moe/modeling_qwen2_moe.py#L712)
...
### PE Audio
https://huggingface.co/docs/transformers/v5.15.0/model_doc/pe_audio.md
