...
- FSMT uses source and target vocabulary pairs that aren't combined into one. It doesn't share embeddings tokens
  either. Its tokenizer is very similar to [XLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/xlm#transformers.XLMTokenizer) and the main model is derived from
  [BartModel](/docs/transformers/v5.17.0/en/model_doc/bart#transformers.BartModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/configuration_fsmt.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/tokenization_fsmt.py#L112)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/tokenization_fsmt.py#L377)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/tokenization_fsmt.py#L403)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/tokenization_fsmt.py#L431)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/modeling_fsmt.py#L802)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/modeling_fsmt.py#L814)
...
elements depending on the configuration ([FSMTConfig](/docs/transformers/v5.17.0/en/model_doc/fsmt#transformers.FSMTConfig)) and inputs.

The [FSMTModel](/docs/transformers/v5.17.0/en/model_doc/fsmt#transformers.FSMTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/modeling_fsmt.py#L938)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/fsmt/modeling_fsmt.py#L949)
...
The [FSMTForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/fsmt#transformers.FSMTForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### NLLB-MOE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/nllb-moe.md
