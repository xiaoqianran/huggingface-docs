...
- ViLT is a model that takes both `pixel_values` and `input_ids` as input. One can use [ViltProcessor](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltProcessor) to prepare data for the model.
...
- ViLT is trained with images of various sizes: the authors resize the shorter edge of input images to 384 and limit the longer edge to
  ...
  which pixel values are real and which are padding. [ViltProcessor](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltProcessor) automatically creates this for you.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/configuration_vilt.py#L24)
...
modality_type_vocab_size (`int`, *optional*, defaults to 2) : The vocabulary size of the modalities passed when calling [ViltModel](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltModel). This is used after concatenating the embeddings of the text and image modalities.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/image_processing_vilt.py#L52)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/image_processing_pil_vilt.py#L113)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/processing_vilt.py#L38)
...
[~ViltImageProcessor](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltImageProcessor) and [~BertTokenizer](/docs/transformers/v5.15.0/en/model_doc/layoutlm#transformers.BertTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L511)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L535)
...
elements depending on the configuration ([ViltConfig](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltConfig)) and inputs.

The [ViltModel](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L671)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L692)
...
The [ViltForMaskedLM](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L844)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L862)
...
The [ViltForQuestionAnswering](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L1056)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L1075)
...
The [ViltForImagesAndTextClassification](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltForImagesAndTextClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L957)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L969)
...
The [ViltForImageAndTextRetrieval](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltForImageAndTextRetrieval) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L1198)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vilt/modeling_vilt.py#L1211)
...
The [ViltForTokenClassification](/docs/transformers/v5.15.0/en/model_doc/vilt#transformers.ViltForTokenClassification) forward method, overrides the `__call__` special method.
...
### YOLOS
https://huggingface.co/docs/transformers/v5.15.0/model_doc/yolos.md
