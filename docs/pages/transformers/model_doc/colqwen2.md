...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colqwen2/configuration_colqwen2.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colqwen2/processing_colqwen2.py#L51)
...
[~Qwen2VLImageProcessor](/docs/transformers/v5.17.0/en/model_doc/qwen2_vl#transformers.Qwen2VLImageProcessor) and [~Qwen2Tokenizer](/docs/transformers/v5.17.0/en/model_doc/qwen2#transformers.Qwen2Tokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colqwen2/processing_colqwen2.py#L77)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colqwen2/modeling_colqwen2.py#L92)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colqwen2/modeling_colqwen2.py#L110)
...
elements depending on the configuration ([ColQwen2Config](/docs/transformers/v5.17.0/en/model_doc/colqwen2#transformers.ColQwen2Config)) and inputs.

The [ColQwen2ForRetrieval](/docs/transformers/v5.17.0/en/model_doc/colqwen2#transformers.ColQwen2ForRetrieval) forward method, overrides the `__call__` special method.
...
### OLMo3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/olmo3.md
