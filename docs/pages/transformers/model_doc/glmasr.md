...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/configuration_glmasr.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/configuration_glmasr.py#L66)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L274)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/processing_glmasr.py#L58)
...
[~WhisperFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/whisper#transformers.WhisperFeatureExtractor) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/processing_glmasr.py#L85)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L287)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L310)
...
The [GlmAsrEncoder](/docs/transformers/v5.17.0/en/model_doc/glmasr#transformers.GlmAsrEncoder) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L364)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L434)
...
elements depending on the configuration ([GlmAsrConfig](/docs/transformers/v5.17.0/en/model_doc/glmasr#transformers.GlmAsrConfig)) and inputs.

The [GlmAsrModel](/docs/transformers/v5.17.0/en/model_doc/glmasr#transformers.GlmAsrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L516)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glmasr/modeling_glmasr.py#L528)
...
The [GlmAsrForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/glmasr#transformers.GlmAsrForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### Deformable DETR
https://huggingface.co/docs/transformers/v5.17.0/model_doc/deformable_detr.md
