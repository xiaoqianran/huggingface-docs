...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colpali/configuration_colpali.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colpali/processing_colpali.py#L54)
...
[ColPaliProcessor](/docs/transformers/v5.17.0/en/model_doc/colpali#transformers.ColPaliProcessor) offers all the functionalities of [SiglipImageProcessor](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipImageProcessor) and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colpali/processing_colpali.py#L94)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colpali/modeling_colpali.py#L90)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/colpali/modeling_colpali.py#L108)
...
The [ColPaliForRetrieval](/docs/transformers/v5.17.0/en/model_doc/colpali#transformers.ColPaliForRetrieval) forward method, overrides the `__call__` special method.
...
### mLUKE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mluke.md
