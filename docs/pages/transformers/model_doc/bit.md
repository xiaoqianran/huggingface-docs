...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/configuration_bit.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/image_processing_bit.py#L22)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/image_processing_pil_bit.py#L22)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/modeling_bit.py#L640)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/modeling_bit.py#L658)
...
elements depending on the configuration ([BitConfig](/docs/transformers/v5.17.0/en/model_doc/bit#transformers.BitConfig)) and inputs.

The [BitModel](/docs/transformers/v5.17.0/en/model_doc/bit#transformers.BitModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/modeling_bit.py#L699)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bit/modeling_bit.py#L712)
...
The [BitForImageClassification](/docs/transformers/v5.17.0/en/model_doc/bit#transformers.BitForImageClassification) forward method, overrides the `__call__` special method.
...
### SmolVLM
https://huggingface.co/docs/transformers/v5.17.0/model_doc/smolvlm.md
