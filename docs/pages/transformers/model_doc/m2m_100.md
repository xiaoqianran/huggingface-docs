...
The [M2M100Tokenizer](/docs/transformers/v5.15.0/en/model_doc/m2m_100#transformers.M2M100Tokenizer) depends on `sentencepiece` so be sure to install it before running the
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/configuration_m2m_100.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L49)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L255)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L225)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L296)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/modeling_m2m_100.py#L716)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/modeling_m2m_100.py#L743)
...
elements depending on the configuration ([M2M100Config](/docs/transformers/v5.15.0/en/model_doc/m2m_100#transformers.M2M100Config)) and inputs.

The [M2M100Model](/docs/transformers/v5.15.0/en/model_doc/m2m_100#transformers.M2M100Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/modeling_m2m_100.py#L818)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/m2m_100/modeling_m2m_100.py#L830)
...
The [M2M100ForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
To load a model using Flash Attention 2, we can pass the argument `attn_implementation="flash_attention_2"` to [from_pretrained()](/docs/transformers/v5.15.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained). You can use either `torch.float16` or `torch.bfloat16` precision.
...
### MPNet
https://huggingface.co/docs/transformers/v5.15.0/model_doc/mpnet.md
