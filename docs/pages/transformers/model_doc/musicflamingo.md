...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/musicflamingo/configuration_musicflamingo.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/musicflamingo/processing_musicflamingo.py#L58)
...
[MusicFlamingoProcessor](/docs/transformers/v5.17.0/en/model_doc/musicflamingo#transformers.MusicFlamingoProcessor) offers all the functionalities of `feature_extractor_class` and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/musicflamingo/modeling_musicflamingo.py#L206)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/musicflamingo/modeling_musicflamingo.py#L279)
...
elements depending on the configuration ([MusicFlamingoConfig](/docs/transformers/v5.17.0/en/model_doc/musicflamingo#transformers.MusicFlamingoConfig)) and inputs.

The [MusicFlamingoModel](/docs/transformers/v5.17.0/en/model_doc/musicflamingo#transformers.MusicFlamingoModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/musicflamingo/modeling_musicflamingo.py#L404)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/musicflamingo/modeling_musicflamingo.py#L416)
...
The [MusicFlamingoForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/musicflamingo#transformers.MusicFlamingoForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### BigBird
https://huggingface.co/docs/transformers/v5.17.0/model_doc/big_bird.md
