...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/configuration_ovis2.py#L58)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/configuration_ovis2.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L467)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L535)
...
elements depending on the configuration ([Ovis2Config](/docs/transformers/v5.15.0/en/model_doc/ovis2#transformers.Ovis2Config)) and inputs.

The [Ovis2Model](/docs/transformers/v5.15.0/en/model_doc/ovis2#transformers.Ovis2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L479)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L511)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L601)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L619)
...
The [Ovis2ForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/ovis2#transformers.Ovis2ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/modeling_ovis2.py#L613)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/image_processing_ovis2.py#L151)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/image_processing_ovis2.py#L170)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/image_processing_pil_ovis2.py#L157)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/image_processing_pil_ovis2.py#L176)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ovis2/processing_ovis2.py#L30)
...
[~Ovis2ImageProcessor](/docs/transformers/v5.15.0/en/model_doc/ovis2#transformers.Ovis2ImageProcessor) and [~Qwen2Tokenizer](/docs/transformers/v5.15.0/en/model_doc/qwen2#transformers.Qwen2Tokenizer) for more information.
...
### MADLAD-400
https://huggingface.co/docs/transformers/v5.15.0/model_doc/madlad-400.md
