...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo_hybrid/configuration_olmo_hybrid.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo_hybrid/modeling_olmo_hybrid.py#L885)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo_hybrid/modeling_olmo_hybrid.py#L909)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo_hybrid/modeling_olmo_hybrid.py#L976)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo_hybrid/modeling_olmo_hybrid.py#L991)
...
elements depending on the configuration ([OlmoHybridConfig](/docs/transformers/v5.17.0/en/model_doc/olmo_hybrid#transformers.OlmoHybridConfig)) and inputs.

The [OlmoHybridForCausalLM](/docs/transformers/v5.17.0/en/model_doc/olmo_hybrid#transformers.OlmoHybridForCausalLM) forward method, overrides the `__call__` special method.
...
### Voxtral
https://huggingface.co/docs/transformers/v5.17.0/model_doc/voxtral.md
