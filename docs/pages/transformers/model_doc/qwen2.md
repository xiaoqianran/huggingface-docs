...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and from the command line using the instruction-tuned models.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/configuration_qwen2.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/tokenization_qwen2.py#L36)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L238)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L247)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L321)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L339)
...
elements depending on the configuration ([Qwen2Config](/docs/transformers/v5.17.0/en/model_doc/qwen2#transformers.Qwen2Config)) and inputs.

The [Qwen2Model](/docs/transformers/v5.17.0/en/model_doc/qwen2#transformers.Qwen2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L406)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L421)
...
The [Qwen2ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/qwen2#transformers.Qwen2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L480)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L484)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2/modeling_qwen2.py#L488)
...
### PP-OCRv5_mobile_rec
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_ocrv5_mobile_rec.md
