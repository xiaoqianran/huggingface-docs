...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_sw3/tokenization_gpt_sw3.py#L21)
...
### TrOCR
https://huggingface.co/docs/transformers/v5.17.0/model_doc/trocr.md
