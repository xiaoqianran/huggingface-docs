...
The example below demonstrates how to detect text with PP-OCRv5_server_rec using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
Here is how you can do it with PP-OCRv5_server_rec using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel):
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/modeling_pp_ocrv5_server_rec.py#L357)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/modeling_pp_ocrv5_server_rec.py#L367)
...
elements depending on the configuration ([PPOCRV5ServerRecConfig](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv5_server_rec#transformers.PPOCRV5ServerRecConfig)) and inputs.

The [PPOCRV5ServerRecForTextRecognition](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv5_server_rec#transformers.PPOCRV5ServerRecForTextRecognition) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/configuration_pp_ocrv5_server_rec.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/modeling_pp_ocrv5_server_rec.py#L320)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/modeling_pp_ocrv5_server_rec.py#L328)
...
The [PPOCRV5ServerRecModel](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv5_server_rec#transformers.PPOCRV5ServerRecModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/modeling_pp_ocrv5_server_rec.py#L258)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_mobile_rec/modeling_pp_ocrv5_mobile_rec.py#L257)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/image_processing_pp_ocrv5_server_rec.py#L49)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/image_processing_pp_ocrv5_server_rec.py#L116)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_server_rec/image_processing_pp_ocrv5_server_rec.py#L143)
...
### T5Gemma
https://huggingface.co/docs/transformers/v5.17.0/model_doc/t5gemma.md
