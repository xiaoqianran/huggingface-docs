...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/configuration_groupvit.py#L125)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/configuration_groupvit.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/configuration_groupvit.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L1088)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L1200)
...
elements depending on the configuration ([GroupViTConfig](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTConfig)) and inputs.

The [GroupViTModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTModel) forward method, overrides the `__call__` special method.
...
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of
  [GroupViTTextModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTTextModel).
- **image_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The image embeddings obtained by applying the projection layer to the pooled output of
  [GroupViTVisionModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTVisionModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [GroupViTTextModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTTextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [GroupViTVisionModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTVisionModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L1134)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L1169)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L933)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L949)
...
The [GroupViTTextModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L1033)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/groupvit/modeling_groupvit.py#L1048)
...
The [GroupViTVisionModel](/docs/transformers/v5.17.0/en/model_doc/groupvit#transformers.GroupViTVisionModel) forward method, overrides the `__call__` special method.
...
### X-Codec2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/xcodec2.md
