...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/image_processing_lfm2_vl.py#L218)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/processing_lfm2_vl.py#L58)
...
[Lfm2VlProcessor](/docs/transformers/v5.15.0/en/model_doc/lfm2_vl#transformers.Lfm2VlProcessor) offers all the functionalities of [Lfm2VlImageProcessor](/docs/transformers/v5.15.0/en/model_doc/lfm2_vl#transformers.Lfm2VlImageProcessor) and `tokenizer_class`. See the
[~Lfm2VlImageProcessor](/docs/transformers/v5.15.0/en/model_doc/lfm2_vl#transformers.Lfm2VlImageProcessor) and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/processing_lfm2_vl.py#L79)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/configuration_lfm2_vl.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/modeling_lfm2_vl.py#L147)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/modeling_lfm2_vl.py#L230)
...
elements depending on the configuration ([Lfm2VlConfig](/docs/transformers/v5.15.0/en/model_doc/lfm2_vl#transformers.Lfm2VlConfig)) and inputs.

The [Lfm2VlModel](/docs/transformers/v5.15.0/en/model_doc/lfm2_vl#transformers.Lfm2VlModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/modeling_lfm2_vl.py#L156)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/modeling_lfm2_vl.py#L296)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/modeling_lfm2_vl.py#L331)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_vl/modeling_lfm2_vl.py#L308)
...
### SuperPoint
https://huggingface.co/docs/transformers/v5.15.0/model_doc/superpoint.md
