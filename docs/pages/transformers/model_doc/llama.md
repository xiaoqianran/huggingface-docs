...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/configuration_llama.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/tokenization_llama.py#L39)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L347)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L364)
...
elements depending on the configuration ([LlamaConfig](/docs/transformers/v5.17.0/en/model_doc/llama2#transformers.LlamaConfig)) and inputs.

The [LlamaModel](/docs/transformers/v5.17.0/en/model_doc/llama2#transformers.LlamaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L421)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L436)
...
The [LlamaForCausalLM](/docs/transformers/v5.17.0/en/model_doc/llama2#transformers.LlamaForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L495)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L498)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama/modeling_llama.py#L502)
...
### PP-LCNet
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_lcnet.md
