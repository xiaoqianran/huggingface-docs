...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/configuration_kosmos2.py#L81)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/configuration_kosmos2.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/configuration_kosmos2.py#L61)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/processing_kosmos2.py#L87)
...
[Kosmos2Processor](/docs/transformers/v5.15.0/en/model_doc/kosmos-2#transformers.Kosmos2Processor) offers all the functionalities of `image_processor_class` and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/processing_kosmos2.py#L139)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/modeling_kosmos2.py#L1343)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/modeling_kosmos2.py#L1395)
...
elements depending on the configuration ([Kosmos2Config](/docs/transformers/v5.15.0/en/model_doc/kosmos-2#transformers.Kosmos2Config)) and inputs.

The [Kosmos2Model](/docs/transformers/v5.15.0/en/model_doc/kosmos-2#transformers.Kosmos2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/modeling_kosmos2.py#L1363)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/modeling_kosmos2.py#L1494)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/kosmos2/modeling_kosmos2.py#L1522)
...
The [Kosmos2ForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/kosmos-2#transformers.Kosmos2ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### GraniteMoe
https://huggingface.co/docs/transformers/v5.15.0/model_doc/granitemoe.md
