...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/configuration_falcon.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L666)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L694)
...
elements depending on the configuration ([FalconConfig](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconConfig)) and inputs.

The [FalconModel](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L837)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L851)
...
The [FalconForCausalLM](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L939)
...
[FalconForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L949)
...
The [FalconForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L1056)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L1074)
...
The [FalconForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L1144)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon/modeling_falcon.py#L1153)
...
The [FalconForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/falcon#transformers.FalconForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### BEiT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/beit.md
