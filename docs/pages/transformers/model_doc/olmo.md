...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo/configuration_olmo.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo/modeling_olmo.py#L342)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo/modeling_olmo.py#L359)
...
elements depending on the configuration ([OlmoConfig](/docs/transformers/v5.17.0/en/model_doc/olmo#transformers.OlmoConfig)) and inputs.

The [OlmoModel](/docs/transformers/v5.17.0/en/model_doc/olmo#transformers.OlmoModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo/modeling_olmo.py#L416)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo/modeling_olmo.py#L431)
...
The [OlmoForCausalLM](/docs/transformers/v5.17.0/en/model_doc/olmo#transformers.OlmoForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo/modeling_olmo.py#L490)
...
### I-BERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/ibert.md
