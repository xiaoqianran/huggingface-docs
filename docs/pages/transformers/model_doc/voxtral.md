...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/configuration_voxtral.py#L76)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/configuration_voxtral.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/processing_voxtral.py#L79)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/processing_voxtral.py#L224)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L237)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L292)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L384)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L439)
...
elements depending on the configuration ([VoxtralConfig](/docs/transformers/v5.15.0/en/model_doc/voxtral#transformers.VoxtralConfig)) and inputs.

The [VoxtralModel](/docs/transformers/v5.15.0/en/model_doc/voxtral#transformers.VoxtralModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L490)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L502)
...
The [VoxtralForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/voxtral#transformers.VoxtralForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/voxtral/modeling_voxtral.py#L499)

### Qwen2MoE
https://huggingface.co/docs/transformers/v5.15.0/model_doc/qwen2_moe.md
