...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_h1/configuration_falcon_h1.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_h1/modeling_falcon_h1.py#L1111)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_h1/modeling_falcon_h1.py#L1126)
...
elements depending on the configuration ([FalconH1Config](/docs/transformers/v5.17.0/en/model_doc/falcon_h1#transformers.FalconH1Config)) and inputs.

The [FalconH1ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/falcon_h1#transformers.FalconH1ForCausalLM) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/openai_privacy_filter.md
