...
The example below demonstrates how to predict the masked token with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/configuration_switch_transformers.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L52)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L72)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L179)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L185)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L796)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L824)
...
The [SwitchTransformersModel](/docs/transformers/v5.17.0/en/model_doc/switch_transformers#transformers.SwitchTransformersModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L938)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L975)
...
The [SwitchTransformersForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/switch_transformers#transformers.SwitchTransformersForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L1096)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/switch_transformers/modeling_switch_transformers.py#L1118)
...
The [SwitchTransformersEncoderModel](/docs/transformers/v5.17.0/en/model_doc/switch_transformers#transformers.SwitchTransformersEncoderModel) forward method, overrides the `__call__` special method.
...
### EoMT-DINOv3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/eomt_dinov3.md
