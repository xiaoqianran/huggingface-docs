...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/regnet/configuration_regnet.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/regnet/modeling_regnet.py#L282)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/regnet/modeling_regnet.py#L292)
...
elements depending on the configuration ([RegNetConfig](/docs/transformers/v5.17.0/en/model_doc/regnet#transformers.RegNetConfig)) and inputs.

The [RegNetModel](/docs/transformers/v5.17.0/en/model_doc/regnet#transformers.RegNetModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/regnet/modeling_regnet.py#L332)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/regnet/modeling_regnet.py#L345)
...
The [RegNetForImageClassification](/docs/transformers/v5.17.0/en/model_doc/regnet#transformers.RegNetForImageClassification) forward method, overrides the `__call__` special method.
...
### MobileNet V1
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mobilenet_v1.md
