...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_lcnet_v4/configuration_pp_lcnet_v4.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_lcnet_v4/modeling_pp_lcnet_v4.py#L351)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_lcnet_v4/modeling_pp_lcnet_v4.py#L364)
...
elements depending on the configuration ([PPLCNetV4Config](/docs/transformers/v5.17.0/en/model_doc/pp_lcnet_v4#transformers.PPLCNetV4Config)) and inputs.

The [PPLCNetV4Backbone](/docs/transformers/v5.17.0/en/model_doc/pp_lcnet_v4#transformers.PPLCNetV4Backbone) forward method, overrides the `__call__` special method.
...
### ViTMatte
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vitmatte.md
