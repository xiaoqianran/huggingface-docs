...
- `StableLM 3B 4E1T`-based models uses the same tokenizer as [GPTNeoXTokenizerFast](/docs/transformers/v5.15.0/en/model_doc/gpt_neox#transformers.GPTNeoXTokenizer).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/configuration_stablelm.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/modeling_stablelm.py#L403)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/modeling_stablelm.py#L429)
...
elements depending on the configuration ([StableLmConfig](/docs/transformers/v5.15.0/en/model_doc/stablelm#transformers.StableLmConfig)) and inputs.

The [StableLmModel](/docs/transformers/v5.15.0/en/model_doc/stablelm#transformers.StableLmModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/modeling_stablelm.py#L487)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/modeling_stablelm.py#L500)
...
The [StableLmForCausalLM](/docs/transformers/v5.15.0/en/model_doc/stablelm#transformers.StableLmForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/modeling_stablelm.py#L564)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/stablelm/modeling_stablelm.py#L567)
...
### RegNet
https://huggingface.co/docs/transformers/v5.15.0/model_doc/regnet.md
