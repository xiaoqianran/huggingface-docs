...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/configuration_got_ocr2.py#L69)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/configuration_got_ocr2.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/image_processing_got_ocr2.py#L125)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/image_processing_pil_got_ocr2.py#L135)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/processing_got_ocr2.py#L109)
...
[~GotOcr2ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/got_ocr2#transformers.GotOcr2ImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/processing_got_ocr2.py#L146)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L535)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L583)
...
elements depending on the configuration ([GotOcr2Config](/docs/transformers/v5.17.0/en/model_doc/got_ocr2#transformers.GotOcr2Config)) and inputs.

The [GotOcr2Model](/docs/transformers/v5.17.0/en/model_doc/got_ocr2#transformers.GotOcr2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L544)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L559)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L636)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L654)
...
The [GotOcr2ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/got_ocr2#transformers.GotOcr2ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/got_ocr2/modeling_got_ocr2.py#L648)
...
### PLBart
https://huggingface.co/docs/transformers/v5.17.0/model_doc/plbart.md
