...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minicpm3/configuration_minicpm3.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minicpm3/modeling_minicpm3.py#L448)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minicpm3/modeling_minicpm3.py#L467)
...
elements depending on the configuration ([MiniCPM3Config](/docs/transformers/v5.17.0/en/model_doc/minicpm3#transformers.MiniCPM3Config)) and inputs.

The [MiniCPM3Model](/docs/transformers/v5.17.0/en/model_doc/minicpm3#transformers.MiniCPM3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minicpm3/modeling_minicpm3.py#L524)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minicpm3/modeling_minicpm3.py#L539)
...
The [MiniCPM3ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/minicpm3#transformers.MiniCPM3ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minicpm3/modeling_minicpm3.py#L598)
...
### X-CLIP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/xclip.md
