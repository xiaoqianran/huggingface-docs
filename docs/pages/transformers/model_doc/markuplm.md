...
- In addition to `input_ids`, [forward()](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMModel.forward) expects 2 additional inputs, namely `xpath_tags_seq` and `xpath_subs_seq`.
These are the XPATH tags and subscripts respectively for each token in the input sequence.
- One can use [MarkupLMProcessor](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMProcessor) to prepare all data for the model. Refer to the [usage guide](#usage-markuplmprocessor) for more info.
...
The easiest way to prepare data for the model is to use [MarkupLMProcessor](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMProcessor), which internally combines a feature extractor
...
In short, one can provide HTML strings (and possibly additional data) to [MarkupLMProcessor](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMProcessor),
and it will create the inputs expected by the model. Internally, the processor first uses
[MarkupLMFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor) to get a list of nodes and corresponding xpaths. The nodes and
xpaths are then provided to [MarkupLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer) or [MarkupLMTokenizerFast](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer), which converts them
...
[MarkupLMFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor) uses [Beautiful Soup](https://www.crummy.com/software/BeautifulSoup/bs4/doc/), a Python library for
pulling data out of HTML and XML files, under the hood. Note that you can still use your own parsing solution of
choice, and provide the nodes and xpaths yourself to [MarkupLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer) or [MarkupLMTokenizerFast](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/configuration_markuplm.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/feature_extraction_markuplm.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/feature_extraction_markuplm.py#L98)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L91)
...
[MarkupLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer) can be used to turn HTML strings into to token-level `input_ids`, `attention_mask`,
`token_type_ids`, `xpath_tags_seq` and `xpath_tags_seq`. This tokenizer inherits from [TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) which
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L952)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L975)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L997)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L453)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L518)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/tokenization_markuplm.py#L253)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/processing_markuplm.py#L25)
...
[MarkupLMProcessor](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMProcessor) offers all the functionalities of `feature_extractor_class` and [MarkupLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer). See the
`~feature_extractor_class` and [~MarkupLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/processing_markuplm.py#L31)
...
truncation (bool, str or [TruncationStrategy](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy), *optional*) : Activates and controls truncation. Accepts the following values:  - `True` or `'longest_first'`: Truncate to a maximum length specified with the argument `max_length` or to the maximum acceptable input length for the model if that argument is not provided. This will truncate token by token, removing a token from the longest sequence in the pair if a pair of sequences (or a batch of pairs) is provided. - `'only_first'`: Truncate to a maximum length specified with the argument `max_length` or to the maximum acceptable input length for the model if that argument is not provided. This will only truncate the first sequence of a pair if a pair of sequences (or a batch of pairs) is provided. - `'only_second'`: Truncate to a maximum length specified with the argument `max_length` or to the maximum acceptable input length for the model if that argument is not provided. This will only truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided. - `False` or `'do_not_truncate'` (default): No truncation (i.e., can output batch with sequence lengths greater than the model maximum admissible input size).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L497)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L521)
...
elements depending on the configuration ([MarkupLMConfig](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMConfig)) and inputs.

The [MarkupLMModel](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L804)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L821)
...
The [MarkupLMForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L709)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L725)
...
The [MarkupLMForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L603)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/markuplm/modeling_markuplm.py#L615)
...
The [MarkupLMForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/markuplm#transformers.MarkupLMForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### ImageGPT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/imagegpt.md
