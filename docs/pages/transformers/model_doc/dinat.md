...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinat/configuration_dinat.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinat/modeling_dinat.py#L541)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinat/modeling_dinat.py#L567)
...
elements depending on the configuration ([DinatConfig](/docs/transformers/v5.17.0/en/model_doc/dinat#transformers.DinatConfig)) and inputs.

The [DinatModel](/docs/transformers/v5.17.0/en/model_doc/dinat#transformers.DinatModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinat/modeling_dinat.py#L622)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinat/modeling_dinat.py#L639)
...
The [DinatForImageClassification](/docs/transformers/v5.17.0/en/model_doc/dinat#transformers.DinatForImageClassification) forward method, overrides the `__call__` special method.
...
### TimesFM 2.5
https://huggingface.co/docs/transformers/v5.17.0/model_doc/timesfm2_5.md
