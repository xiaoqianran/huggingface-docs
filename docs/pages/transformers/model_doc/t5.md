...
The example below demonstrates how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and how to translate with T5 from the command line.
...
- T5 models need a slightly higher learning rate than the default used in [Trainer](/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.Trainer). Typically, values of `1e-4` and `3e-4` work well for most tasks.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/configuration_t5.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/tokenization_t5.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L754)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L788)
...
elements depending on the configuration ([T5Config](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5Config)) and inputs.

The [T5Model](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L898)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L937)
...
The [T5ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1073)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1096)
...
The [T5EncoderModel](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5EncoderModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1144)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1155)
...
The [T5ForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5ForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1286)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1298)
...
The [T5ForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5ForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1347)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/t5/modeling_t5.py#L1384)
...
The [T5ForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5ForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### RT-DETRv2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/rt_detr_v2.md
