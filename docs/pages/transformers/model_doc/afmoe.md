...
The example below demonstrates how to generate text with AFMoE using [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/afmoe/configuration_afmoe.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/afmoe/modeling_afmoe.py#L511)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/afmoe/modeling_afmoe.py#L534)
...
The [AfmoeModel](/docs/transformers/v5.17.0/en/model_doc/afmoe#transformers.AfmoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/afmoe/modeling_afmoe.py#L601)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/afmoe/modeling_afmoe.py#L615)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([AfmoeConfig](/docs/transformers/v5.17.0/en/model_doc/afmoe#transformers.AfmoeConfig)) and inputs.

The [AfmoeForCausalLM](/docs/transformers/v5.17.0/en/model_doc/afmoe#transformers.AfmoeForCausalLM) forward method, overrides the `__call__` special method.
...
### VaultGemma
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vaultgemma.md
