...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m2/configuration_minimax_m2.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L422)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L439)
...
elements depending on the configuration ([MiniMaxM2Config](/docs/transformers/v5.17.0/en/model_doc/minimax_m2#transformers.MiniMaxM2Config)) and inputs.

The [MiniMaxM2Model](/docs/transformers/v5.17.0/en/model_doc/minimax_m2#transformers.MiniMaxM2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L567)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m2/modeling_minimax_m2.py#L585)
...
The [MiniMaxM2ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/minimax_m2#transformers.MiniMaxM2ForCausalLM) forward method, overrides the `__call__` special method.
...
### LLaVA-OneVision
https://huggingface.co/docs/transformers/v5.17.0/model_doc/llava_onevision.md
