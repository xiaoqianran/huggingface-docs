...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/configuration_sew.py#L27)
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [SEWForCTC](/docs/transformers/v5.17.0/en/model_doc/sew#transformers.SEWForCTC).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/modeling_sew.py#L659)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/modeling_sew.py#L726)
...
elements depending on the configuration ([SEWConfig](/docs/transformers/v5.17.0/en/model_doc/sew#transformers.SEWConfig)) and inputs.

The [SEWModel](/docs/transformers/v5.17.0/en/model_doc/sew#transformers.SEWModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/modeling_sew.py#L771)
...
target_lang (`str`, *optional*) : Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or adapter..bin. Only relevant when using an instance of [SEWForCTC](/docs/transformers/v5.17.0/en/model_doc/sew#transformers.SEWForCTC) with adapters. Uses 'eng' by default.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/modeling_sew.py#L840)
...
The [SEWForCTC](/docs/transformers/v5.17.0/en/model_doc/sew#transformers.SEWForCTC) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/modeling_sew.py#L909)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew/modeling_sew.py#L942)
...
The [SEWForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/sew#transformers.SEWForSequenceClassification) forward method, overrides the `__call__` special method.
...
### FalconMamba
https://huggingface.co/docs/transformers/v5.17.0/model_doc/falcon_mamba.md
