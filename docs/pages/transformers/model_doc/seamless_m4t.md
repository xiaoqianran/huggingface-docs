...
[SeamlessM4TModel](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) can perform all the above tasks, but each task also has its own dedicated sub-model.
...
[SeamlessM4TModel](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) can *seamlessly* generate text or speech with few or no changes. Let's target Russian voice translation:
...
Similarly, you can generate translated text from audio files or from text with the same model. You only have to pass `generate_speech=False` to [SeamlessM4TModel.generate()](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel.generate).
...
[SeamlessM4TModel](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) is transformers top level model to generate speech and text, but you can also use dedicated models that perform the task without additional components, thus reducing the memory footprint.
...
Feel free to try out [SeamlessM4TForSpeechToText](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToText) and [SeamlessM4TForTextToSpeech](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForTextToSpeech) as well.
...
Use `return_intermediate_token_ids=True` with [SeamlessM4TModel](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TModel) to return both speech and text !
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L3357)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L3545)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2749)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2877)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L3050)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L3177)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2273)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2309)
...
elements depending on the configuration ([SeamlessM4TConfig](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TConfig)) and inputs.

The [SeamlessM4TForTextToText](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForTextToText) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2391)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2508)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2541)
...
The [SeamlessM4TForSpeechToText](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TForSpeechToText) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2630)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/configuration_seamless_m4t.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/tokenization_seamless_m4t.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/tokenization_seamless_m4t.py#L355)
...
kwargs (*optional*) : Remaining dictionary of keyword arguments that will be passed to [TokenizersBackend.__call__()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/feature_extraction_seamless_m4t.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/feature_extraction_seamless_m4t.py#L140)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/processing_seamless_m4t.py#L48)
...
[~SeamlessM4TFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TFeatureExtractor) and [~SeamlessM4TTokenizer](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/processing_seamless_m4t.py#L54)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2119)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2195)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2042)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L2077)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L1749)
...
#### forward[[transformers.SeamlessM4TTextToUnitModel.forward]]

```python
forward(input_ids: typing.Optional[torch.LongTensor] = None, attention_mask: typing.Optional[torch.Tensor] = None, decoder_input_ids: typing.Optional[torch.LongTensor] = None, decoder_attention_mask: typing.Optional[torch.LongTensor] = None, encoder_outputs: tuple[tuple[torch.FloatTensor]] | None = None, past_key_values: transformers.cache_utils.Cache | None = None, inputs_embeds: typing.Optional[torch.FloatTensor] = None, decoder_inputs_embeds: typing.Optional[torch.FloatTensor] = None, use_cache: bool | None = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L1767)
...
The [SeamlessM4TTextToUnitModel](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TTextToUnitModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L1828)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t/modeling_seamless_m4t.py#L1872)
...
The [SeamlessM4TTextToUnitForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t#transformers.SeamlessM4TTextToUnitForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### CLIP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/clip.md
