...
- WavLM is a speech model that accepts a float array corresponding to the raw waveform of the speech signal. Please use
  [Wav2Vec2Processor](/docs/transformers/v5.17.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) for the feature extraction.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/configuration_wavlm.py#L27)
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [WavLMForCTC](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForCTC).
...
use_weighted_layer_sum (`bool`, *optional*, defaults to `False`) : Whether to use a weighted average of layer outputs with learned weights. Only relevant when using an instance of [WavLMForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForSequenceClassification).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L920)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L994)
...
elements depending on the configuration ([WavLMConfig](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMConfig)) and inputs.

The [WavLMModel](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1045)
...
target_lang (`str`, *optional*) : Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or adapter..bin. Only relevant when using an instance of [WavLMForCTC](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForCTC) with adapters. Uses 'eng' by default.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1114)
...
The [WavLMForCTC](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForCTC) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1183)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1216)
...
The [WavLMForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1280)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1312)
...
The [WavLMForAudioFrameClassification](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForAudioFrameClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1426)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wavlm/modeling_wavlm.py#L1476)
...
The [WavLMForXVector](/docs/transformers/v5.17.0/en/model_doc/wavlm#transformers.WavLMForXVector) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vision-text-dual-encoder.md
