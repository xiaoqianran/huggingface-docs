...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/configuration_gpt2.py#L25)
...
summary_use_proj (`bool`, *optional*, defaults to `True`) : Argument used when doing sequence summary, used in the models [GPT2DoubleHeadsModel](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel). Whether or not to add a projection after the vector extraction.
...
summary_first_dropout (`float`, *optional*, defaults to 0.1) : Argument used when doing sequence summary, used in the models [GPT2DoubleHeadsModel](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel). The dropout ratio to be used after the projection and activation.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/tokenization_gpt2.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L459)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L486)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L511)
...
elements depending on the configuration ([GPT2Config](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2Config)) and inputs.

The [GPT2Model](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L636)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L647)
...
The [GPT2LMHeadModel](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2LMHeadModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L727)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L740)
...
**Returns:** [GPT2DoubleHeadsModelOutput](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput) or `tuple(torch.FloatTensor)`

A [GPT2DoubleHeadsModelOutput](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GPT2Config](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2Config)) and inputs.

The [GPT2DoubleHeadsModel](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L1048)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L1058)
...
The [GPT2ForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2ForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L858)
...
[GPT2ForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2ForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L868)
...
The [GPT2ForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2ForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L968)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt2/modeling_gpt2.py#L986)
...
The [GPT2ForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2ForTokenClassification) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/roberta-prelayernorm.md
