...
- LED pads the `input_ids` to be a multiple of `config.attention_window` if required. A small speedup is gained when [LEDTokenizer](/docs/transformers/v5.17.0/en/model_doc/roberta#transformers.RobertaTokenizer) is used with the `pad_to_multiple_of` argument.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/configuration_led.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1083)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1122)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1160)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1198)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1236)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1739)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1765)
...
**Returns:** [LEDSeq2SeqModelOutput](/docs/transformers/v5.17.0/en/model_doc/led#transformers.models.led.modeling_led.LEDSeq2SeqModelOutput) or `tuple(torch.FloatTensor)`

A [LEDSeq2SeqModelOutput](/docs/transformers/v5.17.0/en/model_doc/led#transformers.models.led.modeling_led.LEDSeq2SeqModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](/docs/transformers/v5.17.0/en/model_doc/led#transformers.LEDConfig)) and inputs.

The [LEDModel](/docs/transformers/v5.17.0/en/model_doc/led#transformers.LEDModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1881)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L1913)
...
**Returns:** [LEDSeq2SeqLMOutput](/docs/transformers/v5.17.0/en/model_doc/led#transformers.models.led.modeling_led.LEDSeq2SeqLMOutput) or `tuple(torch.FloatTensor)`

A [LEDSeq2SeqLMOutput](/docs/transformers/v5.17.0/en/model_doc/led#transformers.models.led.modeling_led.LEDSeq2SeqLMOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](/docs/transformers/v5.17.0/en/model_doc/led#transformers.LEDConfig)) and inputs.

The [LEDForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/led#transformers.LEDForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L2071)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/led/modeling_led.py#L2084)
...
**Returns:** [LEDSeq2SeqQuestionAnsweringModelOutput](/docs/transformers/v5.17.0/en/model_doc/led#transformers.models.led.modeling_led.LEDSeq2SeqQuestionAnsweringModelOutput) or `tuple(torch.FloatTensor)`

A [LEDSeq2SeqQuestionAnsweringModelOutput](/docs/transformers/v5.17.0/en/model_doc/led#transformers.models.led.modeling_led.LEDSeq2SeqQuestionAnsweringModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([LEDConfig](/docs/transformers/v5.17.0/en/model_doc/led#transformers.LEDConfig)) and inputs.

The [LEDForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/led#transformers.LEDForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### DeBERTa-v2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/deberta-v2.md
