...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/configuration_dia.py#L87)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/configuration_dia.py#L164)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/configuration_dia.py#L47)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/configuration_dia.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/tokenization_dia.py#L23)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/feature_extraction_dia.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/feature_extraction_dia.py#L57)
...
return_tensors (`str` or [TensorType](/docs/transformers/v5.17.0/en/internal/file_utils#transformers.TensorType), *optional*, default to 'pt') : If set, will return tensors instead of list of python integers. Acceptable values are:  - `'pt'`: Return PyTorch `torch.Tensor` objects. - `'np'`: Return Numpy `np.ndarray` objects.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/processing_dia.py#L84)
...
audio_tokenizer (`DacModel`) : An instance of [DacModel](/docs/transformers/v5.17.0/en/model_doc/dac#transformers.DacModel) used to encode/decode audio into/from codebooks. It is a required input.
...
[~DiaFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/dia#transformers.DiaFeatureExtractor) and [~DiaTokenizer](/docs/transformers/v5.17.0/en/model_doc/dia#transformers.DiaTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/processing_dia.py#L144)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/processing_dia.py#L247)
...
`audio_tokenizer`. See [decode()](/docs/transformers/v5.17.0/en/model_doc/dac#transformers.DacModel.decode) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/processing_dia.py#L318)

Decodes a single sequence of audio codebooks into the respective audio waveform via the
`audio_tokenizer`. See [decode()](/docs/transformers/v5.17.0/en/model_doc/dac#transformers.DacModel.decode) and [batch_decode()](/docs/transformers/v5.17.0/en/model_doc/dia#transformers.DiaProcessor.batch_decode) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/modeling_dia.py#L649)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/modeling_dia.py#L657)
...
The [DiaModel](/docs/transformers/v5.17.0/en/model_doc/dia#transformers.DiaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/modeling_dia.py#L760)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/modeling_dia.py#L779)
...
The [DiaForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/dia#transformers.DiaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dia/generation_dia.py#L406)

### PatchTST
https://huggingface.co/docs/transformers/v5.17.0/model_doc/patchtst.md
