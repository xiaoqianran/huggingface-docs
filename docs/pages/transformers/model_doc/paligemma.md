...
- [PaliGemmaProcessor](/docs/transformers/v5.15.0/en/model_doc/paligemma#transformers.PaliGemmaProcessor) can prepare images, text, and optional labels for the model. Pass the `suffix` parameter to the processor to create labels for the model during fine-tuning.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/configuration_paligemma.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/processing_paligemma.py#L63)
...
[PaliGemmaProcessor](/docs/transformers/v5.15.0/en/model_doc/paligemma#transformers.PaliGemmaProcessor) offers all the functionalities of [SiglipImageProcessor](/docs/transformers/v5.15.0/en/model_doc/siglip#transformers.SiglipImageProcessor) and `tokenizer_class`. See the
[~SiglipImageProcessor](/docs/transformers/v5.15.0/en/model_doc/siglip#transformers.SiglipImageProcessor) and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/processing_paligemma.py#L94)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L121)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L175)
...
elements depending on the configuration ([PaliGemmaConfig](/docs/transformers/v5.15.0/en/model_doc/paligemma#transformers.PaliGemmaConfig)) and inputs.

The [PaliGemmaModel](/docs/transformers/v5.15.0/en/model_doc/paligemma#transformers.PaliGemmaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L137)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L151)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L293)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L306)
...
The [PaliGemmaForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/paligemma#transformers.PaliGemmaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/paligemma/modeling_paligemma.py#L302)
...
### xLSTM
https://huggingface.co/docs/transformers/v5.15.0/model_doc/xlstm.md
