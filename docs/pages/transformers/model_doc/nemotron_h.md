...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_h/configuration_nemotron_h.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_h/configuration_nemotron_h.py#L198)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_h/modeling_nemotron_h.py#L1033)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_h/modeling_nemotron_h.py#L1050)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_h/modeling_nemotron_h.py#L1114)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_h/modeling_nemotron_h.py#L1126)
...
elements depending on the configuration ([NemotronHConfig](/docs/transformers/v5.17.0/en/model_doc/nemotron_h#transformers.NemotronHConfig)) and inputs.

The [NemotronHForCausalLM](/docs/transformers/v5.17.0/en/model_doc/nemotron_h#transformers.NemotronHForCausalLM) forward method, overrides the `__call__` special method.
...
### Mistral 3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mistral3.md
