...
- There are 2 ways to fine-tune distilled models, either (1) in a classic way, by only placing a prediction head on top
  ...
  to [LevitForImageClassification](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitForImageClassification) and (2) corresponds to [LevitForImageClassificationWithTeacher](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitForImageClassificationWithTeacher).
- All released checkpoints were pre-trained and fine-tuned on  [ImageNet-1k](https://huggingface.co/datasets/ILSVRC/imagenet-1k)
  ...
  pre-training.
- The authors of LeViT released 5 trained LeViT models, which you can directly plug into [LevitModel](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitModel) or [LevitForImageClassification](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitForImageClassification).
  ...
  *facebook/levit-384*. Note that one should use [LevitImageProcessor](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitImageProcessor) in order to
  prepare images for the model.
- [LevitForImageClassificationWithTeacher](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitForImageClassificationWithTeacher) currently supports only inference and not training or fine-tuning.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/configuration_levit.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/image_processing_levit.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/image_processing_pil_levit.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/modeling_levit.py#L489)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/modeling_levit.py#L498)
...
elements depending on the configuration ([LevitConfig](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitConfig)) and inputs.

The [LevitModel](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/modeling_levit.py#L542)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/modeling_levit.py#L559)
...
The [LevitForImageClassification](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitForImageClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/modeling_levit.py#L605)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/levit/modeling_levit.py#L627)
...
The [LevitForImageClassificationWithTeacher](/docs/transformers/v5.17.0/en/model_doc/levit#transformers.LevitForImageClassificationWithTeacher) forward method, overrides the `__call__` special method.
...
### ViTDet
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vitdet.md
