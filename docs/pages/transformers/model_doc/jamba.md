...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/jamba/configuration_jamba.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/jamba/modeling_jamba.py#L811)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/jamba/modeling_jamba.py#L830)
...
elements depending on the configuration ([JambaConfig](/docs/transformers/v5.15.0/en/model_doc/jamba#transformers.JambaConfig)) and inputs.

The [JambaModel](/docs/transformers/v5.15.0/en/model_doc/jamba#transformers.JambaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/jamba/modeling_jamba.py#L973)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/jamba/modeling_jamba.py#L991)
...
The [JambaForCausalLM](/docs/transformers/v5.15.0/en/model_doc/jamba#transformers.JambaForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/jamba/modeling_jamba.py#L1076)
...
### GPT-NeoX-Japanese
https://huggingface.co/docs/transformers/v5.15.0/model_doc/gpt_neox_japanese.md
