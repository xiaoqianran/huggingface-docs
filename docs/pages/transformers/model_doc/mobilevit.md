...
The example below demonstrates how to do [Image Classification] with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) and the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
- Use [MobileViTImageProcessor](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTImageProcessor) to preprocess images.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/configuration_mobilevit.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/image_processing_mobilevit.py#L60)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/image_processing_mobilevit.py#L82)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/image_processing_mobilevit.py#L208)

**Parameters:**

outputs ([MobileViTForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTForSemanticSegmentation)) : Raw outputs of the model.
...
Converts the output of [MobileViTForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTForSemanticSegmentation) into semantic segmentation maps.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/image_processing_pil_mobilevit.py#L64)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/image_processing_pil_mobilevit.py#L86)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/image_processing_pil_mobilevit.py#L191)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/modeling_mobilevit.py#L613)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/modeling_mobilevit.py#L645)
...
elements depending on the configuration ([MobileViTConfig](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTConfig)) and inputs.

The [MobileViTModel](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/modeling_mobilevit.py#L695)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/modeling_mobilevit.py#L711)
...
The [MobileViTForImageClassification](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTForImageClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/modeling_mobilevit.py#L865)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilevit/modeling_mobilevit.py#L876)
...
The [MobileViTForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/mobilevit#transformers.MobileViTForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
### Gemma4 Unified
https://huggingface.co/docs/transformers/v5.17.0/model_doc/gemma4_unified.md
