...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pop2piano/configuration_pop2piano.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pop2piano/modeling_pop2piano.py#L763)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pop2piano/modeling_pop2piano.py#L851)
...
elements depending on the configuration ([Pop2PianoConfig](/docs/transformers/v5.17.0/en/model_doc/pop2piano#transformers.Pop2PianoConfig)) and inputs.

The [Pop2PianoForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/pop2piano#transformers.Pop2PianoForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pop2piano/modeling_pop2piano.py#L953)
...
### EoMT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/eomt.md
