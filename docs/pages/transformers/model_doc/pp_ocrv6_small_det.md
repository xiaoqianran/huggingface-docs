...
The example below demonstrates how to detect text with PP-OCRv6_small_det using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
Here is how you can do it with PP-OCRv6_small_det using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel):
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_small_det/modeling_pp_ocrv6_small_det.py#L314)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_small_det/configuration_pp_ocrv6_small_det.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_small_det/modeling_pp_ocrv6_small_det.py#L289)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_small_det/modeling_pp_ocrv6_small_det.py#L296)
...
elements depending on the configuration ([PPOCRV6SmallDetConfig](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_small_det#transformers.PPOCRV6SmallDetConfig)) and inputs.

The [PPOCRV6SmallDetModel](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_small_det#transformers.PPOCRV6SmallDetModel) forward method, overrides the `__call__` special method.
...
### ConvNeXT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/convnext.md
