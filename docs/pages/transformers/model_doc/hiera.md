...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/configuration_hiera.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/modeling_hiera.py#L793)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/modeling_hiera.py#L817)
...
elements depending on the configuration ([HieraConfig](/docs/transformers/v5.17.0/en/model_doc/hiera#transformers.HieraConfig)) and inputs.

The [HieraModel](/docs/transformers/v5.17.0/en/model_doc/hiera#transformers.HieraModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/modeling_hiera.py#L1061)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/modeling_hiera.py#L1102)
...
The [HieraForPreTraining](/docs/transformers/v5.17.0/en/model_doc/hiera#transformers.HieraForPreTraining) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/modeling_hiera.py#L1207)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hiera/modeling_hiera.py#L1222)
...
The [HieraForImageClassification](/docs/transformers/v5.17.0/en/model_doc/hiera#transformers.HieraForImageClassification) forward method, overrides the `__call__` special method.
...
### SAM3 Tracker Video
https://huggingface.co/docs/transformers/v5.17.0/model_doc/sam3_tracker_video.md
