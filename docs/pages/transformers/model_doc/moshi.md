...
**3. [MimiModel](/docs/transformers/v5.17.0/en/model_doc/mimi#transformers.MimiModel)**
...
[MoshiForConditionalGeneration.generate()](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiForConditionalGeneration.generate) thus needs 3 inputs:
...
Once it's done, you can simply forward `text_labels` and `audio_labels` to [MoshiForConditionalGeneration.forward()](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiForConditionalGeneration.forward), alongside the usual inputs, to get the model loss.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/configuration_moshi.py#L93)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/configuration_moshi.py#L201)

**Returns:** [MoshiConfig](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiConfig)

An instance of a configuration object

Instantiate a [MoshiConfig](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiConfig) (or a derived class) from an audio encoder configuration.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/configuration_moshi.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L801)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L820)
...
elements depending on the configuration ([MoshiConfig](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiConfig)) and inputs.

The [MoshiModel](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L916)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L929)
...
The [MoshiForCausalLM](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L1017)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L1044)
...
The [MoshiForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/moshi#transformers.MoshiForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L1347)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moshi/modeling_moshi.py#L1776)
...
### ELECTRA
https://huggingface.co/docs/transformers/v5.17.0/model_doc/electra.md
