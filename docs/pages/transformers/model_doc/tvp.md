...
The following example shows how to run temporal video grounding using [TvpProcessor](/docs/transformers/v5.17.0/en/model_doc/tvp#transformers.TvpProcessor) and [TvpForVideoGrounding](/docs/transformers/v5.17.0/en/model_doc/tvp#transformers.TvpForVideoGrounding).
...
- This implementation of TVP uses [BertTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutlm#transformers.BertTokenizer) to generate text embeddings and Resnet-50 model to compute visual embeddings.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/configuration_tvp.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/image_processing_tvp.py#L50)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/image_processing_tvp.py#L72)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/image_processing_pil_tvp.py#L72)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/image_processing_pil_tvp.py#L94)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/processing_tvp.py#L34)
...
[~TvpImageProcessor](/docs/transformers/v5.17.0/en/model_doc/tvp#transformers.TvpImageProcessor) and [~BertTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutlm#transformers.BertTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/modeling_tvp.py#L684)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/modeling_tvp.py#L707)
...
elements depending on the configuration ([TvpConfig](/docs/transformers/v5.17.0/en/model_doc/tvp#transformers.TvpConfig)) and inputs.

The [TvpModel](/docs/transformers/v5.17.0/en/model_doc/tvp#transformers.TvpModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/modeling_tvp.py#L803)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tvp/modeling_tvp.py#L812)
...
The [TvpForVideoGrounding](/docs/transformers/v5.17.0/en/model_doc/tvp#transformers.TvpForVideoGrounding) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vivit.md
