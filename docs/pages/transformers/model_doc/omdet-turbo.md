...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/omdet_turbo/configuration_omdet_turbo.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/omdet_turbo/processing_omdet_turbo.py#L190)
...
[~DetrImageProcessor](/docs/transformers/v5.15.0/en/model_doc/detr#transformers.DetrImageProcessor) and [~CLIPTokenizer](/docs/transformers/v5.15.0/en/model_doc/clip#transformers.CLIPTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/omdet_turbo/processing_omdet_turbo.py#L196)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/omdet_turbo/processing_omdet_turbo.py#L266)
...
Converts the raw output of [OmDetTurboForObjectDetection](/docs/transformers/v5.15.0/en/model_doc/omdet-turbo#transformers.OmDetTurboForObjectDetection) into final bounding boxes in (top_left_x, top_left_y,
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/omdet_turbo/modeling_omdet_turbo.py#L1464)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/omdet_turbo/modeling_omdet_turbo.py#L1494)
...
elements depending on the configuration ([OmDetTurboConfig](/docs/transformers/v5.15.0/en/model_doc/omdet-turbo#transformers.OmDetTurboConfig)) and inputs.

The [OmDetTurboForObjectDetection](/docs/transformers/v5.15.0/en/model_doc/omdet-turbo#transformers.OmDetTurboForObjectDetection) forward method, overrides the `__call__` special method.
...
### Qwen2
https://huggingface.co/docs/transformers/v5.15.0/model_doc/qwen2.md
