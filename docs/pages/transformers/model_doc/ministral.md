...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/configuration_ministral.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L337)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L354)
...
elements depending on the configuration ([MinistralConfig](/docs/transformers/v5.15.0/en/model_doc/ministral#transformers.MinistralConfig)) and inputs.

The [MinistralModel](/docs/transformers/v5.15.0/en/model_doc/ministral#transformers.MinistralModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L419)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L434)
...
The [MinistralForCausalLM](/docs/transformers/v5.15.0/en/model_doc/ministral#transformers.MinistralForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L493)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L497)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/ministral/modeling_ministral.py#L501)
...
### HRM-Text
https://huggingface.co/docs/transformers/v5.15.0/model_doc/hrm_text.md
