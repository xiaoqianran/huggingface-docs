...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xlstm/configuration_xlstm.py#L58)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xlstm/modeling_xlstm.py#L1396)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xlstm/modeling_xlstm.py#L1413)
...
elements depending on the configuration ([xLSTMConfig](/docs/transformers/v5.17.0/en/model_doc/xlstm#transformers.xLSTMConfig)) and inputs.

The [xLSTMModel](/docs/transformers/v5.17.0/en/model_doc/xlstm#transformers.xLSTMModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xlstm/modeling_xlstm.py#L1519)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/xlstm/modeling_xlstm.py#L1539)
...
The [xLSTMForCausalLM](/docs/transformers/v5.17.0/en/model_doc/xlstm#transformers.xLSTMForCausalLM) forward method, overrides the `__call__` special method.
...
### mBART
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mbart.md
