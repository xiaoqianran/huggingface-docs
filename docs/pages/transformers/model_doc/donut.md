...
The examples below demonstrate how to perform document understanding tasks using Donut with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) and [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/configuration_donut_swin.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/image_processing_donut.py#L46)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/image_processing_donut.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/image_processing_pil_donut.py#L46)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/image_processing_pil_donut.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/processing_donut.py#L39)
...
[DonutProcessor](/docs/transformers/v5.17.0/en/model_doc/donut#transformers.DonutProcessor) offers all the functionalities of `image_processor_class` and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/processing_donut.py#L45)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/modeling_donut_swin.py#L785)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/modeling_donut_swin.py#L809)
...
elements depending on the configuration ([DonutSwinConfig](/docs/transformers/v5.17.0/en/model_doc/donut#transformers.DonutSwinConfig)) and inputs.

The [DonutSwinModel](/docs/transformers/v5.17.0/en/model_doc/donut#transformers.DonutSwinModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/modeling_donut_swin.py#L881)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/donut/modeling_donut_swin.py#L896)
...
The [DonutSwinForImageClassification](/docs/transformers/v5.17.0/en/model_doc/donut#transformers.DonutSwinForImageClassification) forward method, overrides the `__call__` special method.
...
### DEIMv2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/deimv2.md
