...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/configuration_rt_detr.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/configuration_rt_detr_resnet.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/image_processing_rt_detr.py#L128)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/image_processing_rt_detr.py#L357)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/image_processing_rt_detr.py#L482)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/image_processing_pil_rt_detr.py#L130)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/image_processing_pil_rt_detr.py#L379)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/image_processing_pil_rt_detr.py#L507)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/modeling_rt_detr.py#L1424)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/modeling_rt_detr.py#L1544)
...
The [RTDetrModel](/docs/transformers/v5.17.0/en/model_doc/rt_detr#transformers.RTDetrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/modeling_rt_detr.py#L1750)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/modeling_rt_detr.py#L1771)
...
The [RTDetrForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/rt_detr#transformers.RTDetrForObjectDetection) forward method, overrides the `__call__` special method.
...
- **pred_boxes** (`torch.FloatTensor` of shape `(batch_size, num_queries, 4)`) -- Normalized boxes coordinates for all queries, represented as (center_x, center_y, width, height). These
  ...
  possible padding). You can use [post_process_object_detection()](/docs/transformers/v5.17.0/en/model_doc/rt_detr#transformers.RTDetrImageProcessor.post_process_object_detection) to retrieve the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/modeling_rt_detr_resnet.py#L349)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr/modeling_rt_detr_resnet.py#L362)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([RTDetrResNetConfig](/docs/transformers/v5.17.0/en/model_doc/rt_detr#transformers.RTDetrResNetConfig)) and inputs.

The [RTDetrResNetBackbone](/docs/transformers/v5.17.0/en/model_doc/rt_detr#transformers.RTDetrResNetBackbone) forward method, overrides the `__call__` special method.
...
### Gemma 3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/gemma3.md
