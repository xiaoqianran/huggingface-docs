...
The following example shows how to run masked language modeling using [BridgeTowerProcessor](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerProcessor) and [BridgeTowerForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerForMaskedLM).
...
- This implementation of BridgeTower uses [RobertaTokenizer](/docs/transformers/v5.17.0/en/model_doc/roberta#transformers.RobertaTokenizer) to generate text embeddings and OpenAI's CLIP/ViT model to compute visual embeddings.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/configuration_bridgetower.py#L104)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/configuration_bridgetower.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/configuration_bridgetower.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/image_processing_bridgetower.py#L81)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/image_processing_pil_bridgetower.py#L75)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/processing_bridgetower.py#L42)
...
[~BridgeTowerImageProcessor](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerImageProcessor) and [~RobertaTokenizer](/docs/transformers/v5.17.0/en/model_doc/roberta#transformers.RobertaTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1079)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1152)
...
elements depending on the configuration ([BridgeTowerConfig](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerConfig)) and inputs.

The [BridgeTowerModel](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1620)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1634)
...
The [BridgeTowerForContrastiveLearning](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerForContrastiveLearning) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1417)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1435)
...
The [BridgeTowerForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1518)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bridgetower/modeling_bridgetower.py#L1529)
...
The [BridgeTowerForImageAndTextRetrieval](/docs/transformers/v5.17.0/en/model_doc/bridgetower#transformers.BridgeTowerForImageAndTextRetrieval) forward method, overrides the `__call__` special method.
...
### Fun-ASR-Nano
https://huggingface.co/docs/transformers/v5.17.0/model_doc/fun_asr_nano.md
