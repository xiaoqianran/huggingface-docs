...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/configuration_pe_video.py#L91)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/configuration_pe_video.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/video_processing_pe_video.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/processing_pe_video.py#L4)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/modeling_pe_video.py#L511)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/modeling_pe_video.py#L530)
...
elements depending on the configuration ([PeVideoConfig](/docs/transformers/v5.17.0/en/model_doc/pe_video#transformers.PeVideoConfig)) and inputs.

The [PeVideoEncoder](/docs/transformers/v5.17.0/en/model_doc/pe_video#transformers.PeVideoEncoder) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/modeling_pe_video.py#L577)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pe_video/modeling_pe_video.py#L627)
...
The [PeVideoModel](/docs/transformers/v5.17.0/en/model_doc/pe_video#transformers.PeVideoModel) forward method, overrides the `__call__` special method.
...
### InstructBlipVideo
https://huggingface.co/docs/transformers/v5.17.0/model_doc/instructblipvideo.md
