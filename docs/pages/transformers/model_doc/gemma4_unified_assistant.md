...
```python
transformers.Gemma4UnifiedAssistantConfig(transformers_version: str | None = None, architectures: list[str] | None = None, output_hidden_states: bool | None = False, return_dict: bool | None = True, dtype: typing.Union[str, ForwardRef('torch.dtype'), NoneType] = None, chunk_size_feed_forward: int = 0, is_encoder_decoder: bool = False, id2label: dict[int, str] | dict[str, str] | None = None, label2id: dict[str, int] | dict[str, str] | None = None, problem_type: typing.Optional[typing.Literal['regression', 'single_label_classification', 'multi_label_classification']] = None, text_config: transformers.configuration_utils.PreTrainedConfig | dict[str, typing.Any] | None = None, backbone_hidden_size: int = 3840, use_ordered_embeddings: bool = False, num_centroids: int = 2048, centroid_intermediate_top_k: int = 32, tie_word_embeddings: bool = True)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_unified_assistant/configuration_gemma4_unified_assistant.py#L25)

**Parameters:**

text_config (`Union[~configuration_utils.PreTrainedConfig, dict[str, Any]]`, *optional*) : The config object or dictionary of the text backbone.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_unified_assistant/modeling_gemma4_unified_assistant.py#L116)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_unified_assistant/modeling_gemma4_unified_assistant.py#L212)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_unified_assistant/modeling_gemma4_unified_assistant.py#L141)
...
The [Gemma4UnifiedAssistantForCausalLM](/docs/transformers/v5.17.0/en/model_doc/gemma4_unified_assistant#transformers.Gemma4UnifiedAssistantForCausalLM) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/kyutai_speech_to_text.md
