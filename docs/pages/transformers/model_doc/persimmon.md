...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/configuration_persimmon.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/modeling_persimmon.py#L376)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/modeling_persimmon.py#L399)
...
elements depending on the configuration ([PersimmonConfig](/docs/transformers/v5.15.0/en/model_doc/persimmon#transformers.PersimmonConfig)) and inputs.

The [PersimmonModel](/docs/transformers/v5.15.0/en/model_doc/persimmon#transformers.PersimmonModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/modeling_persimmon.py#L456)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/modeling_persimmon.py#L469)
...
The [PersimmonForCausalLM](/docs/transformers/v5.15.0/en/model_doc/persimmon#transformers.PersimmonForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/modeling_persimmon.py#L532)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/persimmon/modeling_persimmon.py#L535)
...
### TIPSv2
https://huggingface.co/docs/transformers/v5.15.0/model_doc/tipsv2.md
