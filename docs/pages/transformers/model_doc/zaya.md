...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/zaya/configuration_zaya.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/zaya/configuration_zaya.py#L123)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/zaya/modeling_zaya.py#L691)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/zaya/modeling_zaya.py#L710)
...
elements depending on the configuration ([ZayaConfig](/docs/transformers/v5.17.0/en/model_doc/zaya#transformers.ZayaConfig)) and inputs.

The [ZayaModel](/docs/transformers/v5.17.0/en/model_doc/zaya#transformers.ZayaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/zaya/modeling_zaya.py#L793)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/zaya/modeling_zaya.py#L806)
...
The [ZayaForCausalLM](/docs/transformers/v5.17.0/en/model_doc/zaya#transformers.ZayaForCausalLM) forward method, overrides the `__call__` special method.
...
### MatCha
https://huggingface.co/docs/transformers/v5.17.0/model_doc/matcha.md
