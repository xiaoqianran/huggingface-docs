...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/configuration_cohere.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/tokenization_cohere.py#L45)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/tokenization_cohere.py#L297)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/tokenization_cohere.py#L186)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/modeling_cohere.py#L368)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/modeling_cohere.py#L385)
...
elements depending on the configuration ([CohereConfig](/docs/transformers/v5.17.0/en/model_doc/cohere#transformers.CohereConfig)) and inputs.

The [CohereModel](/docs/transformers/v5.17.0/en/model_doc/cohere#transformers.CohereModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/modeling_cohere.py#L442)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere/modeling_cohere.py#L459)
...
The [CohereForCausalLM](/docs/transformers/v5.17.0/en/model_doc/cohere#transformers.CohereForCausalLM) forward method, overrides the `__call__` special method.
...
### Blenderbot
https://huggingface.co/docs/transformers/v5.17.0/model_doc/blenderbot.md
