...
- Pixtral uses [PixtralVisionModel](/docs/transformers/v5.17.0/en/model_doc/pixtral#transformers.PixtralVisionModel) as the vision encoder and [MistralForCausalLM](/docs/transformers/v5.17.0/en/model_doc/mistral#transformers.MistralForCausalLM)  for its language decoder.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/configuration_pixtral.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/utils/dummy_mistral_common_objects.py#L5)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/modeling_pixtral.py#L388)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/modeling_pixtral.py#L411)
...
elements depending on the configuration ([PixtralVisionConfig](/docs/transformers/v5.17.0/en/model_doc/pixtral#transformers.PixtralVisionConfig)) and inputs.

The [PixtralVisionModel](/docs/transformers/v5.17.0/en/model_doc/pixtral#transformers.PixtralVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/image_processing_pixtral.py#L99)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/image_processing_pixtral.py#L117)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/image_processing_pil_pixtral.py#L107)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/image_processing_pil_pixtral.py#L125)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pixtral/processing_pixtral.py#L50)
...
[~PixtralImageProcessor](/docs/transformers/v5.17.0/en/model_doc/pixtral#transformers.PixtralImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
### BLIP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/blip.md
