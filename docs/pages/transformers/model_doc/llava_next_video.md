...
Then simply load the quantized model by adding [BitsAndBytesConfig](/docs/transformers/v5.15.0/en/main_classes/quantization#transformers.BitsAndBytesConfig) as shown below:
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/configuration_llava_next_video.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/processing_llava_next_video.py#L42)
...
[~LlavaNextVideoVideoProcessor](/docs/transformers/v5.15.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoVideoProcessor), [~LlavaNextImageProcessor](/docs/transformers/v5.15.0/en/model_doc/granitevision#transformers.LlavaNextImageProcessor), and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/video_processing_llava_next_video.py#L20)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L302)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L502)
...
elements depending on the configuration ([LlavaNextVideoConfig](/docs/transformers/v5.15.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoConfig)) and inputs.

The [LlavaNextVideoModel](/docs/transformers/v5.15.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L388)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L461)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L584)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L321)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L642)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L694)
...
The [LlavaNextVideoForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/llava_next_video#transformers.LlavaNextVideoForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L662)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next_video/modeling_llava_next_video.py#L815)
...
### VipLlava
https://huggingface.co/docs/transformers/v5.15.0/model_doc/vipllava.md
