...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoe/configuration_granitemoe.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoe/modeling_granitemoe.py#L404)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoe/modeling_granitemoe.py#L422)
...
elements depending on the configuration ([GraniteMoeConfig](/docs/transformers/v5.15.0/en/model_doc/granitemoe#transformers.GraniteMoeConfig)) and inputs.

The [GraniteMoeModel](/docs/transformers/v5.15.0/en/model_doc/granitemoe#transformers.GraniteMoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoe/modeling_granitemoe.py#L564)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoe/modeling_granitemoe.py#L583)
...
The [GraniteMoeForCausalLM](/docs/transformers/v5.15.0/en/model_doc/granitemoe#transformers.GraniteMoeForCausalLM) forward method, overrides the `__call__` special method.
...
### Parakeet
https://huggingface.co/docs/transformers/v5.15.0/model_doc/parakeet.md
