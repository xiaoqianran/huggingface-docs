...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/configuration_sew_d.py#L27)
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [SEWDForCTC](/docs/transformers/v5.17.0/en/model_doc/sew-d#transformers.SEWDForCTC).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/modeling_sew_d.py#L1190)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/modeling_sew_d.py#L1257)
...
elements depending on the configuration ([SEWDConfig](/docs/transformers/v5.17.0/en/model_doc/sew-d#transformers.SEWDConfig)) and inputs.

The [SEWDModel](/docs/transformers/v5.17.0/en/model_doc/sew-d#transformers.SEWDModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/modeling_sew_d.py#L1303)
...
target_lang (`str`, *optional*) : Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or adapter..bin. Only relevant when using an instance of [SEWDForCTC](/docs/transformers/v5.17.0/en/model_doc/sew-d#transformers.SEWDForCTC) with adapters. Uses 'eng' by default.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/modeling_sew_d.py#L1372)
...
The [SEWDForCTC](/docs/transformers/v5.17.0/en/model_doc/sew-d#transformers.SEWDForCTC) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/modeling_sew_d.py#L1442)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sew_d/modeling_sew_d.py#L1475)
...
The [SEWDForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/sew-d#transformers.SEWDForSequenceClassification) forward method, overrides the `__call__` special method.
...
### PP-OCRv5_server_det
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_ocrv5_server_det.md
