...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/configuration_mpt.py#L71)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L224)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L256)
...
elements depending on the configuration ([MptConfig](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptConfig)) and inputs.

The [MptModel](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L368)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L382)
...
The [MptForCausalLM](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L463)
...
[MptForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L476)
...
The [MptForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L582)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L600)
...
The [MptForTokenClassification](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L671)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mpt/modeling_mpt.py#L680)
...
The [MptForQuestionAnswering](/docs/transformers/v5.15.0/en/model_doc/mpt#transformers.MptForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### OLMo
https://huggingface.co/docs/transformers/v5.15.0/model_doc/olmo.md
