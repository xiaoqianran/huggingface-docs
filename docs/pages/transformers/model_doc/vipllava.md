...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/configuration_vipllava.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L134)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L207)
...
elements depending on the configuration ([VipLlavaConfig](/docs/transformers/v5.15.0/en/model_doc/vipllava#transformers.VipLlavaConfig)) and inputs.

The [VipLlavaModel](/docs/transformers/v5.15.0/en/model_doc/vipllava#transformers.VipLlavaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L143)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L183)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L270)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L300)
...
The [VipLlavaForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/vipllava#transformers.VipLlavaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vipllava/modeling_vipllava.py#L282)
...
### TVP
https://huggingface.co/docs/transformers/v5.15.0/model_doc/tvp.md
