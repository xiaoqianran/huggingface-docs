...
A [MiniMaxM3VLVisionModel](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLVisionModel): a `Conv3d` patch embedding over flattened `[N_patches, C·T·P·P]` input, a stack of
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/configuration_minimax_m3_vl.py#L189)
...
defaults will yield a similar configuration to that of the [MiniMaxAI/MiniMax-M3](https://huggingface.co/MiniMaxAI/MiniMax-M3)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/configuration_minimax_m3_vl.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/configuration_minimax_m3_vl.py#L160)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/processing_minimax_m3_vl.py#L31)
...
[~MiniMaxM3VLImageProcessor](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLImageProcessor), `~tokenizer_class`, and [~MiniMaxM3VLVideoProcessor](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLVideoProcessor) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/processing_minimax_m3_vl.py#L121)
...
This is a standalone (non-modular) image processor: it shares the patch-flattening idea of [Qwen2VLImageProcessor](/docs/transformers/v5.17.0/en/model_doc/qwen2_vl#transformers.Qwen2VLImageProcessor)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/image_processing_minimax_m3_vl.py#L86)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/image_processing_minimax_m3_vl.py#L255)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/image_processing_minimax_m3_vl.py#L163)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/image_processing_minimax_m3_vl.py#L129)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/image_processing_minimax_m3_vl.py#L137)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/video_processing_minimax_m3_vl.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L1182)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L1200)
...
The [MiniMaxM3VLVisionModel](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L716)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L733)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MiniMaxM3VLConfig](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLConfig)) and inputs.

The [MiniMaxM3VLTextModel](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L1308)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L1377)
...
The [MiniMaxM3VLModel](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L865)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L884)
...
The [MiniMaxM3VLForCausalLM](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3VLForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L1454)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax_m3_vl/modeling_minimax_m3_vl.py#L1471)
...
The [MiniMaxM3SparseForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/minimax_m3_vl#transformers.MiniMaxM3SparseForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### D-FINE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/d_fine.md
