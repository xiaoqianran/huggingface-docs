...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/upernet/configuration_upernet.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/upernet/modeling_upernet.py#L278)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/upernet/modeling_upernet.py#L293)
...
elements depending on the configuration ([UperNetConfig](/docs/transformers/v5.17.0/en/model_doc/upernet#transformers.UperNetConfig)) and inputs.

The [UperNetForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/upernet#transformers.UperNetForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
### Persimmon
https://huggingface.co/docs/transformers/v5.17.0/model_doc/persimmon.md
