...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v2/configuration_deepseek_v2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L492)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L509)
...
elements depending on the configuration ([DeepseekV2Config](/docs/transformers/v5.15.0/en/model_doc/deepseek_v2#transformers.DeepseekV2Config)) and inputs.

The [DeepseekV2Model](/docs/transformers/v5.15.0/en/model_doc/deepseek_v2#transformers.DeepseekV2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L566)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L581)
...
The [DeepseekV2ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/deepseek_v2#transformers.DeepseekV2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v2/modeling_deepseek_v2.py#L640)
...
### Granite4Vision
https://huggingface.co/docs/transformers/v5.15.0/model_doc/granite4_vision.md
