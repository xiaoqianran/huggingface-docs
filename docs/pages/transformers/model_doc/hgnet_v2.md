...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hgnet_v2/configuration_hgnet_v2.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hgnet_v2/modeling_hgnet_v2.py#L343)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hgnet_v2/modeling_hgnet_v2.py#L356)
...
elements depending on the configuration ([HGNetV2Config](/docs/transformers/v5.17.0/en/model_doc/hgnet_v2#transformers.HGNetV2Config)) and inputs.

The [HGNetV2Backbone](/docs/transformers/v5.17.0/en/model_doc/hgnet_v2#transformers.HGNetV2Backbone) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hgnet_v2/modeling_hgnet_v2.py#L420)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hgnet_v2/modeling_hgnet_v2.py#L436)
...
The [HGNetV2ForImageClassification](/docs/transformers/v5.17.0/en/model_doc/hgnet_v2#transformers.HGNetV2ForImageClassification) forward method, overrides the `__call__` special method.
...
### MuseGlimmer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/muse_glimmer.md
