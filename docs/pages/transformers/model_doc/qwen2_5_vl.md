...
- Use the `min_pixels` and `max_pixels` parameters in [AutoProcessor](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoProcessor) to set the resolution.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/configuration_qwen2_5_vl.py#L162)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/configuration_qwen2_5_vl.py#L36)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/configuration_qwen2_5_vl.py#L72)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/processing_qwen2_5_vl.py#L41)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L772)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L798)
...
elements depending on the configuration ([Qwen2_5_VLConfig](/docs/transformers/v5.17.0/en/model_doc/qwen2_5_vl#transformers.Qwen2_5_VLConfig)) and inputs.

The [Qwen2_5_VLTextModel](/docs/transformers/v5.17.0/en/model_doc/qwen2_5_vl#transformers.Qwen2_5_VLTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L887)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1194)
...
The [Qwen2_5_VLModel](/docs/transformers/v5.17.0/en/model_doc/qwen2_5_vl#transformers.Qwen2_5_VLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1071)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1088)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1279)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1317)
...
The [Qwen2_5_VLForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/qwen2_5_vl#transformers.Qwen2_5_VLForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1291)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1304)
...
### Mistral
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mistral.md
