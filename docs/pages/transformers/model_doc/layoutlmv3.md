...
- Regarding usage of [LayoutLMv3Processor](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3Processor), we refer to the [usage guide](layoutlmv2#usage-layoutlmv2processor) of its predecessor.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/configuration_layoutlmv3.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/image_processing_layoutlmv3.py#L124)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/image_processing_layoutlmv3.py#L140)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/image_processing_pil_layoutlmv3.py#L123)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/image_processing_pil_layoutlmv3.py#L139)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L114)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L240)
...
#### batch_encode_plus[[transformers.LayoutLMv3Tokenizer.batch_encode_plus]]

```python
batch_encode_plus(batch_text_or_text_pairs: list[str] | list[tuple[str, str]] | list[list[str]], is_pair: bool | None = None, boxes: list[list[list[int]]] | None = None, word_labels: list[int] | list[list[int]] | None = None, add_special_tokens: bool = True, padding: bool | str | transformers.utils.generic.PaddingStrategy = False, truncation: bool | str | transformers.tokenization_utils_base.TruncationStrategy | None = None, max_length: int | None = None, stride: int = 0, pad_to_multiple_of: int | None = None, padding_side: str | None = None, return_tensors: str | transformers.utils.generic.TensorType | None = None, return_token_type_ids: bool | None = None, return_attention_mask: bool | None = None, return_overflowing_tokens: bool = False, return_special_tokens_mask: bool = False, return_offsets_mapping: bool = False, return_length: bool = False, verbose: bool = True, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L392)
...
#### build_inputs_with_special_tokens[[transformers.LayoutLMv3Tokenizer.build_inputs_with_special_tokens]]

```python
build_inputs_with_special_tokens(token_ids_0, token_ids_1 = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L835)
...
#### encode_plus[[transformers.LayoutLMv3Tokenizer.encode_plus]]

```python
encode_plus(text: str | list[str], text_pair: list[str] | None = None, boxes: list[list[int]] | None = None, word_labels: list[int] | None = None, add_special_tokens: bool = True, padding: bool | str | transformers.utils.generic.PaddingStrategy = False, truncation: bool | str | transformers.tokenization_utils_base.TruncationStrategy | None = None, max_length: int | None = None, stride: int = 0, pad_to_multiple_of: int | None = None, padding_side: str | None = None, return_tensors: str | transformers.utils.generic.TensorType | None = None, return_token_type_ids: bool | None = None, return_attention_mask: bool | None = None, return_overflowing_tokens: bool = False, return_special_tokens_mask: bool = False, return_offsets_mapping: bool = False, return_length: bool = False, verbose: bool = True, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L457)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/processing_layoutlmv3.py#L24)
...
[~LayoutLMv3ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3ImageProcessor) and [~LayoutLMv3Tokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3Tokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/processing_layoutlmv3.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L537)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L620)
...
elements depending on the configuration ([LayoutLMv3Config](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config)) and inputs.

The [LayoutLMv3Model](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1049)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1065)
...
The [LayoutLMv3ForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3ForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L834)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L854)
...
The [LayoutLMv3ForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3ForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L934)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L950)
...
The [LayoutLMv3ForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/layoutlmv3#transformers.LayoutLMv3ForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### ERNIE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/ernie.md
