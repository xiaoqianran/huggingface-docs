...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/configuration_mvp.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L870)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L906)
...
elements depending on the configuration ([MvpConfig](/docs/transformers/v5.15.0/en/model_doc/mvp#transformers.MvpConfig)) and inputs.

The [MvpModel](/docs/transformers/v5.15.0/en/model_doc/mvp#transformers.MvpModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1018)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1052)
...
The [MvpForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/mvp#transformers.MvpForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1183)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1201)
...
The [MvpForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/mvp#transformers.MvpForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1348)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1365)
...
The [MvpForQuestionAnswering](/docs/transformers/v5.15.0/en/model_doc/mvp#transformers.MvpForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1519)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mvp/modeling_mvp.py#L1543)
...
The [MvpForCausalLM](/docs/transformers/v5.15.0/en/model_doc/mvp#transformers.MvpForCausalLM) forward method, overrides the `__call__` special method.
...
### TAPAS
https://huggingface.co/docs/transformers/v5.15.0/model_doc/tapas.md
