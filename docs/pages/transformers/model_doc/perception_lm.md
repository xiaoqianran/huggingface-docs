...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/configuration_perception_lm.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/processing_perception_lm.py#L32)
...
[~PerceptionLMVideoProcessor](/docs/transformers/v5.17.0/en/model_doc/perception_lm#transformers.PerceptionLMVideoProcessor), [~PerceptionLMImageProcessor](/docs/transformers/v5.17.0/en/model_doc/perception_lm#transformers.PerceptionLMImageProcessor), and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/image_processing_perception_lm.py#L52)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/image_processing_perception_lm.py#L69)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/video_processing_perception_lm.py#L19)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/modeling_perception_lm.py#L166)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/modeling_perception_lm.py#L233)
...
elements depending on the configuration ([PerceptionLMConfig](/docs/transformers/v5.17.0/en/model_doc/perception_lm#transformers.PerceptionLMConfig)) and inputs.

The [PerceptionLMModel](/docs/transformers/v5.17.0/en/model_doc/perception_lm#transformers.PerceptionLMModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/modeling_perception_lm.py#L174)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/modeling_perception_lm.py#L192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/modeling_perception_lm.py#L297)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/perception_lm/modeling_perception_lm.py#L309)
...
The [PerceptionLMForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/perception_lm#transformers.PerceptionLMForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### Swin2SR
https://huggingface.co/docs/transformers/v5.17.0/model_doc/swin2sr.md
