...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/configuration_bloom.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L416)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L447)
...
elements depending on the configuration ([BloomConfig](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomConfig)) and inputs.

The [BloomModel](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L560)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L609)
...
The [BloomForCausalLM](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L695)
...
[BloomForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L705)
...
The [BloomForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L811)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L829)
...
The [BloomForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L900)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bloom/modeling_bloom.py#L909)
...
The [BloomForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/bloom#transformers.BloomForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### PPLCNetV3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_lcnet_v3.md
