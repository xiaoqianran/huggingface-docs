...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/configuration_idefics.py#L77)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/configuration_idefics.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/configuration_idefics.py#L49)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/modeling_idefics.py#L856)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/modeling_idefics.py#L931)
...
elements depending on the configuration ([IdeficsConfig](/docs/transformers/v5.15.0/en/model_doc/idefics#transformers.IdeficsConfig)) and inputs.

The [IdeficsModel](/docs/transformers/v5.15.0/en/model_doc/idefics#transformers.IdeficsModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/modeling_idefics.py#L1084)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/modeling_idefics.py#L1107)
...
The [IdeficsForVisionText2Text](/docs/transformers/v5.15.0/en/model_doc/idefics#transformers.IdeficsForVisionText2Text) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/image_processing_idefics.py#L52)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/image_processing_idefics.py#L71)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/image_processing_pil_idefics.py#L51)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/image_processing_pil_idefics.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/processing_idefics.py#L146)
...
[~IdeficsImageProcessor](/docs/transformers/v5.15.0/en/model_doc/idefics#transformers.IdeficsImageProcessor) and [~LlamaTokenizer](/docs/transformers/v5.15.0/en/model_doc/llama2#transformers.LlamaTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/idefics/processing_idefics.py#L173)
...
### LayoutXLM
https://huggingface.co/docs/transformers/v5.15.0/model_doc/layoutxlm.md
