...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/configuration_fuyu.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L51)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L145)
...
elements depending on the configuration ([FuyuConfig](/docs/transformers/v5.15.0/en/model_doc/fuyu#transformers.FuyuConfig)) and inputs.

The [FuyuModel](/docs/transformers/v5.15.0/en/model_doc/fuyu#transformers.FuyuModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L109)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L121)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L208)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/modeling_fuyu.py#L217)
...
The [FuyuForCausalLM](/docs/transformers/v5.15.0/en/model_doc/fuyu#transformers.FuyuForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/image_processing_fuyu.py#L74)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/image_processing_pil_fuyu.py#L76)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/processing_fuyu.py#L333)
...
[~FuyuImageProcessor](/docs/transformers/v5.15.0/en/model_doc/fuyu#transformers.FuyuImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/fuyu/processing_fuyu.py#L488)
...
### LightGlue
https://huggingface.co/docs/transformers/v5.15.0/model_doc/lightglue.md
