...
Load the quantized model by simply adding [BitsAndBytesConfig](/docs/transformers/v5.17.0/en/main_classes/quantization#transformers.BitsAndBytesConfig) as shown below:
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/configuration_video_llava.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/image_processing_video_llava.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/image_processing_video_llava.py#L167)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/video_processing_video_llava.py#L20)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/processing_video_llava.py#L37)
...
[~VideoLlavaImageProcessor](/docs/transformers/v5.17.0/en/model_doc/video_llava#transformers.VideoLlavaImageProcessor), [~VideoLlavaVideoProcessor](/docs/transformers/v5.17.0/en/model_doc/video_llava#transformers.VideoLlavaVideoProcessor), and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L153)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L299)
...
elements depending on the configuration ([VideoLlavaConfig](/docs/transformers/v5.17.0/en/model_doc/video_llava#transformers.VideoLlavaConfig)) and inputs.

The [VideoLlavaModel](/docs/transformers/v5.17.0/en/model_doc/video_llava#transformers.VideoLlavaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L164)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L256)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L213)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L375)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L415)
...
The [VideoLlavaForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/video_llava#transformers.VideoLlavaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/video_llava/modeling_video_llava.py#L387)
...
### InstructBLIP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/instructblip.md
