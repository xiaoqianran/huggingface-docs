...
The example below demonstrates how to summarize text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
- BigBirdPegasus also uses the [PegasusTokenizer](/docs/transformers/v5.17.0/en/model_doc/pegasus#transformers.PegasusTokenizer).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/configuration_bigbird_pegasus.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L1812)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L1841)
...
elements depending on the configuration ([BigBirdPegasusConfig](/docs/transformers/v5.17.0/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig)) and inputs.

The [BigBirdPegasusModel](/docs/transformers/v5.17.0/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L1924)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L1959)
...
The [BigBirdPegasusForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2069)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2083)
...
The [BigBirdPegasusForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2186)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2199)
...
The [BigBirdPegasusForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2296)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2314)
...
The [BigBirdPegasusForCausalLM](/docs/transformers/v5.17.0/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForCausalLM) forward method, overrides the `__call__` special method.
...
### EuroBERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/eurobert.md
