...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/configuration_conditional_detr.py#L26)
...
num_queries (`int`, *optional*, defaults to 300) : Number of object queries, i.e. detection slots. This is the maximal number of objects [ConditionalDetrModel](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrModel) can detect in a single image. For COCO, we recommend 100 queries.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_conditional_detr.py#L426)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_conditional_detr.py#L671)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_pil_conditional_detr.py#L429)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_pil_conditional_detr.py#L697)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_pil_conditional_detr.py#L842)
...
Converts the raw output of [ConditionalDetrForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForObjectDetection) into final bounding boxes in (top_left_x,
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_pil_conditional_detr.py#L976)

**Parameters:**

outputs ([ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation)) : Raw outputs of the model.
...
Converts the output of [ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation) into instance segmentation predictions. Only supports PyTorch.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_pil_conditional_detr.py#L903)
...
Converts the output of [ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation) into semantic segmentation maps. Only supports PyTorch.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/image_processing_pil_conditional_detr.py#L1065)

**Parameters:**

outputs ([ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation)) : The outputs from [ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation).
...
Converts the output of [ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation) into image panoptic segmentation predictions. Only supports
PyTorch.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1337)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1366)
...
The [ConditionalDetrModel](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1509)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1523)
...
The [ConditionalDetrForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForObjectDetection) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1655)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/conditional_detr/modeling_conditional_detr.py#L1677)
...
The [ConditionalDetrForSegmentation](/docs/transformers/v5.17.0/en/model_doc/conditional_detr#transformers.ConditionalDetrForSegmentation) forward method, overrides the `__call__` special method.
...
### PP-OCRv6_small_rec
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_ocrv6_small_rec.md
