...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/recurrent_gemma/configuration_recurrent_gemma.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/recurrent_gemma/modeling_recurrent_gemma.py#L628)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/recurrent_gemma/modeling_recurrent_gemma.py#L645)
...
elements depending on the configuration ([RecurrentGemmaConfig](/docs/transformers/v5.17.0/en/model_doc/recurrent_gemma#transformers.RecurrentGemmaConfig)) and inputs.

The [RecurrentGemmaModel](/docs/transformers/v5.17.0/en/model_doc/recurrent_gemma#transformers.RecurrentGemmaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/recurrent_gemma/modeling_recurrent_gemma.py#L707)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/recurrent_gemma/modeling_recurrent_gemma.py#L719)
...
The [RecurrentGemmaForCausalLM](/docs/transformers/v5.17.0/en/model_doc/recurrent_gemma#transformers.RecurrentGemmaForCausalLM) forward method, overrides the `__call__` special method.
...
### MobileViT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mobilevit.md
