...
- If you're using Transformers < 4.37.0.dev, set `trust_remote_code=True` in [from_pretrained()](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoModel.from_pretrained). Otherwise, make sure you update Transformers to the latest stable version.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/configuration_phi.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/modeling_phi.py#L322)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/modeling_phi.py#L340)
...
elements depending on the configuration ([PhiConfig](/docs/transformers/v5.15.0/en/model_doc/phi#transformers.PhiConfig)) and inputs.

The [PhiModel](/docs/transformers/v5.15.0/en/model_doc/phi#transformers.PhiModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/modeling_phi.py#L399)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/modeling_phi.py#L414)
...
The [PhiForCausalLM](/docs/transformers/v5.15.0/en/model_doc/phi#transformers.PhiForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/modeling_phi.py#L473)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/phi/modeling_phi.py#L477)
...
### Fuyu
https://huggingface.co/docs/transformers/v5.15.0/model_doc/fuyu.md
