...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/modeling_oneformer.py#L820)
...
Class for outputs of [OneFormerModel](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerModel). This class returns all the needed hidden states to compute the logits.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/modeling_oneformer.py#L877)
...
This output can be directly passed to [post_process_semantic_segmentation()](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerImageProcessor.post_process_semantic_segmentation) or
[post_process_instance_segmentation()](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerImageProcessor.post_process_instance_segmentation) or
[post_process_panoptic_segmentation()](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerImageProcessor.post_process_panoptic_segmentation) depending on the task. Please, see
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/configuration_oneformer.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_oneformer.py#L275)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_oneformer.py#L300)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_oneformer.py#L690)

**Parameters:**

outputs ([OneFormerForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerForUniversalSegmentation)) : Raw outputs of the model.
...
Converts the output of [OneFormerForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerForUniversalSegmentation) into semantic segmentation maps. Only supports
PyTorch.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_oneformer.py#L766)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_oneformer.py#L886)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_pil_oneformer.py#L293)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_pil_oneformer.py#L318)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_pil_oneformer.py#L746)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_pil_oneformer.py#L820)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/image_processing_pil_oneformer.py#L940)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/processing_oneformer.py#L27)
...
[~OneFormerImageProcessor](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerImageProcessor) and [~CLIPTokenizer](/docs/transformers/v5.17.0/en/model_doc/clip#transformers.CLIPTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/processing_oneformer.py#L61)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/modeling_oneformer.py#L2845)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/modeling_oneformer.py#L2862)
...
**Returns:** [OneFormerModelOutput](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.models.oneformer.modeling_oneformer.OneFormerModelOutput) or `tuple(torch.FloatTensor)`

A [OneFormerModelOutput](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.models.oneformer.modeling_oneformer.OneFormerModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([OneFormerConfig](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerConfig)) and inputs.

The [OneFormerModel](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/modeling_oneformer.py#L2981)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/oneformer/modeling_oneformer.py#L3048)
...
**Returns:** [OneFormerForUniversalSegmentationOutput](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.models.oneformer.modeling_oneformer.OneFormerForUniversalSegmentationOutput) or `tuple(torch.FloatTensor)`

A [OneFormerForUniversalSegmentationOutput](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.models.oneformer.modeling_oneformer.OneFormerForUniversalSegmentationOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([OneFormerConfig](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerConfig)) and inputs.

The [OneFormerForUniversalSegmentation](/docs/transformers/v5.17.0/en/model_doc/oneformer#transformers.OneFormerForUniversalSegmentation) forward method, overrides the `__call__` special method.
...
### ViTMAE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/vit_mae.md
