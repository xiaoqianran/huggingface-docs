...
The example below demonstrates how to perform optical character recognition (OCR) with the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/trocr/configuration_trocr.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/trocr/processing_trocr.py#L30)
...
[~ViTImageProcessor](/docs/transformers/v5.17.0/en/model_doc/vit#transformers.ViTImageProcessor) and [~XLMRobertaTokenizer](/docs/transformers/v5.17.0/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/trocr/processing_trocr.py#L34)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/trocr/modeling_trocr.py#L639)
...
The TrOCR Decoder with a language modeling head. Can be used as the decoder part of [EncoderDecoderModel](/docs/transformers/v5.17.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel) and
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/trocr/modeling_trocr.py#L665)
...
elements depending on the configuration ([TrOCRConfig](/docs/transformers/v5.17.0/en/model_doc/trocr#transformers.TrOCRConfig)) and inputs.

The [TrOCRForCausalLM](/docs/transformers/v5.17.0/en/model_doc/trocr#transformers.TrOCRForCausalLM) forward method, overrides the `__call__` special method.
...
https://huggingface.co/docs/transformers/v5.17.0/model_doc/cvt.md
