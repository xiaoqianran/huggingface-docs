...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/configuration_granite4_vision.py#L101)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/configuration_granite4_vision.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/processing_granite4_vision.py#L42)
...
[Granite4VisionProcessor](/docs/transformers/v5.17.0/en/model_doc/granite4_vision#transformers.Granite4VisionProcessor) offers all the functionalities of [LlavaNextImageProcessor](/docs/transformers/v5.17.0/en/model_doc/granitevision#transformers.LlavaNextImageProcessor) and `tokenizer_class`. See the
[~LlavaNextImageProcessor](/docs/transformers/v5.17.0/en/model_doc/granitevision#transformers.LlavaNextImageProcessor) and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L751)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L955)
...
elements depending on the configuration ([Granite4VisionConfig](/docs/transformers/v5.17.0/en/model_doc/granite4_vision#transformers.Granite4VisionConfig)) and inputs.

The [Granite4VisionModel](/docs/transformers/v5.17.0/en/model_doc/granite4_vision#transformers.Granite4VisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L843)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L932)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L784)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L544)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L566)
...
The [Granite4VisionTextModel](/docs/transformers/v5.17.0/en/model_doc/granite4_vision#transformers.Granite4VisionTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L1033)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L1085)
...
The [Granite4VisionForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/granite4_vision#transformers.Granite4VisionForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granite4_vision/modeling_granite4_vision.py#L1053)
...
### Lfm2Moe
https://huggingface.co/docs/transformers/v5.17.0/model_doc/lfm2_moe.md
