...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/apertus/configuration_apertus.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/apertus/modeling_apertus.py#L341)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/apertus/modeling_apertus.py#L358)
...
elements depending on the configuration ([ApertusConfig](/docs/transformers/v5.17.0/en/model_doc/apertus#transformers.ApertusConfig)) and inputs.

The [ApertusModel](/docs/transformers/v5.17.0/en/model_doc/apertus#transformers.ApertusModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/apertus/modeling_apertus.py#L415)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/apertus/modeling_apertus.py#L430)
...
The [ApertusForCausalLM](/docs/transformers/v5.17.0/en/model_doc/apertus#transformers.ApertusForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/apertus/modeling_apertus.py#L494)
...
### Qwen2Audio
https://huggingface.co/docs/transformers/v5.17.0/model_doc/qwen2_audio.md
