...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/configuration_edgetam.py#L152)

**Parameters:**

vision_config (`Union[dict, ~configuration_utils.PreTrainedConfig]`, *optional*) : The config object or dictionary of the vision backbone.

prompt_encoder_config (Union[`dict`, `EdgeTamPromptEncoderConfig`], *optional*) : Dictionary of configuration options used to initialize [EdgeTamPromptEncoderConfig](/docs/transformers/v5.17.0/en/model_doc/edgetam#transformers.EdgeTamPromptEncoderConfig).

mask_decoder_config (Union[`dict`, `EdgeTamMaskDecoderConfig`], *optional*) : Dictionary of configuration options used to initialize [EdgeTamMaskDecoderConfig](/docs/transformers/v5.17.0/en/model_doc/edgetam#transformers.EdgeTamMaskDecoderConfig).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/configuration_edgetam.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/configuration_edgetam.py#L114)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/configuration_edgetam.py#L90)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/modeling_edgetam.py#L452)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/modeling_edgetam.py#L470)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/modeling_edgetam.py#L945)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/modeling_edgetam.py#L1051)
...
elements depending on the configuration ([EdgeTamConfig](/docs/transformers/v5.17.0/en/model_doc/edgetam#transformers.EdgeTamConfig)) and inputs.

The [EdgeTamModel](/docs/transformers/v5.17.0/en/model_doc/edgetam#transformers.EdgeTamModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/edgetam/modeling_edgetam.py#L1229)
...
### DeepSeek-V4
https://huggingface.co/docs/transformers/v5.17.0/model_doc/deepseek_v4.md
