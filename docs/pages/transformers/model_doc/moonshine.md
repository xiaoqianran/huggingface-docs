...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine/configuration_moonshine.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine/modeling_moonshine.py#L714)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine/modeling_moonshine.py#L743)
...
elements depending on the configuration ([MoonshineConfig](/docs/transformers/v5.17.0/en/model_doc/moonshine#transformers.MoonshineConfig)) and inputs.

The [MoonshineModel](/docs/transformers/v5.17.0/en/model_doc/moonshine#transformers.MoonshineModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine/modeling_moonshine.py#L736)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine/modeling_moonshine.py#L836)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/moonshine/modeling_moonshine.py#L856)
...
The [MoonshineForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/moonshine#transformers.MoonshineForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### Informer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/informer.md
