...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/configuration_qwen3_vl.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/configuration_qwen3_vl.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/configuration_qwen3_vl.py#L62)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/processing_qwen3_vl.py#L42)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L112)
...
#### get_num_of_video_patches[[transformers.Qwen3VLVideoProcessor.get_num_of_video_patches]]

```python
get_num_of_video_patches(num_frames: int, height: int, width: int, videos_kwargs = None)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L343)
...
Number of placeholder tokens required and number of patches per image.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L226)
...
```python
resize(videos: torch.Tensor, size: SizeDict, resample: PILImageResampling | tvF.InterpolationMode | int | None, factor: int, temporal_factor: int, cap_pixels_per_frame: bool | None = None, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L188)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/video_processing_qwen3_vl.py#L139)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L642)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L689)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L753)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L773)
...
elements depending on the configuration ([Qwen3VLConfig](/docs/transformers/v5.17.0/en/model_doc/qwen3_vl#transformers.Qwen3VLConfig)) and inputs.

The [Qwen3VLTextModel](/docs/transformers/v5.17.0/en/model_doc/qwen3_vl#transformers.Qwen3VLTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L873)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1154)
...
The [Qwen3VLModel](/docs/transformers/v5.17.0/en/model_doc/qwen3_vl#transformers.Qwen3VLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1032)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1044)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1267)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1305)
...
The [Qwen3VLForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/qwen3_vl#transformers.Qwen3VLForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1279)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_vl/modeling_qwen3_vl.py#L1292)
...
### NemotronH
https://huggingface.co/docs/transformers/v5.17.0/model_doc/nemotron_h.md
