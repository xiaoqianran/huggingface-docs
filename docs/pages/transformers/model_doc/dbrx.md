...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dbrx/configuration_dbrx.py#L104)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dbrx/modeling_dbrx.py#L466)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dbrx/modeling_dbrx.py#L495)
...
elements depending on the configuration ([DbrxConfig](/docs/transformers/v5.15.0/en/model_doc/dbrx#transformers.DbrxConfig)) and inputs.

The [DbrxModel](/docs/transformers/v5.15.0/en/model_doc/dbrx#transformers.DbrxModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dbrx/modeling_dbrx.py#L636)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dbrx/modeling_dbrx.py#L671)
...
The [DbrxForCausalLM](/docs/transformers/v5.15.0/en/model_doc/dbrx#transformers.DbrxForCausalLM) forward method, overrides the `__call__` special method.
...
### DePlot
https://huggingface.co/docs/transformers/v5.15.0/model_doc/deplot.md
