...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/table_transformer/configuration_table_transformer.py#L26)
...
num_queries (`int`, *optional*, defaults to 100) : Number of object queries, i.e. detection slots. This is the maximal number of objects [TableTransformerModel](/docs/transformers/v5.17.0/en/model_doc/table-transformer#transformers.TableTransformerModel) can detect in a single image. For COCO, we recommend 100 queries.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/table_transformer/modeling_table_transformer.py#L967)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/table_transformer/modeling_table_transformer.py#L996)
...
elements depending on the configuration ([TableTransformerConfig](/docs/transformers/v5.17.0/en/model_doc/table-transformer#transformers.TableTransformerConfig)) and inputs.

The [TableTransformerModel](/docs/transformers/v5.17.0/en/model_doc/table-transformer#transformers.TableTransformerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/table_transformer/modeling_table_transformer.py#L1136)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/table_transformer/modeling_table_transformer.py#L1155)
...
The [TableTransformerForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/table-transformer#transformers.TableTransformerForObjectDetection) forward method, overrides the `__call__` special method.
...
### Hy4-Preview
https://huggingface.co/docs/transformers/v5.17.0/model_doc/hy_v4.md
