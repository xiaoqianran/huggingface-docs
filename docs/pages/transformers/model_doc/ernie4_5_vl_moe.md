...
image_processor (`Ernie4_5_VLMoeImageProcessor`) : The image processor is a required input.

tokenizer (`tokenizer_class`) : The tokenizer is a required input.

video_processor (`Ernie4_5_VLMoeVideoProcessor`) : The video processor is a required input.
