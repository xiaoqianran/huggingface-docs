...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_moe/configuration_lfm2_moe.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L638)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L653)
...
elements depending on the configuration ([Lfm2MoeConfig](/docs/transformers/v5.15.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeConfig)) and inputs.

The [Lfm2MoeForCausalLM](/docs/transformers/v5.15.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L558)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L575)
...
The [Lfm2MoeModel](/docs/transformers/v5.15.0/en/model_doc/lfm2_moe#transformers.Lfm2MoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/lfm2_moe/modeling_lfm2_moe.py#L527)
...
### MaskFormer
https://huggingface.co/docs/transformers/v5.15.0/model_doc/maskformer.md
