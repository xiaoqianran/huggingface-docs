...
- [Wav2Vec2BertForCTC](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForCTC) is supported by this [example script](https://github.com/huggingface/transformers/tree/main/examples/pytorch/speech-recognition).
...
- [Wav2Vec2BertForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForSequenceClassification) can be used by adapting this [example script](https://github.com/huggingface/transformers/tree/main/examples/pytorch/audio-classification).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/configuration_wav2vec2_bert.py#L26)
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [Wav2Vec2BertForCTC](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForCTC).
...
defaults will yield a similar configuration to that of the [facebook/w2v-bert-2.0](https://huggingface.co/facebook/w2v-bert-2.0)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/processing_wav2vec2_bert.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/processing_wav2vec2_bert.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/processing_wav2vec2_bert.py#L70)

If `input_features` is not `None`, this method forwards the `input_features` and `kwargs` arguments to SeamlessM4TFeatureExtractor's [pad()](/docs/transformers/v5.17.0/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor.pad) to pad the input features.
If `labels` is not `None`, this method forwards the `labels` and `kwargs` arguments to PreTrainedTokenizer's [pad()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.pad) to pad the label(s).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L940)
...
```python
forward(input_features: typing.Optional[torch.Tensor], attention_mask: typing.Optional[torch.Tensor] = None, mask_time_indices: typing.Optional[torch.FloatTensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1007)
...
elements depending on the configuration ([Wav2Vec2BertConfig](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertConfig)) and inputs.

The [Wav2Vec2BertModel](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1053)
...
```python
forward(input_features: typing.Optional[torch.Tensor], attention_mask: typing.Optional[torch.Tensor] = None, labels: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1083)
...
The [Wav2Vec2BertForCTC](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForCTC) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1154)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1180)
...
The [Wav2Vec2BertForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForSequenceClassification) forward method, overrides the `__call__` special method.
...
>>> model = Wav2Vec2BertForSequenceClassification.from_pretrained("facebook/w2v-bert-2.0", num_labels=num_labels)
...
>>> tokenizer = AutoTokenizer.from_pretrained("facebook/w2v-bert-2.0")
>>> model = Wav2Vec2BertForSequenceClassification.from_pretrained("facebook/w2v-bert-2.0", problem_type="multi_label_classification")
...
...     "facebook/w2v-bert-2.0", num_labels=num_labels, problem_type="multi_label_classification"
... )
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1238)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1263)
...
The [Wav2Vec2BertForAudioFrameClassification](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForAudioFrameClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1371)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/wav2vec2_bert/modeling_wav2vec2_bert.py#L1414)
...
The [Wav2Vec2BertForXVector](/docs/transformers/v5.17.0/en/model_doc/wav2vec2-bert#transformers.Wav2Vec2BertForXVector) forward method, overrides the `__call__` special method.
...
### DiffusionGemma
https://huggingface.co/docs/transformers/v5.17.0/model_doc/diffusion_gemma.md
