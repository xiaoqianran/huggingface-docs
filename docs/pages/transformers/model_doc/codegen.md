...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/codegen/configuration_codegen.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/codegen/tokenization_codegen.py#L37)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/codegen/modeling_codegen.py#L276)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/codegen/modeling_codegen.py#L299)
...
elements depending on the configuration ([CodeGenConfig](/docs/transformers/v5.17.0/en/model_doc/codegen#transformers.CodeGenConfig)) and inputs.

The [CodeGenModel](/docs/transformers/v5.17.0/en/model_doc/codegen#transformers.CodeGenModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/codegen/modeling_codegen.py#L411)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/codegen/modeling_codegen.py#L422)
...
The [CodeGenForCausalLM](/docs/transformers/v5.17.0/en/model_doc/codegen#transformers.CodeGenForCausalLM) forward method, overrides the `__call__` special method.
...
### OmDet-Turbo
https://huggingface.co/docs/transformers/v5.17.0/model_doc/omdet-turbo.md
