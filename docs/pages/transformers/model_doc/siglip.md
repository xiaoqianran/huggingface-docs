...
The example below demonstrates how to generate similarity scores between texts and image(s) with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
- When using the standalone [SiglipTokenizer](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipTokenizer) or [SiglipProcessor](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipProcessor), make sure to pass `padding="max_length"` because that is how the model was trained.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/configuration_siglip.py#L104)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/configuration_siglip.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/configuration_siglip.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/tokenization_siglip.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/tokenization_siglip.py#L203)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/tokenization_siglip.py#L142)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/tokenization_siglip.py#L181)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/tokenization_siglip.py#L335)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/image_processing_siglip.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/image_processing_pil_siglip.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/processing_siglip.py#L23)
...
[~SiglipImageProcessor](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipImageProcessor) and [~SiglipTokenizer](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L647)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L737)
...
elements depending on the configuration ([SiglipConfig](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipConfig)) and inputs.

The [SiglipModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipModel) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, image_batch_size)`) -- The scaled dot product scores between `text_embeds` and `image_embeds`. This represents the text-image
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [SiglipTextModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipTextModel).
- **image_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The image embeddings obtained by applying the projection layer to the pooled output of [SiglipVisionModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipVisionModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [SiglipTextModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipTextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [SiglipVisionModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipVisionModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L672)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L703)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L471)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L488)
...
The [SiglipTextModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L553)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L573)
...
The [SiglipVisionModel](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L835)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/siglip/modeling_siglip.py#L859)
...
The [SiglipForImageClassification](/docs/transformers/v5.17.0/en/model_doc/siglip#transformers.SiglipForImageClassification) forward method, overrides the `__call__` special method.
...
### CodeGen
https://huggingface.co/docs/transformers/v5.17.0/model_doc/codegen.md
