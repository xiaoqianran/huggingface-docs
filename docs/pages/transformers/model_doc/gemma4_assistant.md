...
Architecturally, the Gemma 4 Assistant shares the same [Gemma4TextModel](/docs/transformers/v5.17.0/en/model_doc/gemma4#transformers.Gemma4TextModel) backbone
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_assistant/configuration_gemma4_assistant.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_assistant/modeling_gemma4_assistant.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_assistant/modeling_gemma4_assistant.py#L205)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gemma4_assistant/modeling_gemma4_assistant.py#L134)
...
The [Gemma4AssistantForCausalLM](/docs/transformers/v5.17.0/en/model_doc/gemma4_assistant#transformers.Gemma4AssistantForCausalLM) forward method, overrides the `__call__` special method.
...
### MiniMax-M2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/minimax_m2.md
