...
The example below demonstrates how to generate biomedical text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and also from the command line.
...
- BioGPT can reuse previously computed key-value attention pairs. Access this feature with the [past_key_values](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptModel.forward.past_key_values) parameter in `BioGPTModel.forward`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/configuration_biogpt.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/tokenization_biogpt.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/tokenization_biogpt.py#L282)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L321)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L343)
...
elements depending on the configuration ([BioGptConfig](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptConfig)) and inputs.

The [BioGptModel](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L420)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L438)
...
The [BioGptForCausalLM](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L487)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L502)
...
The [BioGptForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L571)
...
[BioGptForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/biogpt/modeling_biogpt.py#L581)
...
The [BioGptForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/biogpt#transformers.BioGptForSequenceClassification) forward method, overrides the `__call__` special method.
...
### DINOv3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/dinov3.md
