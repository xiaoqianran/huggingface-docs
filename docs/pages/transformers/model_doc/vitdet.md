...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vitdet/configuration_vitdet.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vitdet/modeling_vitdet.py#L600)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/vitdet/modeling_vitdet.py#L614)
...
elements depending on the configuration ([VitDetConfig](/docs/transformers/v5.15.0/en/model_doc/vitdet#transformers.VitDetConfig)) and inputs.

The [VitDetModel](/docs/transformers/v5.15.0/en/model_doc/vitdet#transformers.VitDetModel) forward method, overrides the `__call__` special method.
...
### Qwen3.5
https://huggingface.co/docs/transformers/v5.15.0/model_doc/qwen3_5.md
