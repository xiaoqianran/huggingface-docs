...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/configuration_sam_hq.py#L153)

**Parameters:**

vision_config (`Union[dict, ~configuration_utils.PreTrainedConfig]`, *optional*) : The config object or dictionary of the vision backbone.

prompt_encoder_config (Union[`dict`, `SamHQPromptEncoderConfig`], *optional*) : Dictionary of configuration options used to initialize [SamHQPromptEncoderConfig](/docs/transformers/v5.17.0/en/model_doc/sam_hq#transformers.SamHQPromptEncoderConfig).

mask_decoder_config (Union[`dict`, `SamHQMaskDecoderConfig`], *optional*) : Dictionary of configuration options used to initialize [SamHQMaskDecoderConfig](/docs/transformers/v5.17.0/en/model_doc/sam_hq#transformers.SamHQMaskDecoderConfig).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/configuration_sam_hq.py#L54)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/configuration_sam_hq.py#L119)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/configuration_sam_hq.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/processing_sam_hq.py#L83)
...
[SamHQProcessor](/docs/transformers/v5.17.0/en/model_doc/sam_hq#transformers.SamHQProcessor) offers all the functionalities of [SamImageProcessor](/docs/transformers/v5.17.0/en/model_doc/sam#transformers.SamImageProcessor). See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/processing_sam_hq.py#L93)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/modeling_sam_hq.py#L1075)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/modeling_sam_hq.py#L1087)
...
elements depending on the configuration ([SamHQConfig](/docs/transformers/v5.17.0/en/model_doc/sam_hq#transformers.SamHQConfig)) and inputs.

The [SamHQVisionModel](/docs/transformers/v5.17.0/en/model_doc/sam_hq#transformers.SamHQVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/modeling_sam_hq.py#L1233)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/sam_hq/modeling_sam_hq.py#L1317)
...
The [SamHQModel](/docs/transformers/v5.17.0/en/model_doc/sam_hq#transformers.SamHQModel) forward method, overrides the `__call__` special method.
...
### Helium
https://huggingface.co/docs/transformers/v5.17.0/model_doc/helium.md
