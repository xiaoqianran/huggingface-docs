...
- Set the `eos_token_id` as the `decoder_start_token_id` for mBART-50. The target language id is used as the first generated token by passing `forced_bos_token_id` to [generate()](/docs/transformers/v5.15.0/en/main_classes/text_generation#transformers.GenerationMixin.generate).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/configuration_mbart.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/tokenization_mbart.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/tokenization_mbart.py#L177)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/tokenization_mbart.py#L192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart50/tokenization_mbart50.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart50/tokenization_mbart50.py#L266)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart50/tokenization_mbart50.py#L281)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L763)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L790)
...
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.15.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.

The [MBartModel](/docs/transformers/v5.15.0/en/model_doc/mbart#transformers.MBartModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L883)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L913)
...
The [MBartForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/mbart#transformers.MBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L1177)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L1190)
...
The [MBartForQuestionAnswering](/docs/transformers/v5.15.0/en/model_doc/mbart#transformers.MBartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L1048)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L1062)
...
The [MBartForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/mbart#transformers.MBartForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L1300)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mbart/modeling_mbart.py#L1322)
...
The [MBartForCausalLM](/docs/transformers/v5.15.0/en/model_doc/mbart#transformers.MBartForCausalLM) forward method, overrides the `__call__` special method.
...
### Falcon3
https://huggingface.co/docs/transformers/v5.15.0/model_doc/falcon3.md
