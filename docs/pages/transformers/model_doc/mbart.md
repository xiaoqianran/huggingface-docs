...
The example below demonstrates how to translate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
- Set the `eos_token_id` as the `decoder_start_token_id` for mBART-50. The target language id is used as the first generated token by passing `forced_bos_token_id` to [generate()](/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationMixin.generate).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/configuration_mbart.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/tokenization_mbart.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/tokenization_mbart.py#L177)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/tokenization_mbart.py#L192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart50/tokenization_mbart50.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart50/tokenization_mbart50.py#L266)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart50/tokenization_mbart50.py#L281)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L758)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L785)
...
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.

The [MBartModel](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L878)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L908)
...
The [MBartForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L1172)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L1185)
...
**Returns:** [Seq2SeqQuestionAnsweringModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput) or `tuple(torch.FloatTensor)`

A [Seq2SeqQuestionAnsweringModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.

The [MBartForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L1043)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L1057)
...
**Returns:** [Seq2SeqSequenceClassifierOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput) or `tuple(torch.FloatTensor)`

A [Seq2SeqSequenceClassifierOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([MBartConfig](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartConfig)) and inputs.

The [MBartForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L1295)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mbart/modeling_mbart.py#L1317)
...
The [MBartForCausalLM](/docs/transformers/v5.17.0/en/model_doc/mbart#transformers.MBartForCausalLM) forward method, overrides the `__call__` special method.
...
### Falcon3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/falcon3.md
