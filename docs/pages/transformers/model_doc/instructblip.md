...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/configuration_instructblip.py#L106)

**Parameters:**

vision_config (`Union[dict, ~configuration_utils.PreTrainedConfig]`, *optional*) : The config object or dictionary of the vision backbone.

qformer_config (`dict`, *optional*) : Dictionary of configuration options used to initialize [InstructBlipQFormerConfig](/docs/transformers/v5.17.0/en/model_doc/instructblip#transformers.InstructBlipQFormerConfig).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/configuration_instructblip.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/configuration_instructblip.py#L64)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/processing_instructblip.py#L45)
...
[~BlipImageProcessor](/docs/transformers/v5.17.0/en/model_doc/blip#transformers.BlipImageProcessor), [~GPT2Tokenizer](/docs/transformers/v5.17.0/en/model_doc/gpt2#transformers.GPT2Tokenizer), and `~{qformer_tokenizer_class}` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/processing_instructblip.py#L63)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L392)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L412)
...
elements depending on the configuration ([InstructBlipConfig](/docs/transformers/v5.17.0/en/model_doc/instructblip#transformers.InstructBlipConfig)) and inputs.

The [InstructBlipVisionModel](/docs/transformers/v5.17.0/en/model_doc/instructblip#transformers.InstructBlipVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L760)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L797)
...
The [InstructBlipQFormerModel](/docs/transformers/v5.17.0/en/model_doc/instructblip#transformers.InstructBlipQFormerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L865)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L917)
...
The [InstructBlipModel](/docs/transformers/v5.17.0/en/model_doc/instructblip#transformers.InstructBlipModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L902)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L1026)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L1172)
...
The [InstructBlipForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/instructblip#transformers.InstructBlipForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L1306)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/instructblip/modeling_instructblip.py#L1089)
...
### MegatronBERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/megatron-bert.md
