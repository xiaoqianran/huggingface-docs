...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/configuration_deepseek_v3.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/modeling_deepseek_v3.py#L566)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/modeling_deepseek_v3.py#L583)
...
elements depending on the configuration ([DeepseekV3Config](/docs/transformers/v5.15.0/en/model_doc/deepseek_v3#transformers.DeepseekV3Config)) and inputs.

The [DeepseekV3Model](/docs/transformers/v5.15.0/en/model_doc/deepseek_v3#transformers.DeepseekV3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/modeling_deepseek_v3.py#L640)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/modeling_deepseek_v3.py#L655)
...
The [DeepseekV3ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/deepseek_v3#transformers.DeepseekV3ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/modeling_deepseek_v3.py#L714)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v3/modeling_deepseek_v3.py#L718)
...
### XGLM
https://huggingface.co/docs/transformers/v5.15.0/model_doc/xglm.md
