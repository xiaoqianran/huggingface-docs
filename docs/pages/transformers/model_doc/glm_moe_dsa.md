...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm_moe_dsa/configuration_glm_moe_dsa.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm_moe_dsa/modeling_glm_moe_dsa.py#L674)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm_moe_dsa/modeling_glm_moe_dsa.py#L691)
...
elements depending on the configuration ([GlmMoeDsaConfig](/docs/transformers/v5.15.0/en/model_doc/glm_moe_dsa#transformers.GlmMoeDsaConfig)) and inputs.

The [GlmMoeDsaModel](/docs/transformers/v5.15.0/en/model_doc/glm_moe_dsa#transformers.GlmMoeDsaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm_moe_dsa/modeling_glm_moe_dsa.py#L753)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm_moe_dsa/modeling_glm_moe_dsa.py#L768)
...
The [GlmMoeDsaForCausalLM](/docs/transformers/v5.15.0/en/model_doc/glm_moe_dsa#transformers.GlmMoeDsaForCausalLM) forward method, overrides the `__call__` special method.
...
### PP-OCRv5_server_rec
https://huggingface.co/docs/transformers/v5.15.0/model_doc/pp_ocrv5_server_rec.md
