...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/configuration_minimax.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L621)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L638)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L776)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L794)
...
elements depending on the configuration ([MiniMaxConfig](/docs/transformers/v5.17.0/en/model_doc/minimax#transformers.MiniMaxConfig)) and inputs.

The [MiniMaxForCausalLM](/docs/transformers/v5.17.0/en/model_doc/minimax#transformers.MiniMaxForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L879)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L883)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/minimax/modeling_minimax.py#L887)
...
### Qwen3-VL-Moe
https://huggingface.co/docs/transformers/v5.17.0/model_doc/qwen3_vl_moe.md
