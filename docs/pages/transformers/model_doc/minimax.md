...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/configuration_minimax.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L617)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L634)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L785)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L803)
...
elements depending on the configuration ([MiniMaxConfig](/docs/transformers/v5.15.0/en/model_doc/minimax#transformers.MiniMaxConfig)) and inputs.

The [MiniMaxForCausalLM](/docs/transformers/v5.15.0/en/model_doc/minimax#transformers.MiniMaxForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L888)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L892)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/minimax/modeling_minimax.py#L896)
...
### Qwen3-VL-Moe
https://huggingface.co/docs/transformers/v5.15.0/model_doc/qwen3_vl_moe.md
