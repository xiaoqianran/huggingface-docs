...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/configuration_textnet.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/image_processing_textnet.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/image_processing_textnet.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/image_processing_pil_textnet.py#L45)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/image_processing_pil_textnet.py#L66)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/modeling_textnet.py#L224)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/modeling_textnet.py#L232)
...
elements depending on the configuration ([TextNetConfig](/docs/transformers/v5.17.0/en/model_doc/textnet#transformers.TextNetConfig)) and inputs.

The [TextNetModel](/docs/transformers/v5.17.0/en/model_doc/textnet#transformers.TextNetModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/modeling_textnet.py#L271)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/textnet/modeling_textnet.py#L286)
...
The [TextNetForImageClassification](/docs/transformers/v5.17.0/en/model_doc/textnet#transformers.TextNetForImageClassification) forward method, overrides the `__call__` special method.
...
### Wav2Vec2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/wav2vec2.md
