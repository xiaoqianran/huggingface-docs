...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/configuration_openai.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L299)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L318)
...
elements depending on the configuration ([OpenAIGPTConfig](/docs/transformers/v5.17.0/en/model_doc/openai-gpt#transformers.OpenAIGPTConfig)) and inputs.

The [OpenAIGPTModel](/docs/transformers/v5.17.0/en/model_doc/openai-gpt#transformers.OpenAIGPTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L414)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L425)
...
The [OpenAIGPTLMHeadModel](/docs/transformers/v5.17.0/en/model_doc/openai-gpt#transformers.OpenAIGPTLMHeadModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L499)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L513)
...
The [OpenAIGPTDoubleHeadsModel](/docs/transformers/v5.17.0/en/model_doc/openai-gpt#transformers.OpenAIGPTDoubleHeadsModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L616)
...
[OpenAIGPTForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/openai-gpt#transformers.OpenAIGPTForSequenceClassification) uses the last token in order to do the classification, as other causal
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/modeling_openai.py#L626)
...
The [OpenAIGPTForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/openai-gpt#transformers.OpenAIGPTForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/openai/tokenization_openai.py#L28)
...
### SigLIP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/siglip.md
