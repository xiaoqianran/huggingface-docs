...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/solar_open/configuration_solar_open.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/solar_open/modeling_solar_open.py#L455)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/solar_open/modeling_solar_open.py#L472)
...
elements depending on the configuration ([SolarOpenConfig](/docs/transformers/v5.15.0/en/model_doc/solar_open#transformers.SolarOpenConfig)) and inputs.

The [SolarOpenModel](/docs/transformers/v5.15.0/en/model_doc/solar_open#transformers.SolarOpenModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/solar_open/modeling_solar_open.py#L529)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/solar_open/modeling_solar_open.py#L544)
...
The [SolarOpenForCausalLM](/docs/transformers/v5.15.0/en/model_doc/solar_open#transformers.SolarOpenForCausalLM) forward method, overrides the `__call__` special method.
...
### PP-DocLayoutV2
https://huggingface.co/docs/transformers/v5.15.0/model_doc/pp_doclayout_v2.md
