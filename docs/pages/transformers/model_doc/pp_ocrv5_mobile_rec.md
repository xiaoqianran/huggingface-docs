...
The example below demonstrates how to detect text with PP-OCRv5_mobile_rec using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
Here is how you can do it with PP-OCRv5_mobile_rec using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel):
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_mobile_rec/modeling_pp_ocrv5_mobile_rec.py#L374)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_mobile_rec/modeling_pp_ocrv5_mobile_rec.py#L384)
...
elements depending on the configuration ([PPOCRV5MobileRecConfig](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv5_mobile_rec#transformers.PPOCRV5MobileRecConfig)) and inputs.

The [PPOCRV5MobileRecForTextRecognition](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv5_mobile_rec#transformers.PPOCRV5MobileRecForTextRecognition) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_mobile_rec/configuration_pp_ocrv5_mobile_rec.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_mobile_rec/modeling_pp_ocrv5_mobile_rec.py#L322)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv5_mobile_rec/modeling_pp_ocrv5_mobile_rec.py#L330)
...
The [PPOCRV5MobileRecModel](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv5_mobile_rec#transformers.PPOCRV5MobileRecModel) forward method, overrides the `__call__` special method.
...
### GLM-OCR
https://huggingface.co/docs/transformers/v5.17.0/model_doc/glm_ocr.md
