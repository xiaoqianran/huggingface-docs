...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/configuration_audioflamingo3.py#L73)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/configuration_audioflamingo3.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/processing_audioflamingo3.py#L53)
...
[~WhisperFeatureExtractor](/docs/transformers/v5.15.0/en/model_doc/whisper#transformers.WhisperFeatureExtractor) and [~Qwen2Tokenizer](/docs/transformers/v5.15.0/en/model_doc/qwen2#transformers.Qwen2Tokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/processing_audioflamingo3.py#L79)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L302)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L354)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L448)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L514)
...
elements depending on the configuration ([AudioFlamingo3Config](/docs/transformers/v5.15.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3Config)) and inputs.

The [AudioFlamingo3Model](/docs/transformers/v5.15.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L570)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L582)
...
The [AudioFlamingo3ForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/audioflamingo3#transformers.AudioFlamingo3ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/audioflamingo3/modeling_audioflamingo3.py#L579)

### BROS
https://huggingface.co/docs/transformers/v5.15.0/model_doc/bros.md
