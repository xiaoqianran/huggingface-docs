...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mellum/configuration_mellum.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mellum/modeling_mellum.py#L457)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mellum/modeling_mellum.py#L474)
...
elements depending on the configuration ([MellumConfig](/docs/transformers/v5.15.0/en/model_doc/mellum#transformers.MellumConfig)) and inputs.

The [MellumModel](/docs/transformers/v5.15.0/en/model_doc/mellum#transformers.MellumModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mellum/modeling_mellum.py#L623)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mellum/modeling_mellum.py#L641)
...
The [MellumForCausalLM](/docs/transformers/v5.15.0/en/model_doc/mellum#transformers.MellumForCausalLM) forward method, overrides the `__call__` special method.
...
### MiMo-V2-Flash
https://huggingface.co/docs/transformers/v5.15.0/model_doc/mimo_v2_flash.md
