...
The examples below demonstrate how to generate text with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_mamba/configuration_falcon_mamba.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L652)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L672)
...
elements depending on the configuration ([FalconMambaConfig](/docs/transformers/v5.17.0/en/model_doc/falcon_mamba#transformers.FalconMambaConfig)) and inputs.

The [FalconMambaModel](/docs/transformers/v5.17.0/en/model_doc/falcon_mamba#transformers.FalconMambaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L742)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L783)
...
The [FalconMambaForCausalLM](/docs/transformers/v5.17.0/en/model_doc/falcon_mamba#transformers.FalconMambaForCausalLM) forward method, overrides the `__call__` special method.
...
### Video-LLaVA
https://huggingface.co/docs/transformers/v5.17.0/model_doc/video_llava.md
