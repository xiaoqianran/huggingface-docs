...
The examples below demonstrate how to generate text with [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline), [AutoModel](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoModel), and from the command line.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/falcon_mamba/configuration_falcon_mamba.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L653)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L673)
...
elements depending on the configuration ([FalconMambaConfig](/docs/transformers/v5.15.0/en/model_doc/falcon_mamba#transformers.FalconMambaConfig)) and inputs.

The [FalconMambaModel](/docs/transformers/v5.15.0/en/model_doc/falcon_mamba#transformers.FalconMambaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L743)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/falcon_mamba/modeling_falcon_mamba.py#L784)
...
The [FalconMambaForCausalLM](/docs/transformers/v5.15.0/en/model_doc/falcon_mamba#transformers.FalconMambaForCausalLM) forward method, overrides the `__call__` special method.
...
### Video-LLaVA
https://huggingface.co/docs/transformers/v5.15.0/model_doc/video_llava.md
