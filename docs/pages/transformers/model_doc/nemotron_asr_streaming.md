...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/configuration_nemotron_asr_streaming.py#L120)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/configuration_nemotron_asr_streaming.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/processing_nemotron_asr_streaming.py#L50)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/processing_nemotron_asr_streaming.py#L85)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/processing_nemotron_asr_streaming.py#L169)

Forward arguments to [decode()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode) and post-process the token-level timestamps (if
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/modeling_nemotron_asr_streaming.py#L326)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/modeling_nemotron_asr_streaming.py#L1051)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/modeling_nemotron_asr_streaming.py#L891)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/modeling_nemotron_asr_streaming.py#L914)
...
The [NemotronAsrStreamingEncoder](/docs/transformers/v5.17.0/en/model_doc/nemotron_asr_streaming#transformers.NemotronAsrStreamingEncoder) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/modeling_nemotron_asr_streaming.py#L1140)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/modeling_nemotron_asr_streaming.py#L1170)
...
**Returns:** [NemotronAsrStreamingRNNTOutput](/docs/transformers/v5.17.0/en/model_doc/nemotron_asr_streaming#transformers.NemotronAsrStreamingRNNTOutput) or `tuple(torch.FloatTensor)`

A [NemotronAsrStreamingRNNTOutput](/docs/transformers/v5.17.0/en/model_doc/nemotron_asr_streaming#transformers.NemotronAsrStreamingRNNTOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.

The [NemotronAsrStreamingForRNNT](/docs/transformers/v5.17.0/en/model_doc/nemotron_asr_streaming#transformers.NemotronAsrStreamingForRNNT) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron_asr_streaming/generation_nemotron_asr_streaming.py#L212)

### GLM-V
https://huggingface.co/docs/transformers/v5.17.0/model_doc/glm4v.md
