...
- The tokenizer used for this model is identical to the [LlamaTokenizer](/docs/transformers/v5.17.0/en/model_doc/llama2#transformers.LlamaTokenizer), with the exception of additional tokens.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/configuration_phi3.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/configuration_phi3.py#L107)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/modeling_phi3.py#L351)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/modeling_phi3.py#L368)
...
elements depending on the configuration ([Phi3Config](/docs/transformers/v5.17.0/en/model_doc/phi3#transformers.Phi3Config)) and inputs.

The [Phi3Model](/docs/transformers/v5.17.0/en/model_doc/phi3#transformers.Phi3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/modeling_phi3.py#L425)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/modeling_phi3.py#L440)
...
The [Phi3ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/phi3#transformers.Phi3ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/modeling_phi3.py#L536)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/phi3/modeling_phi3.py#L540)
...
### GLM-4
https://huggingface.co/docs/transformers/v5.17.0/model_doc/glm.md
