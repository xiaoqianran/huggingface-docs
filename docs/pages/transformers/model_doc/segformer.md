...
The example below demonstrates semantic segmentation with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/configuration_segformer.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/image_processing_segformer.py#L55)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/image_processing_segformer.py#L75)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/image_processing_segformer.py#L192)

**Parameters:**

outputs ([SegformerForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation)) : Raw outputs of the model.
...
Converts the output of [SegformerForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation) into semantic segmentation maps.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/image_processing_pil_segformer.py#L58)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/image_processing_pil_segformer.py#L78)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/image_processing_pil_segformer.py#L177)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L376)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L390)
...
elements depending on the configuration ([SegformerConfig](/docs/transformers/v5.17.0/en/model_doc/segformer#transformers.SegformerConfig)) and inputs.

The [SegformerModel](/docs/transformers/v5.17.0/en/model_doc/segformer#transformers.SegformerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L478)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L502)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L410)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L423)
...
The [SegformerForImageClassification](/docs/transformers/v5.17.0/en/model_doc/segformer#transformers.SegformerForImageClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L540)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/segformer/modeling_segformer.py#L549)
...
The [SegformerForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/segformer#transformers.SegformerForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
### Glm4MoeLite
https://huggingface.co/docs/transformers/v5.17.0/model_doc/glm4_moe_lite.md
