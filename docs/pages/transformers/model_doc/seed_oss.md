...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/configuration_seed_oss.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L348)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L365)
...
elements depending on the configuration ([SeedOssConfig](/docs/transformers/v5.17.0/en/model_doc/seed_oss#transformers.SeedOssConfig)) and inputs.

The [SeedOssModel](/docs/transformers/v5.17.0/en/model_doc/seed_oss#transformers.SeedOssModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L422)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L437)
...
The [SeedOssForCausalLM](/docs/transformers/v5.17.0/en/model_doc/seed_oss#transformers.SeedOssForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L501)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L505)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seed_oss/modeling_seed_oss.py#L509)
...
### Qwen2.5-Omni
https://huggingface.co/docs/transformers/v5.17.0/model_doc/qwen2_5_omni.md
