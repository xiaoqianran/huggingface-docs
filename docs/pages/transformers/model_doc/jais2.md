...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jais2/configuration_jais2.py#L32)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jais2/modeling_jais2.py#L316)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jais2/modeling_jais2.py#L333)
...
elements depending on the configuration ([Jais2Config](/docs/transformers/v5.17.0/en/model_doc/jais2#transformers.Jais2Config)) and inputs.

The [Jais2Model](/docs/transformers/v5.17.0/en/model_doc/jais2#transformers.Jais2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jais2/modeling_jais2.py#L390)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/jais2/modeling_jais2.py#L405)
...
The [Jais2ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/jais2#transformers.Jais2ForCausalLM) forward method, overrides the `__call__` special method.
...
### Aria
https://huggingface.co/docs/transformers/v5.17.0/model_doc/aria.md
