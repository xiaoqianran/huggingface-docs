...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/configuration_llava.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/image_processing_llava.py#L38)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/image_processing_pil_llava.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/processing_llava.py#L37)
...
[~LlavaImageProcessor](/docs/transformers/v5.17.0/en/model_doc/llava#transformers.LlavaImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L130)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L215)
...
elements depending on the configuration ([LlavaConfig](/docs/transformers/v5.17.0/en/model_doc/llava#transformers.LlavaConfig)) and inputs.

The [LlavaModel](/docs/transformers/v5.17.0/en/model_doc/llava#transformers.LlavaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L139)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L191)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L272)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L299)
...
The [LlavaForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/llava#transformers.LlavaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llava/modeling_llava.py#L284)
...
### BioGPT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/biogpt.md
