...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/configuration_cohere_asr.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/processing_cohere_asr.py#L51)
...
[~CohereAsrFeatureExtractor](/docs/transformers/v5.17.0/en/model_doc/cohere_asr#transformers.models.cohere_asr.feature_extraction_cohere_asr._LazyModule.__getattr__..Placeholder) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/processing_cohere_asr.py#L79)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/modeling_cohere_asr.py#L297)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/modeling_cohere_asr.py#L426)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/modeling_cohere_asr.py#L454)
...
elements depending on the configuration ([CohereAsrConfig](/docs/transformers/v5.17.0/en/model_doc/cohere_asr#transformers.CohereAsrConfig)) and inputs.

The [CohereAsrModel](/docs/transformers/v5.17.0/en/model_doc/cohere_asr#transformers.CohereAsrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/modeling_cohere_asr.py#L548)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cohere_asr/modeling_cohere_asr.py#L568)
...
The [CohereAsrForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/cohere_asr#transformers.CohereAsrForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### HunYuanVL
https://huggingface.co/docs/transformers/v5.17.0/model_doc/hunyuan_vl.md
