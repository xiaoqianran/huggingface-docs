...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/laguna/configuration_laguna.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/laguna/configuration_laguna.py#L152)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/laguna/modeling_laguna.py#L507)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/laguna/modeling_laguna.py#L524)
...
elements depending on the configuration ([LagunaConfig](/docs/transformers/v5.15.0/en/model_doc/laguna#transformers.LagunaConfig)) and inputs.

The [LagunaModel](/docs/transformers/v5.15.0/en/model_doc/laguna#transformers.LagunaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/laguna/modeling_laguna.py#L673)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/laguna/modeling_laguna.py#L692)
...
The [LagunaForCausalLM](/docs/transformers/v5.15.0/en/model_doc/laguna#transformers.LagunaForCausalLM) forward method, overrides the `__call__` special method.
...
### Ernie 4.5 Moe
https://huggingface.co/docs/transformers/v5.15.0/model_doc/ernie4_5_moe.md
