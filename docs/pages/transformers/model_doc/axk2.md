...
The example below shows how to generate text with [Pipeline](/docs/transformers/v5.15.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.15.0/en/model_doc/auto#transformers.AutoModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/configuration_axk2.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/modeling_axk2.py#L757)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/modeling_axk2.py#L774)
...
elements depending on the configuration ([AXK2Config](/docs/transformers/v5.15.0/en/model_doc/axk2#transformers.AXK2Config)) and inputs.

The [AXK2Model](/docs/transformers/v5.15.0/en/model_doc/axk2#transformers.AXK2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/modeling_axk2.py#L834)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/modeling_axk2.py#L849)
...
The [AXK2ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/axk2#transformers.AXK2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/modeling_axk2.py#L908)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/axk2/modeling_axk2.py#L912)
...
### GPT
https://huggingface.co/docs/transformers/v5.15.0/model_doc/openai-gpt.md
