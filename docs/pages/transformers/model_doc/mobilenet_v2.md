...
The examples below demonstrate how to classify an image with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
- While trained on images of a specific sizes, the model architecture works with images of different sizes (minimum 32x32). The [MobileNetV2ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2ImageProcessor) handles the necessary preprocessing.
...
- The original TensorFlow checkpoints determines the padding amount at inference because it depends on the input image size. To use the native PyTorch padding behavior, set `tf_padding=False` in [MobileNetV2Config](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2Config).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/configuration_mobilenet_v2.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2.py#L49)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2.py#L69)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/image_processing_mobilenet_v2.py#L184)

**Parameters:**

outputs ([MobileNetV2ForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2ForSemanticSegmentation)) : Raw outputs of the model.
...
Converts the output of [MobileNetV2ForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2ForSemanticSegmentation) into semantic segmentation maps.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/image_processing_pil_mobilenet_v2.py#L57)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/image_processing_pil_mobilenet_v2.py#L77)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/image_processing_pil_mobilenet_v2.py#L180)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L260)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L325)
...
elements depending on the configuration ([MobileNetV2Config](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2Config)) and inputs.

The [MobileNetV2Model](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L374)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L390)
...
The [MobileNetV2ForImageClassification](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2ForImageClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L508)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mobilenet_v2/modeling_mobilenet_v2.py#L519)
...
The [MobileNetV2ForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/mobilenet_v2#transformers.MobileNetV2ForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
### VideoMAE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/videomae.md
