...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/configuration_lw_detr.py#L109)
...
num_queries (`int`, *optional*, defaults to 300) : Number of object queries, i.e. detection slots. This is the maximal number of objects [LwDetrModel](/docs/transformers/v5.17.0/en/model_doc/lw_detr#transformers.LwDetrModel) can detect in a single image.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/configuration_lw_detr.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/modeling_lw_detr.py#L1200)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/modeling_lw_detr.py#L1306)
...
elements depending on the configuration ([LwDetrConfig](/docs/transformers/v5.17.0/en/model_doc/lw_detr#transformers.LwDetrConfig)) and inputs.

The [LwDetrModel](/docs/transformers/v5.17.0/en/model_doc/lw_detr#transformers.LwDetrModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/modeling_lw_detr.py#L1536)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/modeling_lw_detr.py#L1550)
...
The [LwDetrForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/lw_detr#transformers.LwDetrForObjectDetection) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/modeling_lw_detr.py#L342)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lw_detr/modeling_lw_detr.py#L356)
...
The [LwDetrViTBackbone](/docs/transformers/v5.17.0/en/model_doc/lw_detr#transformers.LwDetrViTBackbone) forward method, overrides the `__call__` special method.
...
### ESMFold2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/esmfold2.md
