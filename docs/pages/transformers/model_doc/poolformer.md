...
- One can use [PoolFormerImageProcessor](/docs/transformers/v5.15.0/en/model_doc/poolformer#transformers.PoolFormerImageProcessor) to prepare images for the model.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/configuration_poolformer.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/image_processing_poolformer.py#L43)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/image_processing_pil_poolformer.py#L43)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/modeling_poolformer.py#L252)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/modeling_poolformer.py#L269)
...
elements depending on the configuration ([PoolFormerConfig](/docs/transformers/v5.15.0/en/model_doc/poolformer#transformers.PoolFormerConfig)) and inputs.

The [PoolFormerModel](/docs/transformers/v5.15.0/en/model_doc/poolformer#transformers.PoolFormerModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/modeling_poolformer.py#L316)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/poolformer/modeling_poolformer.py#L338)
...
The [PoolFormerForImageClassification](/docs/transformers/v5.15.0/en/model_doc/poolformer#transformers.PoolFormerForImageClassification) forward method, overrides the `__call__` special method.
...
### SEW
https://huggingface.co/docs/transformers/v5.15.0/model_doc/sew.md
