...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/configuration_qwen3.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L346)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L364)
...
elements depending on the configuration ([Qwen3Config](/docs/transformers/v5.17.0/en/model_doc/qwen3#transformers.Qwen3Config)) and inputs.

The [Qwen3Model](/docs/transformers/v5.17.0/en/model_doc/qwen3#transformers.Qwen3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L431)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L446)
...
The [Qwen3ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/qwen3#transformers.Qwen3ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L510)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L514)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3/modeling_qwen3.py#L518)
...
### ProphetNet
https://huggingface.co/docs/transformers/v5.17.0/model_doc/prophetnet.md
