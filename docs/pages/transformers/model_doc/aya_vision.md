...
- Use the [apply_chat_template()](/docs/transformers/v5.17.0/en/main_classes/processors#transformers.ProcessorMixin.apply_chat_template) method to correctly format inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/processing_aya_vision.py#L34)
...
[~GotOcr2ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/got_ocr2#transformers.GotOcr2ImageProcessor) and [~CohereTokenizer](/docs/transformers/v5.17.0/en/model_doc/cohere#transformers.CohereTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/configuration_aya_vision.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L159)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L234)
...
elements depending on the configuration ([AyaVisionConfig](/docs/transformers/v5.17.0/en/model_doc/aya_vision#transformers.AyaVisionConfig)) and inputs.

The [AyaVisionModel](/docs/transformers/v5.17.0/en/model_doc/aya_vision#transformers.AyaVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L168)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L210)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L291)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L318)
...
The [AyaVisionForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/aya_vision#transformers.AyaVisionForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/aya_vision/modeling_aya_vision.py#L303)
...
### GptOss
https://huggingface.co/docs/transformers/v5.17.0/model_doc/gpt_oss.md
