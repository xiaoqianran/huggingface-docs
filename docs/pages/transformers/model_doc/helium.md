...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/configuration_helium.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/modeling_helium.py#L340)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/modeling_helium.py#L357)
...
elements depending on the configuration ([HeliumConfig](/docs/transformers/v5.15.0/en/model_doc/helium#transformers.HeliumConfig)) and inputs.

The [HeliumModel](/docs/transformers/v5.15.0/en/model_doc/helium#transformers.HeliumModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/modeling_helium.py#L414)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/modeling_helium.py#L429)
...
The [HeliumForCausalLM](/docs/transformers/v5.15.0/en/model_doc/helium#transformers.HeliumForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/modeling_helium.py#L488)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/helium/modeling_helium.py#L492)
...
### OLMo Hybrid
https://huggingface.co/docs/transformers/v5.15.0/model_doc/olmo_hybrid.md
