...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/configuration_smollm3.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L350)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L368)
...
elements depending on the configuration ([SmolLM3Config](/docs/transformers/v5.15.0/en/model_doc/smollm3#transformers.SmolLM3Config)) and inputs.

The [SmolLM3Model](/docs/transformers/v5.15.0/en/model_doc/smollm3#transformers.SmolLM3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L435)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L450)
...
The [SmolLM3ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/smollm3#transformers.SmolLM3ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L509)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L513)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/smollm3/modeling_smollm3.py#L517)
...
### Perceiver
https://huggingface.co/docs/transformers/v5.15.0/model_doc/perceiver.md
