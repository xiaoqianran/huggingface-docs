...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cwm/configuration_cwm.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cwm/modeling_cwm.py#L311)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cwm/modeling_cwm.py#L334)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cwm/modeling_cwm.py#L353)
...
elements depending on the configuration ([CwmConfig](/docs/transformers/v5.17.0/en/model_doc/cwm#transformers.CwmConfig)) and inputs.

The [CwmModel](/docs/transformers/v5.17.0/en/model_doc/cwm#transformers.CwmModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cwm/modeling_cwm.py#L416)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cwm/modeling_cwm.py#L431)
...
The [CwmForCausalLM](/docs/transformers/v5.17.0/en/model_doc/cwm#transformers.CwmForCausalLM) forward method, overrides the `__call__` special method.
...
### ModernVBert
https://huggingface.co/docs/transformers/v5.17.0/model_doc/modernvbert.md
