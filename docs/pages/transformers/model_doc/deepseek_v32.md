...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v32/configuration_deepseek_v32.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L664)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L696)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L713)
...
elements depending on the configuration ([DeepseekV32Config](/docs/transformers/v5.15.0/en/model_doc/deepseek_v32#transformers.DeepseekV32Config)) and inputs.

The [DeepseekV32Model](/docs/transformers/v5.15.0/en/model_doc/deepseek_v32#transformers.DeepseekV32Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L773)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v32/modeling_deepseek_v32.py#L788)
...
The [DeepseekV32ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/deepseek_v32#transformers.DeepseekV32ForCausalLM) forward method, overrides the `__call__` special method.
...
### UPerNet
https://huggingface.co/docs/transformers/v5.15.0/model_doc/upernet.md
