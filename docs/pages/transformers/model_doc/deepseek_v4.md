...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v4/configuration_deepseek_v4.py#L40)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v4/configuration_deepseek_v4.py#L225)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v4/modeling_deepseek_v4.py#L1256)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v4/modeling_deepseek_v4.py#L1274)
...
elements depending on the configuration ([DeepseekV4Config](/docs/transformers/v5.15.0/en/model_doc/deepseek_v4#transformers.DeepseekV4Config)) and inputs.

The [DeepseekV4Model](/docs/transformers/v5.15.0/en/model_doc/deepseek_v4#transformers.DeepseekV4Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v4/modeling_deepseek_v4.py#L1414)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/deepseek_v4/modeling_deepseek_v4.py#L1432)
...
The [DeepseekV4ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/deepseek_v4#transformers.DeepseekV4ForCausalLM) forward method, overrides the `__call__` special method.
...
### Speech2Text
https://huggingface.co/docs/transformers/v5.15.0/model_doc/speech_to_text.md
