...
Use [AutoBackbone](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.AutoBackbone) to load the vision backbone directly and get spatial feature maps, without the text model. 
...
- [Tipsv2Model](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Model) returns normalized `image_embeds` and `text_embeds`. `logits_per_image` and `logits_per_text` are convenience outputs computed as cosine similarity divided by the temperature.
- Use [get_image_features()](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Model.get_image_features) and [get_text_features()](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Model.get_text_features) to retrieve image and text embeddings individually.
- Use [Tipsv2VisionBackbone](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionBackbone) if you need access to feature maps from all layers.
- Use [Tipsv2VisionModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel) if you need access to the two vision class tokens.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/configuration_tipsv2.py#L141)

**Parameters:**

text_config (`dict`, *optional*) : Dictionary of configuration options used to initialize [Tipsv2TextConfig](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2TextConfig).

vision_config (`dict`, *optional*) : Dictionary of configuration options used to initialize [Tipsv2VisionConfig](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionConfig).

temperature_init_value (`float`, *optional*, defaults to `0.005065968260169029`) : Initial value for the learnable temperature parameter used to scale cosine-similarity logits in [Tipsv2Model](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Model).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/configuration_tipsv2.py#L92)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/configuration_tipsv2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/tokenization_tipsv2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/image_processing_tipsv2.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/processing_tipsv2.py#L36)
...
[~Tipsv2ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2ImageProcessor) and [~Tipsv2Tokenizer](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Tokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L1040)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L1093)
...
elements depending on the configuration ([Tipsv2Config](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Config)) and inputs.

The [Tipsv2Model](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2Model) forward method, overrides the `__call__` special method.
...
- **logits_per_text** (`torch.FloatTensor` of shape `(text_batch_size, image_batch_size)`) -- The scaled dot product scores between `text_embeds` and `image_embeds`. This represents the text-image
  similarity scores.
- **text_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The text embeddings obtained by applying the projection layer to the pooled output of [Tipsv2TextModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2TextModel).
- **image_embeds** (`torch.FloatTensor` of shape `(batch_size, output_dim`) -- The image embeddings obtained by applying the projection layer to the pooled output of [Tipsv2VisionModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel).
- **text_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [Tipsv2TextModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2TextModel).
- **vision_model_output** (`~modeling_outputs.BaseModelOutputWithPooling`, *optional*) -- The output of the [Tipsv2VisionModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L1050)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L1068)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L916)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L927)
...
The [Tipsv2TextModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2TextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L490)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L506)
...
The [Tipsv2VisionModel](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L565)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/tipsv2/modeling_tipsv2.py#L587)
...
The [Tipsv2VisionBackbone](/docs/transformers/v5.17.0/en/model_doc/tipsv2#transformers.Tipsv2VisionBackbone) forward method, overrides the `__call__` special method.
...
### LayoutLMV2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/layoutlmv2.md
