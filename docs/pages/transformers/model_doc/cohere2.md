...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/cohere2/configuration_cohere2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/cohere2/modeling_cohere2.py#L342)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/cohere2/modeling_cohere2.py#L358)
...
elements depending on the configuration ([Cohere2Config](/docs/transformers/v5.15.0/en/model_doc/cohere2#transformers.Cohere2Config)) and inputs.

The [Cohere2Model](/docs/transformers/v5.15.0/en/model_doc/cohere2#transformers.Cohere2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/cohere2/modeling_cohere2.py#L420)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/cohere2/modeling_cohere2.py#L437)
...
The [Cohere2ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/cohere2#transformers.Cohere2ForCausalLM) forward method, overrides the `__call__` special method.
...
### Gemma4
https://huggingface.co/docs/transformers/v5.15.0/model_doc/gemma4.md
