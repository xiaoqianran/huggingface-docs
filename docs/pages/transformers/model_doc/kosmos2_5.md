...
The examples below demonstrates how to generate with [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel), for both Markdown and OCR tasks.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/configuration_kosmos2_5.py#L105)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/configuration_kosmos2_5.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/configuration_kosmos2_5.py#L60)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/image_processing_kosmos2_5.py#L67)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/image_processing_kosmos2_5.py#L78)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/image_processing_pil_kosmos2_5.py#L74)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/image_processing_pil_kosmos2_5.py#L85)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/processing_kosmos2_5.py#L45)
...
[Kosmos2_5Processor](/docs/transformers/v5.17.0/en/model_doc/kosmos2_5#transformers.Kosmos2_5Processor) offers all the functionalities of `image_processor_class` and `tokenizer_class`. See the
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/processing_kosmos2_5.py#L57)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/modeling_kosmos2_5.py#L1144)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/modeling_kosmos2_5.py#L1162)
...
width (`torch.FloatTensor` of shape `(batch_size,)`) : The original width (before resizing) of each image in the batch. This can be obtained using [AutoImageProcessor](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoImageProcessor). See `Kosmos2_5ImageProcessor.__call__()` for details.

height (`torch.FloatTensor` of shape `(batch_size,)`) : The original height (before resizing) of each image in the batch. This can be obtained using [AutoImageProcessor](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoImageProcessor). See `Kosmos2_5ImageProcessor.__call__()` for details.
...
The [Kosmos2_5Model](/docs/transformers/v5.17.0/en/model_doc/kosmos2_5#transformers.Kosmos2_5Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/modeling_kosmos2_5.py#L1405)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/kosmos2_5/modeling_kosmos2_5.py#L1428)
...
The [Kosmos2_5ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/kosmos2_5#transformers.Kosmos2_5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### LLaVA-NeXT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/llava_next.md
