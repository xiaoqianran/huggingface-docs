...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/configuration_qwen3_moe.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L439)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L456)
...
elements depending on the configuration ([Qwen3MoeConfig](/docs/transformers/v5.17.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeConfig)) and inputs.

The [Qwen3MoeModel](/docs/transformers/v5.17.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L584)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L602)
...
The [Qwen3MoeForCausalLM](/docs/transformers/v5.17.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L687)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L691)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L695)
...
### PE Audio Video
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pe_audio_video.md
