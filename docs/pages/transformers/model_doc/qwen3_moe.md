...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/configuration_qwen3_moe.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L439)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L456)
...
elements depending on the configuration ([Qwen3MoeConfig](/docs/transformers/v5.15.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeConfig)) and inputs.

The [Qwen3MoeModel](/docs/transformers/v5.15.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L597)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L615)
...
The [Qwen3MoeForCausalLM](/docs/transformers/v5.15.0/en/model_doc/qwen3_moe#transformers.Qwen3MoeForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L700)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L704)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/qwen3_moe/modeling_qwen3_moe.py#L708)
...
### PE Audio Video
https://huggingface.co/docs/transformers/v5.15.0/model_doc/pe_audio_video.md
