...
The example below demonstrates how to detect text with PP-OCRV5_Mobile_Det using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/configuration_slanext.py#L68)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/modeling_slanext.py#L620)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/modeling_slanext.py#L627)
...
elements depending on the configuration ([SLANeXtConfig](/docs/transformers/v5.17.0/en/model_doc/slanext#transformers.SLANeXtConfig)) and inputs.

The [SLANeXtForTableRecognition](/docs/transformers/v5.17.0/en/model_doc/slanext#transformers.SLANeXtForTableRecognition) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/modeling_slanext.py#L524)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/modeling_slanext.py#L548)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/image_processing_slanext.py#L40)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/image_processing_slanext.py#L172)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/slanext/image_processing_slanext.py#L208)
...
### MPT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mpt.md
