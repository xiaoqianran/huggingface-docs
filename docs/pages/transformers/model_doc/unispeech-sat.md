...
- UniSpeechSat is a speech model that accepts a float array corresponding to the raw waveform of the speech signal.
  Please use [Wav2Vec2Processor](/docs/transformers/v5.17.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) for the feature extraction.
- UniSpeechSat model can be fine-tuned using connectionist temporal classification (CTC) so the model output has to be
  decoded using [Wav2Vec2CTCTokenizer](/docs/transformers/v5.17.0/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/configuration_unispeech_sat.py#L27)
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [UniSpeechSatForCTC](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForCTC).
...
num_clusters (`int`, *optional*, defaults to 504) : Number of clusters for weak labeling. Only relevant when using an instance of [UniSpeechSatForPreTraining](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForPreTraining).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L872)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L935)
...
elements depending on the configuration ([UniSpeechSatConfig](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatConfig)) and inputs.

The [UniSpeechSatModel](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1087)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1156)
...
The [UniSpeechSatForCTC](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForCTC) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1225)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1258)
...
The [UniSpeechSatForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1322)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1354)
...
The [UniSpeechSatForAudioFrameClassification](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForAudioFrameClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1468)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1518)
...
The [UniSpeechSatForXVector](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForXVector) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L981)
...
```python
forward(input_values: typing.Optional[torch.Tensor], attention_mask: typing.Optional[torch.Tensor] = None, **kwargs: Unpack)
```

[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech_sat/modeling_unispeech_sat.py#L1037)
...
**Returns:** [UniSpeechSatForPreTrainingOutput](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatForPreTrainingOutput) or `tuple(torch.FloatTensor)`

A [UniSpeechSatForPreTrainingOutput](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.models.unispeech_sat.modeling_unispeech_sat.UniSpeechSatForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UniSpeechSatConfig](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatConfig)) and inputs.

The [UniSpeechSatForPreTraining](/docs/transformers/v5.17.0/en/model_doc/unispeech-sat#transformers.UniSpeechSatForPreTraining) forward method, overrides the `__call__` special method.
...
### Chameleon
https://huggingface.co/docs/transformers/v5.17.0/model_doc/chameleon.md
