...
use the [ViTMSNForImageClassification](/docs/transformers/v5.17.0/en/model_doc/vit_msn#transformers.ViTMSNForImageClassification) class which is initialized from [ViTMSNModel](/docs/transformers/v5.17.0/en/model_doc/vit_msn#transformers.ViTMSNModel). Follow
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vit_msn/configuration_vit_msn.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vit_msn/modeling_vit_msn.py#L317)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vit_msn/modeling_vit_msn.py#L331)
...
elements depending on the configuration ([ViTMSNConfig](/docs/transformers/v5.17.0/en/model_doc/vit_msn#transformers.ViTMSNConfig)) and inputs.

The [ViTMSNModel](/docs/transformers/v5.17.0/en/model_doc/vit_msn#transformers.ViTMSNModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vit_msn/modeling_vit_msn.py#L387)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vit_msn/modeling_vit_msn.py#L395)
...
The [ViTMSNForImageClassification](/docs/transformers/v5.17.0/en/model_doc/vit_msn#transformers.ViTMSNForImageClassification) forward method, overrides the `__call__` special method.
...
### Falcon
https://huggingface.co/docs/transformers/v5.17.0/model_doc/falcon.md
