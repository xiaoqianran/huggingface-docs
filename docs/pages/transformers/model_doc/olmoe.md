...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmoe/configuration_olmoe.py#L23)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmoe/modeling_olmoe.py#L435)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmoe/modeling_olmoe.py#L451)
...
elements depending on the configuration ([OlmoeConfig](/docs/transformers/v5.17.0/en/model_doc/olmoe#transformers.OlmoeConfig)) and inputs.

The [OlmoeModel](/docs/transformers/v5.17.0/en/model_doc/olmoe#transformers.OlmoeModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmoe/modeling_olmoe.py#L580)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmoe/modeling_olmoe.py#L598)
...
The [OlmoeForCausalLM](/docs/transformers/v5.17.0/en/model_doc/olmoe#transformers.OlmoeForCausalLM) forward method, overrides the `__call__` special method.
...
### Llama3
https://huggingface.co/docs/transformers/v5.17.0/model_doc/llama3.md
