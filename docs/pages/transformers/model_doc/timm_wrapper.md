...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/configuration_timm_wrapper.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/image_processing_timm_wrapper.py#L38)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/image_processing_timm_wrapper.py#L96)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/modeling_timm_wrapper.py#L163)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/modeling_timm_wrapper.py#L177)
...
elements depending on the configuration ([TimmWrapperConfig](/docs/transformers/v5.17.0/en/model_doc/timm_wrapper#transformers.TimmWrapperConfig)) and inputs.

The [TimmWrapperModel](/docs/transformers/v5.17.0/en/model_doc/timm_wrapper#transformers.TimmWrapperModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/modeling_timm_wrapper.py#L280)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timm_wrapper/modeling_timm_wrapper.py#L303)
...
return_dict (`bool`, *optional*) : Whether or not to return a [ModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.utils.ModelOutput) instead of a plain tuple. **kwargs: Additional keyword arguments passed along to the `timm` model forward.
...
The [TimmWrapperForImageClassification](/docs/transformers/v5.17.0/en/model_doc/timm_wrapper#transformers.TimmWrapperForImageClassification) forward method, overrides the `__call__` special method.
...
### Moonshine
https://huggingface.co/docs/transformers/v5.17.0/model_doc/moonshine.md
