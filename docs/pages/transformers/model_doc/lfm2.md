...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lfm2/configuration_lfm2.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lfm2/modeling_lfm2.py#L457)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lfm2/modeling_lfm2.py#L474)
...
elements depending on the configuration ([Lfm2Config](/docs/transformers/v5.17.0/en/model_doc/lfm2#transformers.Lfm2Config)) and inputs.

The [Lfm2Model](/docs/transformers/v5.17.0/en/model_doc/lfm2#transformers.Lfm2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lfm2/modeling_lfm2.py#L537)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/lfm2/modeling_lfm2.py#L552)
...
The [Lfm2ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/lfm2#transformers.Lfm2ForCausalLM) forward method, overrides the `__call__` special method.
...
### RWKV
https://huggingface.co/docs/transformers/v5.17.0/model_doc/rwkv.md
