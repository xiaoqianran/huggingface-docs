...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nanochat/configuration_nanochat.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nanochat/modeling_nanochat.py#L350)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nanochat/modeling_nanochat.py#L368)
...
elements depending on the configuration ([NanoChatConfig](/docs/transformers/v5.17.0/en/model_doc/nanochat#transformers.NanoChatConfig)) and inputs.

The [NanoChatModel](/docs/transformers/v5.17.0/en/model_doc/nanochat#transformers.NanoChatModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nanochat/modeling_nanochat.py#L425)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nanochat/modeling_nanochat.py#L441)
...
The [NanoChatForCausalLM](/docs/transformers/v5.17.0/en/model_doc/nanochat#transformers.NanoChatForCausalLM) forward method, overrides the `__call__` special method.
...
### Qwen3MoE
https://huggingface.co/docs/transformers/v5.17.0/model_doc/qwen3_moe.md
