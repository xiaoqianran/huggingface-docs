...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/configuration_patchtst.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1066)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1085)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1560)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1590)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1366)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1381)
...
elements depending on the configuration ([PatchTSTConfig](/docs/transformers/v5.17.0/en/model_doc/patchtst#transformers.PatchTSTConfig)) and inputs.

The [PatchTSTForClassification](/docs/transformers/v5.17.0/en/model_doc/patchtst#transformers.PatchTSTForClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1212)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1223)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1809)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/patchtst/modeling_patchtst.py#L1836)
...
The [PatchTSTForRegression](/docs/transformers/v5.17.0/en/model_doc/patchtst#transformers.PatchTSTForRegression) forward method, overrides the `__call__` special method.
...
### GlmImage
https://huggingface.co/docs/transformers/v5.17.0/model_doc/glm_image.md
