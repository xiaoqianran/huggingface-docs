...
The example below demonstrates how to detect text with PP-OCRv6_medium_det using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
Here is how you can do it with PP-OCRv6_medium_det using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel):
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_medium_det/modeling_pp_ocrv6_medium_det.py#L363)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_medium_det/configuration_pp_ocrv6_medium_det.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_medium_det/modeling_pp_ocrv6_medium_det.py#L338)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_medium_det/modeling_pp_ocrv6_medium_det.py#L345)
...
elements depending on the configuration ([PPOCRV6MediumDetConfig](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_medium_det#transformers.PPOCRV6MediumDetConfig)) and inputs.

The [PPOCRV6MediumDetModel](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_medium_det#transformers.PPOCRV6MediumDetModel) forward method, overrides the `__call__` special method.
...
### BART
https://huggingface.co/docs/transformers/v5.17.0/model_doc/bart.md
