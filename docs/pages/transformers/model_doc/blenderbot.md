...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/configuration_blenderbot.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/tokenization_blenderbot.py#L34)
...
See [BartModel](/docs/transformers/v5.17.0/en/model_doc/bart#transformers.BartModel) for arguments to *forward* and *generate*
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L647)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L673)
...
elements depending on the configuration ([BlenderbotConfig](/docs/transformers/v5.17.0/en/model_doc/blenderbot#transformers.BlenderbotConfig)) and inputs.

The [BlenderbotModel](/docs/transformers/v5.17.0/en/model_doc/blenderbot#transformers.BlenderbotModel) forward method, overrides the `__call__` special method.
...
See [BartForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/bart#transformers.BartForConditionalGeneration) for arguments to *forward* and *generate*
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L763)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L795)
...
The [BlenderbotForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L924)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot/modeling_blenderbot.py#L946)
...
The [BlenderbotForCausalLM](/docs/transformers/v5.17.0/en/model_doc/blenderbot#transformers.BlenderbotForCausalLM) forward method, overrides the `__call__` special method.
...
### Bamba
https://huggingface.co/docs/transformers/v5.17.0/model_doc/bamba.md
