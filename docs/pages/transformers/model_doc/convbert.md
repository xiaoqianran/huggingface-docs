...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/configuration_convbert.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/tokenization_convbert.py#L19)

Construct a ConvBERT tokenizer (backed by HuggingFace's tokenizers library). Based on WordPiece.

This tokenizer inherits from [BertTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutlm#transformers.BertTokenizer) which contains most of the main methods. Users should
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L576)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L595)
...
elements depending on the configuration ([ConvBertConfig](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertConfig)) and inputs.

The [ConvBertModel](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L671)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L690)
...
The [ConvBertForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L765)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L776)
...
The [ConvBertForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L838)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L849)
...
The [ConvBertForMultipleChoice](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L933)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L948)
...
The [ConvBertForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L992)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/convbert/modeling_convbert.py#L1003)
...
The [ConvBertForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/convbert#transformers.ConvBertForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### CLAP
https://huggingface.co/docs/transformers/v5.17.0/model_doc/clap.md
