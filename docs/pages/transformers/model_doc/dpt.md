...
DPT is compatible with the [AutoBackbone](/docs/transformers/v5.17.0/en/main_classes/backbones#transformers.AutoBackbone) class. This allows to use the DPT framework with various computer vision backbones available in the library, such as `VitDetBackbone` or `Dinov2Backbone`. One can create it as follows:
...
- Demo notebooks for [DPTForDepthEstimation](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTForDepthEstimation) can be found [here](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/DPT).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/configuration_dpt.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/image_processing_dpt.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/image_processing_dpt.py#L135)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/image_processing_pil_dpt.py#L110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/image_processing_pil_dpt.py#L131)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/image_processing_pil_dpt.py#L268)

**Parameters:**

outputs ([DPTForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTForSemanticSegmentation)) : Raw outputs of the model.
...
Converts the output of [DPTForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTForSemanticSegmentation) into semantic segmentation maps.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/image_processing_pil_dpt.py#L331)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/modeling_dpt.py#L752)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/modeling_dpt.py#L780)
...
elements depending on the configuration ([DPTConfig](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTConfig)) and inputs.

The [DPTModel](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/modeling_dpt.py#L923)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/modeling_dpt.py#L942)
...
The [DPTForDepthEstimation](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTForDepthEstimation) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/modeling_dpt.py#L1073)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dpt/modeling_dpt.py#L1089)
...
The [DPTForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/dpt#transformers.DPTForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
### SAM3 Video
https://huggingface.co/docs/transformers/v5.17.0/model_doc/sam3_video.md
