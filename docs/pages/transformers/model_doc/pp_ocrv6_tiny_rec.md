...
The example below demonstrates how to detect text with PP-OCRv6_tiny_rec using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
Here is how you can do it with PP-OCRv6_tiny_rec using the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel):
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_tiny_rec/modeling_pp_ocrv6_tiny_rec.py#L118)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_tiny_rec/modeling_pp_ocrv6_tiny_rec.py#L128)
...
elements depending on the configuration ([PPOCRV6TinyRecConfig](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_tiny_rec#transformers.PPOCRV6TinyRecConfig)) and inputs.

The [PPOCRV6TinyRecForTextRecognition](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_tiny_rec#transformers.PPOCRV6TinyRecForTextRecognition) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_tiny_rec/configuration_pp_ocrv6_tiny_rec.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_tiny_rec/modeling_pp_ocrv6_tiny_rec.py#L92)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_ocrv6_tiny_rec/modeling_pp_ocrv6_tiny_rec.py#L100)
...
The [PPOCRV6TinyRecModel](/docs/transformers/v5.17.0/en/model_doc/pp_ocrv6_tiny_rec#transformers.PPOCRV6TinyRecModel) forward method, overrides the `__call__` special method.
...
### MarianMT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/marian.md
