...
- [LongT5ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration) is an extension of [T5ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/t5#transformers.T5ForConditionalGeneration) exchanging the traditional
encoder *self-attention* layer with efficient either *local* attention or *transient-global* (*tglobal*) attention.
- Unlike the T5 model, LongT5 does not use a task prefix. Furthermore, it uses a different pre-training objective
inspired by the pre-training of [PegasusForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/configuration_longt5.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/modeling_longt5.py#L1430)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/modeling_longt5.py#L1464)
...
elements depending on the configuration ([LongT5Config](/docs/transformers/v5.17.0/en/model_doc/longt5#transformers.LongT5Config)) and inputs.

The [LongT5Model](/docs/transformers/v5.17.0/en/model_doc/longt5#transformers.LongT5Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/modeling_longt5.py#L1586)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/modeling_longt5.py#L1625)
...
The [LongT5ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/modeling_longt5.py#L1771)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/longt5/modeling_longt5.py#L1795)
...
The [LongT5EncoderModel](/docs/transformers/v5.17.0/en/model_doc/longt5#transformers.LongT5EncoderModel) forward method, overrides the `__call__` special method.
...
### UMT5
https://huggingface.co/docs/transformers/v5.17.0/model_doc/umt5.md
