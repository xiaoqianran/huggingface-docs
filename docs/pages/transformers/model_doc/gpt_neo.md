...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/configuration_gpt_neox_japanese.py#L25)
...
```python
transformers.GPTNeoXJapaneseTokenizer(vocab_file, emoji_file, unk_token = 'REDACTED', pad_token = 'REDACTED', bos_token = 'REDACTED', eos_token = 'REDACTED', do_clean_text = False, **kwargs)
```

[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/tokenization_gpt_neox_japanese.py#L53)
...
This tokenizer inherits from [PreTrainedTokenizer](/docs/transformers/v5.15.0/en/main_classes/tokenizer#transformers.PythonBackend) and is based on Japanese special Sub-Word-Encoding that is
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/tokenization_gpt_neox_japanese.py#L159)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/modeling_gpt_neox_japanese.py#L378)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/modeling_gpt_neox_japanese.py#L399)
...
elements depending on the configuration ([GPTNeoXJapaneseConfig](/docs/transformers/v5.15.0/en/model_doc/gpt_neox_japanese#transformers.GPTNeoXJapaneseConfig)) and inputs.

The [GPTNeoXJapaneseModel](/docs/transformers/v5.15.0/en/model_doc/gpt_neox_japanese#transformers.GPTNeoXJapaneseModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/modeling_gpt_neox_japanese.py#L503)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/gpt_neox_japanese/modeling_gpt_neox_japanese.py#L522)
...
The [GPTNeoXJapaneseForCausalLM](/docs/transformers/v5.15.0/en/model_doc/gpt_neox_japanese#transformers.GPTNeoXJapaneseForCausalLM) forward method, overrides the `__call__` special method.
...
### VoxtralRealtime
https://huggingface.co/docs/transformers/v5.15.0/model_doc/voxtral_realtime.md
