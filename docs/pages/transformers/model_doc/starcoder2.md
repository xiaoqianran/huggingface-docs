...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/configuration_starcoder2.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/modeling_starcoder2.py#L323)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/modeling_starcoder2.py#L341)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/modeling_starcoder2.py#L402)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/modeling_starcoder2.py#L417)
...
elements depending on the configuration ([Starcoder2Config](/docs/transformers/v5.15.0/en/model_doc/starcoder2#transformers.Starcoder2Config)) and inputs.

The [Starcoder2ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/starcoder2#transformers.Starcoder2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/modeling_starcoder2.py#L476)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/starcoder2/modeling_starcoder2.py#L480)
...
### Nougat
https://huggingface.co/docs/transformers/v5.15.0/model_doc/nougat.md
