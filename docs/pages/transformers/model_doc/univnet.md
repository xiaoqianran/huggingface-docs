...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/univnet/configuration_univnet.py#L24)

**Parameters:**

model_in_channels (`int`, *optional*, defaults to 64) : The number of input channels for the UnivNet residual network. This should correspond to `noise_sequence.shape[1]` and the value used in the [UnivNetFeatureExtractor](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor) class.
...
num_mel_bins (`int`, *optional*, defaults to 100) : The number of frequency bins in the conditioning log-mel spectrogram. This should correspond to the value used in the [UnivNetFeatureExtractor](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/univnet/feature_extraction_univnet.py#L29)
...
model_in_channels (`int`, *optional*, defaults to 64) : The number of input channels to the [UnivNetModel](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetModel) model. This should match `UnivNetModel.config.model_in_channels`.
...
return_attention_mask (`bool`, *optional*, defaults to `True`) : Whether or not [__call__()](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetFeatureExtractor.__call__) should return `attention_mask`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/univnet/feature_extraction_univnet.py#L286)
...
return_noise (`bool`, *optional*, defaults to `True`) : Whether to generate and return a noise waveform for use in [UnivNetModel.forward()](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetModel.forward).
...
return_tensors (`str` or [TensorType](/docs/transformers/v5.15.0/en/internal/file_utils#transformers.TensorType), *optional*) : If set, will return tensors instead of list of python integers. Acceptable values are:  - `'pt'`: Return PyTorch `torch.np.array` objects. - `'np'`: Return Numpy `np.ndarray` objects.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/univnet/modeling_univnet.py#L425)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/univnet/modeling_univnet.py#L469)
...
elements depending on the configuration ([UnivNetConfig](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetConfig)) and inputs.

The [UnivNetModel](/docs/transformers/v5.15.0/en/model_doc/univnet#transformers.UnivNetModel) forward method, overrides the `__call__` special method.
...
### GroupViT
https://huggingface.co/docs/transformers/v5.15.0/model_doc/groupvit.md
