...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/configuration_glm_image.py#L149)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/configuration_glm_image.py#L43)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/configuration_glm_image.py#L82)
...
vision_vocab_size (`int`, *optional*, defaults to 16512) : Vision vocabulary size of the GlmImage model. Defines the number of different tokens that can be represented by the `inputs_ids` passed when calling [GlmImageVisionModel](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageVisionModel)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/configuration_glm_image.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/image_processing_glm_image.py#L98)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/image_processing_glm_image.py#L137)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/image_processing_pil_glm_image.py#L96)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/image_processing_pil_glm_image.py#L198)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/processing_glm_image.py#L59)

**Parameters:**

image_processor ([GlmImageProcessor](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageProcessor), *optional*) : The image processor is a required input.

tokenizer ([PreTrainedTokenizerFast](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend), *optional*) : The tokenizer is a required input.
...
[__call__()](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageProcessor.__call__) and [decode()](/docs/transformers/v5.17.0/en/model_doc/donut#transformers.DonutProcessor.decode) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/processing_glm_image.py#L83)
...
and `kwargs` arguments to PreTrainedTokenizerFast's [__call__()](/docs/transformers/v5.17.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__) if `text` is not `None` to encode
the text.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L624)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L650)
...
The [GlmImageVisionModel](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L779)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L803)
...
The [GlmImageTextModel](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L596)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L884)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L1213)
...
The [GlmImageModel](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L1126)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmImageConfig](/docs/transformers/v5.17.0/en/model_doc/glm_image#transformers.GlmImageConfig)) and inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L1353)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L1380)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm_image/modeling_glm_image.py#L1368)
...
### IDEFICS
https://huggingface.co/docs/transformers/v5.17.0/model_doc/idefics.md
