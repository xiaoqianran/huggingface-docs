...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/configuration_zamba2.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/modeling_zamba2.py#L1110)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/modeling_zamba2.py#L1141)
...
elements depending on the configuration ([Zamba2Config](/docs/transformers/v5.15.0/en/model_doc/zamba2#transformers.Zamba2Config)) and inputs.

The [Zamba2Model](/docs/transformers/v5.15.0/en/model_doc/zamba2#transformers.Zamba2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/modeling_zamba2.py#L1251)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/modeling_zamba2.py#L1263)
...
The [Zamba2ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/zamba2#transformers.Zamba2ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/modeling_zamba2.py#L1351)
...
[Zamba2ForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/zamba2#transformers.Zamba2ForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/zamba2/modeling_zamba2.py#L1361)
...
The [Zamba2ForSequenceClassification](/docs/transformers/v5.15.0/en/model_doc/zamba2#transformers.Zamba2ForSequenceClassification) forward method, overrides the `__call__` special method.
...
### PhiMoE
https://huggingface.co/docs/transformers/v5.15.0/model_doc/phimoe.md
