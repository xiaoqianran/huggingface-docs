...
The example below demonstrates how to encode and decode audio with the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mimi/configuration_mimi.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mimi/modeling_mimi.py#L1186)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mimi/modeling_mimi.py#L1408)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mimi/modeling_mimi.py#L1297)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mimi/modeling_mimi.py#L1456)
...
elements depending on the configuration ([MimiConfig](/docs/transformers/v5.17.0/en/model_doc/mimi#transformers.MimiConfig)) and inputs.

The [MimiModel](/docs/transformers/v5.17.0/en/model_doc/mimi#transformers.MimiModel) forward method, overrides the `__call__` special method.
...
### RoFormer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/roformer.md
