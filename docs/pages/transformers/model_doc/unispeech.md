...
- UniSpeech is a speech model that accepts a float array corresponding to the raw waveform of the speech signal. Please
  use [Wav2Vec2Processor](/docs/transformers/v5.17.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor) for the feature extraction.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/configuration_unispeech.py#L27)
...
final_dropout (`float`, *optional*, defaults to 0.1) : The dropout probability for the final projection layer of [UniSpeechForCTC](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForCTC).
...
use_weighted_layer_sum (`bool`, *optional*, defaults to `False`) : Whether to use a weighted average of layer outputs with learned weights. Only relevant when using an instance of [UniSpeechForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForSequenceClassification).
...
num_ctc_classes (`int`, *optional*, defaults to 80) : Specifies the number of classes (phoneme tokens and blank token) for phoneme-level CTC loss. Only relevant when using an instance of [UniSpeechForPreTraining](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForPreTraining).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L62)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L866)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L930)
...
elements depending on the configuration ([UniSpeechConfig](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechConfig)) and inputs.

The [UniSpeechModel](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L1092)
...
target_lang (`str`, *optional*) : Language id of adapter weights. Adapter weights are stored in the format adapter..safetensors or adapter..bin. Only relevant when using an instance of [UniSpeechForCTC](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForCTC) with adapters. Uses 'eng' by default.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L1161)
...
The [UniSpeechForCTC](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForCTC) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L1230)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L1263)
...
The [UniSpeechForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L976)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/unispeech/modeling_unispeech.py#L1025)
...
**Returns:** [UniSpeechForPreTrainingOutput](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput) or `tuple(torch.FloatTensor)`

A [UniSpeechForPreTrainingOutput](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([UniSpeechConfig](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechConfig)) and inputs.

The [UniSpeechForPreTraining](/docs/transformers/v5.17.0/en/model_doc/unispeech#transformers.UniSpeechForPreTraining) forward method, overrides the `__call__` special method.
...
### ALBERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/albert.md
