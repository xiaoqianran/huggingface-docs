...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mamba/configuration_mamba.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mamba/modeling_mamba.py#L614)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mamba/modeling_mamba.py#L639)
...
elements depending on the configuration ([MambaConfig](/docs/transformers/v5.15.0/en/model_doc/mamba#transformers.MambaConfig)) and inputs.

The [MambaModel](/docs/transformers/v5.15.0/en/model_doc/mamba#transformers.MambaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mamba/modeling_mamba.py#L709)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/mamba/modeling_mamba.py#L750)
...
The [MambaForCausalLM](/docs/transformers/v5.15.0/en/model_doc/mamba#transformers.MambaForCausalLM) forward method, overrides the `__call__` special method.
...
### XLM-RoBERTa
https://huggingface.co/docs/transformers/v5.15.0/model_doc/xlm-roberta.md
