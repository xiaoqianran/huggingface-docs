...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_moe/configuration_hunyuan_v1_moe.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L460)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L477)
...
elements depending on the configuration ([HunYuanMoEV1Config](/docs/transformers/v5.17.0/en/model_doc/hunyuan_v1_moe#transformers.HunYuanMoEV1Config)) and inputs.

The [HunYuanMoEV1Model](/docs/transformers/v5.17.0/en/model_doc/hunyuan_v1_moe#transformers.HunYuanMoEV1Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L534)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L549)
...
The [HunYuanMoEV1ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/hunyuan_v1_moe#transformers.HunYuanMoEV1ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_moe/modeling_hunyuan_v1_moe.py#L608)
...
### Data2Vec
https://huggingface.co/docs/transformers/v5.17.0/model_doc/data2vec.md
