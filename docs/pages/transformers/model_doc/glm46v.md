...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/configuration_glm46v.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/image_processing_glm46v.py#L87)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/image_processing_glm46v.py#L104)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/video_processing_glm46v.py#L94)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/image_processing_pil_glm46v.py#L85)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/image_processing_pil_glm46v.py#L102)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/processing_glm46v.py#L43)
...
[~Glm46VImageProcessor](/docs/transformers/v5.15.0/en/model_doc/glm46v#transformers.Glm46VImageProcessor), `~tokenizer_class`, and [~Glm46VVideoProcessor](/docs/transformers/v5.15.0/en/model_doc/glm46v#transformers.Glm46VVideoProcessor) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L74)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L368)
...
The [Glm46VModel](/docs/transformers/v5.15.0/en/model_doc/glm46v#transformers.Glm46VModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L234)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Glm46VConfig](/docs/transformers/v5.15.0/en/model_doc/glm46v#transformers.Glm46VConfig)) and inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L260)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L444)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L482)
...
The [Glm46VForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/glm46v#transformers.Glm46VForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L456)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/glm46v/modeling_glm46v.py#L469)
...
### Bark
https://huggingface.co/docs/transformers/v5.15.0/model_doc/bark.md
