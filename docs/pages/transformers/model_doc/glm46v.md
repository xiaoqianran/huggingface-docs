...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/configuration_glm46v.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/image_processing_glm46v.py#L86)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/image_processing_glm46v.py#L103)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/video_processing_glm46v.py#L93)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/image_processing_pil_glm46v.py#L84)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/image_processing_pil_glm46v.py#L101)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/processing_glm46v.py#L42)
...
[~Glm46VImageProcessor](/docs/transformers/v5.17.0/en/model_doc/glm46v#transformers.Glm46VImageProcessor), `~tokenizer_class`, and [~Glm46VVideoProcessor](/docs/transformers/v5.17.0/en/model_doc/glm46v#transformers.Glm46VVideoProcessor) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L73)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L367)
...
The [Glm46VModel](/docs/transformers/v5.17.0/en/model_doc/glm46v#transformers.Glm46VModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L233)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([Glm46VConfig](/docs/transformers/v5.17.0/en/model_doc/glm46v#transformers.Glm46VConfig)) and inputs.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L259)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L443)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L481)
...
The [Glm46VForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/glm46v#transformers.Glm46VForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L455)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glm46v/modeling_glm46v.py#L468)
...
### Bark
https://huggingface.co/docs/transformers/v5.17.0/model_doc/bark.md
