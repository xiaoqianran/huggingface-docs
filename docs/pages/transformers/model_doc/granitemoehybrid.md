...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoehybrid/configuration_granitemoehybrid.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1038)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1056)
...
The [GraniteMoeHybridModel](/docs/transformers/v5.17.0/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/granitemoehybrid/modeling_granitemoehybrid.py#L1211)
...
The [GraniteMoeHybridForCausalLM](/docs/transformers/v5.17.0/en/model_doc/granitemoehybrid#transformers.GraniteMoeHybridForCausalLM) forward method, overrides the `__call__` special method.
...
### FLAN-T5
https://huggingface.co/docs/transformers/v5.17.0/model_doc/flan-t5.md
