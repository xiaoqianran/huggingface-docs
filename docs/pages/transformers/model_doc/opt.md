...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/configuration_opt.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L400)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L413)
...
elements depending on the configuration ([OPTConfig](/docs/transformers/v5.17.0/en/model_doc/opt#transformers.OPTConfig)) and inputs.

The [OPTModel](/docs/transformers/v5.17.0/en/model_doc/opt#transformers.OPTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L443)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L462)
...
The [OPTForCausalLM](/docs/transformers/v5.17.0/en/model_doc/opt#transformers.OPTForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L541)
...
[OPTForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/opt#transformers.OPTForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L551)
...
The [OPTForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/opt#transformers.OPTForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L644)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/opt/modeling_opt.py#L653)
...
The [OPTForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/opt#transformers.OPTForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### Idefics2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/idefics2.md
