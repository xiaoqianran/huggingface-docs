...
The examples below demonstrates how to generate with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel). We additionally add an example
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/configuration_llama4.py#L208)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/configuration_llama4.py#L79)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/configuration_llama4.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/processing_llama4.py#L34)
...
[Llama4Processor](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4Processor) offers all the functionalities of [Llama4ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4ImageProcessor) and `tokenizer_class`. See the
[~Llama4ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4ImageProcessor) and `~tokenizer_class` for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/image_processing_llama4.py#L296)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/image_processing_llama4.py#L312)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L1159)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L1233)
...
elements depending on the configuration ([Llama4Config](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4Config)) and inputs.

The [Llama4ForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4ForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L1191)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L576)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L593)
...
The [Llama4ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L483)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L510)
...
The [Llama4TextModel](/docs/transformers/v5.17.0/en/model_doc/llama4#transformers.Llama4TextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L1021)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/llama4/modeling_llama4.py#L1058)
...
### Moshi
https://huggingface.co/docs/transformers/v5.17.0/model_doc/moshi.md
