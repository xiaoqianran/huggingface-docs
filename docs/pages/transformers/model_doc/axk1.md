...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/configuration_axk1.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/modeling_axk1.py#L593)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/modeling_axk1.py#L610)
...
elements depending on the configuration ([AXK1Config](/docs/transformers/v5.17.0/en/model_doc/axk1#transformers.AXK1Config)) and inputs.

The [AXK1Model](/docs/transformers/v5.17.0/en/model_doc/axk1#transformers.AXK1Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/modeling_axk1.py#L667)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/modeling_axk1.py#L682)
...
The [AXK1ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/axk1#transformers.AXK1ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/modeling_axk1.py#L741)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/axk1/modeling_axk1.py#L745)
...
### Zamba2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/zamba2.md
