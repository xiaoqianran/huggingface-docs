...
Note that [BlenderbotSmallModel](/docs/transformers/v5.17.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel) and
[BlenderbotSmallForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForConditionalGeneration) are only used in combination with the checkpoint
[facebook/blenderbot-90M](https://huggingface.co/facebook/blenderbot-90M). Larger Blenderbot checkpoints should
instead be used with [BlenderbotModel](/docs/transformers/v5.17.0/en/model_doc/blenderbot#transformers.BlenderbotModel) and
[BlenderbotForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/tokenization_blenderbot_small.py#L51)
...
kwargs (*optional*) : Additional keyword arguments passed along to [PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/tokenization_blenderbot_small.py#L192)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L611)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L637)
...
elements depending on the configuration ([BlenderbotSmallConfig](/docs/transformers/v5.17.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig)) and inputs.

The [BlenderbotSmallModel](/docs/transformers/v5.17.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L727)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L759)
...
The [BlenderbotSmallForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L888)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L910)
...
The [BlenderbotSmallForCausalLM](/docs/transformers/v5.17.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallForCausalLM) forward method, overrides the `__call__` special method.
...
### Mamba 2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mamba2.md
