...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/configuration_llava_next.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/image_processing_llava_next.py#L53)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/image_processing_llava_next.py#L74)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/image_processing_pil_llava_next.py#L50)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/image_processing_pil_llava_next.py#L71)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/processing_llava_next.py#L44)
...
[~LlavaNextImageProcessor](/docs/transformers/v5.15.0/en/model_doc/granitevision#transformers.LlavaNextImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L250)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L430)
...
elements depending on the configuration ([LlavaNextConfig](/docs/transformers/v5.15.0/en/model_doc/granitevision#transformers.LlavaNextConfig)) and inputs.

The [LlavaNextModel](/docs/transformers/v5.15.0/en/model_doc/llava_next#transformers.LlavaNextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L332)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L407)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L265)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L496)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L548)
...
The [LlavaNextForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/granitevision#transformers.LlavaNextForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/llava_next/modeling_llava_next.py#L516)
...
### MiniCPM3
https://huggingface.co/docs/transformers/v5.15.0/model_doc/minicpm3.md
