...
- Demo notebooks for [GLPNForDepthEstimation](/docs/transformers/v5.17.0/en/model_doc/glpn#transformers.GLPNForDepthEstimation) can be found [here](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/GLPN).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/configuration_glpn.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/image_processing_glpn.py#L51)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/image_processing_glpn.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/image_processing_pil_glpn.py#L46)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/image_processing_pil_glpn.py#L65)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/modeling_glpn.py#L377)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/modeling_glpn.py#L389)
...
elements depending on the configuration ([GLPNConfig](/docs/transformers/v5.17.0/en/model_doc/glpn#transformers.GLPNConfig)) and inputs.

The [GLPNModel](/docs/transformers/v5.17.0/en/model_doc/glpn#transformers.GLPNModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/modeling_glpn.py#L565)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/glpn/modeling_glpn.py#L576)
...
The [GLPNForDepthEstimation](/docs/transformers/v5.17.0/en/model_doc/glpn#transformers.GLPNForDepthEstimation) forward method, overrides the `__call__` special method.
...
### Funnel Transformer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/funnel.md
