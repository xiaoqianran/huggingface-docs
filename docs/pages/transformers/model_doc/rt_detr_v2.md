...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr_v2/configuration_rt_detr_v2.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1342)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1461)
...
The [RTDetrV2Model](/docs/transformers/v5.17.0/en/model_doc/rt_detr_v2#transformers.RTDetrV2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1764)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/rt_detr_v2/modeling_rt_detr_v2.py#L1797)
...
The [RTDetrV2ForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/rt_detr_v2#transformers.RTDetrV2ForObjectDetection) forward method, overrides the `__call__` special method.
...
### PI0
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pi0.md
