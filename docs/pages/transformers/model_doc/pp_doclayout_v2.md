...
The example below demonstrates how to generate text with PP-DocLayoutV2 using [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel).
...
Here is how you can do it with PP-DocLayoutV2 using [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel):
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/configuration_pp_doclayout_v2.py#L107)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/modeling_pp_doclayout_v2.py#L2347)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/modeling_pp_doclayout_v2.py#L2373)
...
The [PPDocLayoutV2ForObjectDetection](/docs/transformers/v5.17.0/en/model_doc/pp_doclayout_v2#transformers.PPDocLayoutV2ForObjectDetection) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/modeling_pp_doclayout_v2.py#L2020)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/modeling_pp_doclayout_v2.py#L2141)
...
The [PPDocLayoutV2Model](/docs/transformers/v5.17.0/en/model_doc/pp_doclayout_v2#transformers.PPDocLayoutV2Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/modeling_pp_doclayout_v2.py#L808)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/modeling_pp_doclayout_v2.py#L826)
...
The [PPDocLayoutV2ReadingOrder](/docs/transformers/v5.17.0/en/model_doc/pp_doclayout_v2#transformers.PPDocLayoutV2ReadingOrder) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/pp_doclayout_v2/image_processing_pp_doclayout_v2.py#L34)
...
### KOSMOS-2
https://huggingface.co/docs/transformers/v5.17.0/model_doc/kosmos-2.md
