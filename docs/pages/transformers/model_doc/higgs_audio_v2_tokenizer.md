...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/higgs_audio_v2_tokenizer/configuration_higgs_audio_v2_tokenizer.py#L34)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/higgs_audio_v2_tokenizer/modeling_higgs_audio_v2_tokenizer.py#L456)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/higgs_audio_v2_tokenizer/modeling_higgs_audio_v2_tokenizer.py#L564)
...
return_dict (`bool`, *optional*) : Whether or not to return a [ModelOutput](/docs/transformers/v5.17.0/en/main_classes/output#transformers.utils.ModelOutput)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/higgs_audio_v2_tokenizer/modeling_higgs_audio_v2_tokenizer.py#L512)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/higgs_audio_v2_tokenizer/modeling_higgs_audio_v2_tokenizer.py#L592)
...
The [HiggsAudioV2TokenizerModel](/docs/transformers/v5.17.0/en/model_doc/higgs_audio_v2_tokenizer#transformers.HiggsAudioV2TokenizerModel) forward method, overrides the `__call__` special method.
...
### HyperCLOVA X
https://huggingface.co/docs/transformers/v5.17.0/model_doc/hyperclovax.md
