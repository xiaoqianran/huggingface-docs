...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/configuration_olmo3.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/modeling_olmo3.py#L456)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/modeling_olmo3.py#L471)
...
elements depending on the configuration ([Olmo3Config](/docs/transformers/v5.17.0/en/model_doc/olmo3#transformers.Olmo3Config)) and inputs.

The [Olmo3ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/olmo3#transformers.Olmo3ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/modeling_olmo3.py#L530)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/modeling_olmo3.py#L373)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/modeling_olmo3.py#L390)
...
The [Olmo3Model](/docs/transformers/v5.17.0/en/model_doc/olmo3#transformers.Olmo3Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/olmo3/modeling_olmo3.py#L343)
...
### Ministral
https://huggingface.co/docs/transformers/v5.17.0/model_doc/ministral.md
