...
The example below demonstrates how to obtain an image embedding with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline) or the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_vit/configuration_dinov3_vit.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_convnext/configuration_dinov3_convnext.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_vit/modeling_dinov3_vit.py#L508)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_vit/modeling_dinov3_vit.py#L522)
...
elements depending on the configuration ([DINOv3ViTConfig](/docs/transformers/v5.17.0/en/model_doc/dinov3#transformers.DINOv3ViTConfig)) and inputs.

The [DINOv3ViTModel](/docs/transformers/v5.17.0/en/model_doc/dinov3#transformers.DINOv3ViTModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_vit/modeling_dinov3_vit.py#L553)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_vit/modeling_dinov3_vit.py#L569)
...
The [DINOv3ViTBackbone](/docs/transformers/v5.17.0/en/model_doc/dinov3#transformers.DINOv3ViTBackbone) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_convnext/modeling_dinov3_convnext.py#L218)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_convnext/modeling_dinov3_convnext.py#L226)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([DINOv3ConvNextConfig](/docs/transformers/v5.17.0/en/model_doc/dinov3#transformers.DINOv3ConvNextConfig)) and inputs.

The [DINOv3ConvNextModel](/docs/transformers/v5.17.0/en/model_doc/dinov3#transformers.DINOv3ConvNextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_vit/image_processing_dinov3_vit.py#L34)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_convnext/modeling_dinov3_convnext.py#L253)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/dinov3_convnext/modeling_dinov3_convnext.py#L268)
...
The [DINOv3ConvNextBackbone](/docs/transformers/v5.17.0/en/model_doc/dinov3#transformers.DINOv3ConvNextBackbone) forward method, overrides the `__call__` special method.
...
### CodeLlama
https://huggingface.co/docs/transformers/v5.17.0/model_doc/code_llama.md
