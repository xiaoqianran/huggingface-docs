...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dots1/configuration_dots1.py#L29)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dots1/modeling_dots1.py#L463)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dots1/modeling_dots1.py#L481)
...
elements depending on the configuration ([Dots1Config](/docs/transformers/v5.15.0/en/model_doc/dots1#transformers.Dots1Config)) and inputs.

The [Dots1Model](/docs/transformers/v5.15.0/en/model_doc/dots1#transformers.Dots1Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dots1/modeling_dots1.py#L548)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/dots1/modeling_dots1.py#L563)
...
The [Dots1ForCausalLM](/docs/transformers/v5.15.0/en/model_doc/dots1#transformers.Dots1ForCausalLM) forward method, overrides the `__call__` special method.
...
### DepthPro
https://huggingface.co/docs/transformers/v5.15.0/model_doc/depth_pro.md
