...
- BEiT models are regular Vision Transformers, but pre-trained in a self-supervised way rather than supervised. They
  ...
  [ViTImageProcessor](/docs/transformers/v5.17.0/en/model_doc/vit#transformers.ViTImageProcessor) by [BeitImageProcessor](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitImageProcessor) and
  [ViTForImageClassification](/docs/transformers/v5.17.0/en/model_doc/vit#transformers.ViTForImageClassification) by [BeitForImageClassification](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForImageClassification)).
- There's also a demo notebook available which showcases how to combine DALL-E's image tokenizer with BEiT for
  performing masked image modeling. You can find it [here](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/BEiT).
- As the BEiT models expect each image to be of the same size (resolution), one can use
  [BeitImageProcessor](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitImageProcessor) to resize (or rescale) and normalize images for the model.
...
- BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
  ...
  `use_relative_position_bias` attribute of [BeitConfig](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitConfig) to `True` in order to add
  position embeddings.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L54)
...
Class for outputs of [BeitModel](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitModel).
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/configuration_beit.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/image_processing_beit.py#L50)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/image_processing_beit.py#L70)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/image_processing_beit.py#L183)

**Parameters:**

outputs ([BeitForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForSemanticSegmentation)) : Raw outputs of the model.
...
Converts the output of [BeitForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForSemanticSegmentation) into semantic segmentation maps.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/image_processing_pil_beit.py#L53)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/image_processing_pil_beit.py#L73)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/image_processing_pil_beit.py#L169)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L486)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L512)
...
**Returns:** [BeitModelOutputWithPooling](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.models.beit.modeling_beit.BeitModelOutputWithPooling) or `tuple(torch.FloatTensor)`

A [BeitModelOutputWithPooling](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.models.beit.modeling_beit.BeitModelOutputWithPooling) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([BeitConfig](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitConfig)) and inputs.

The [BeitModel](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L583)
...
predict RGB pixel values. As a result, this class is incompatible with [AutoModelForMaskedImageModeling](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModelForMaskedImageModeling), so you
will need to use [BeitForMaskedImageModeling](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForMaskedImageModeling) directly if you wish to do masked image modeling with BEiT.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L600)
...
The [BeitForMaskedImageModeling](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForMaskedImageModeling) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L675)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L688)
...
The [BeitForImageClassification](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForImageClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L984)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/beit/modeling_beit.py#L1006)
...
The [BeitForSemanticSegmentation](/docs/transformers/v5.17.0/en/model_doc/beit#transformers.BeitForSemanticSegmentation) forward method, overrides the `__call__` special method.
...
### PPLCNetV4
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pp_lcnet_v4.md
