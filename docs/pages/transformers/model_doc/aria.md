...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/image_processing_aria.py#L52)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/image_processing_pil_aria.py#L53)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/processing_aria.py#L63)
...
[~AriaImageProcessor](/docs/transformers/v5.15.0/en/model_doc/aria#transformers.AriaImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/configuration_aria.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/configuration_aria.py#L104)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L678)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L695)
...
elements depending on the configuration ([AriaConfig](/docs/transformers/v5.15.0/en/model_doc/aria#transformers.AriaConfig)) and inputs.

The [AriaTextModel](/docs/transformers/v5.15.0/en/model_doc/aria#transformers.AriaTextModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L881)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L944)
...
The [AriaModel](/docs/transformers/v5.15.0/en/model_doc/aria#transformers.AriaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L889)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L920)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L752)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L767)
...
The [AriaTextForCausalLM](/docs/transformers/v5.15.0/en/model_doc/aria#transformers.AriaTextForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L1017)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L1044)
...
The [AriaForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/aria#transformers.AriaForConditionalGeneration) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/aria/modeling_aria.py#L1029)
...
### Qwen2-VL
https://huggingface.co/docs/transformers/v5.15.0/model_doc/qwen2_vl.md
