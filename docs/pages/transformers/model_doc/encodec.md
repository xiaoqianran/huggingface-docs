...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/configuration_encodec.py#L27)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/feature_extraction_encodec.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/feature_extraction_encodec.py#L81)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/modeling_encodec.py#L485)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/modeling_encodec.py#L661)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/modeling_encodec.py#L525)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/encodec/modeling_encodec.py#L716)
...
elements depending on the configuration ([EncodecConfig](/docs/transformers/v5.17.0/en/model_doc/encodec#transformers.EncodecConfig)) and inputs.

The [EncodecModel](/docs/transformers/v5.17.0/en/model_doc/encodec#transformers.EncodecModel) forward method, overrides the `__call__` special method.
...
### LLaVa
https://huggingface.co/docs/transformers/v5.17.0/model_doc/llava.md
