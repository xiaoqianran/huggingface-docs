...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bert_japanese/tokenization_bert_japanese.py#L58)
...
This tokenizer inherits from [PreTrainedTokenizer](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.PythonBackend) which contains most of the main methods. Users should refer
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/bert_japanese/tokenization_bert_japanese.py#L256)

Converts a sequence of tokens (string) in a single string.

### SAM3-LiteText
https://huggingface.co/docs/transformers/v5.17.0/model_doc/sam3_lite_text.md
