...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/configuration_deepseek_vl.py#L34)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/processing_deepseek_vl.py#L38)
...
[~DeepseekVLImageProcessor](/docs/transformers/v5.17.0/en/model_doc/deepseek_vl#transformers.DeepseekVLImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.17.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/image_processing_deepseek_vl.py#L44)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/image_processing_pil_deepseek_vl.py#L50)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/image_processing_pil_deepseek_vl.py#L71)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L129)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L177)
...
elements depending on the configuration ([DeepseekVLConfig](/docs/transformers/v5.17.0/en/model_doc/deepseek_vl#transformers.DeepseekVLConfig)) and inputs.

The [DeepseekVLModel](/docs/transformers/v5.17.0/en/model_doc/deepseek_vl#transformers.DeepseekVLModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L143)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L226)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/deepseek_vl/modeling_deepseek_vl.py#L240)
...
The [DeepseekVLForConditionalGeneration](/docs/transformers/v5.17.0/en/model_doc/deepseek_vl#transformers.DeepseekVLForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### PhoBERT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/phobert.md
