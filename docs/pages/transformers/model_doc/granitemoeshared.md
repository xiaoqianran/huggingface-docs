...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoeshared/configuration_granitemoeshared.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L472)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L490)
...
elements depending on the configuration ([GraniteMoeSharedConfig](/docs/transformers/v5.15.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedConfig)) and inputs.

The [GraniteMoeSharedModel](/docs/transformers/v5.15.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L632)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/granitemoeshared/modeling_granitemoeshared.py#L651)
...
The [GraniteMoeSharedForCausalLM](/docs/transformers/v5.15.0/en/model_doc/granitemoeshared#transformers.GraniteMoeSharedForCausalLM) forward method, overrides the `__call__` special method.
...
### SAM2 Video
https://huggingface.co/docs/transformers/v5.15.0/model_doc/sam2_video.md
