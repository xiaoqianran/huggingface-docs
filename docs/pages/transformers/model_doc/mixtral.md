...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/configuration_mixtral.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L410)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L427)
...
elements depending on the configuration ([MixtralConfig](/docs/transformers/v5.17.0/en/model_doc/mixtral#transformers.MixtralConfig)) and inputs.

The [MixtralModel](/docs/transformers/v5.17.0/en/model_doc/mixtral#transformers.MixtralModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L555)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L573)
...
The [MixtralForCausalLM](/docs/transformers/v5.17.0/en/model_doc/mixtral#transformers.MixtralForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L658)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L662)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/mixtral/modeling_mixtral.py#L666)
...
### TimeSformer
https://huggingface.co/docs/transformers/v5.17.0/model_doc/timesformer.md
