...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_dense/configuration_hunyuan_v1_dense.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L383)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L400)
...
elements depending on the configuration ([HunYuanDenseV1Config](/docs/transformers/v5.17.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Config)) and inputs.

The [HunYuanDenseV1Model](/docs/transformers/v5.17.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L457)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L472)
...
The [HunYuanDenseV1ForCausalLM](/docs/transformers/v5.17.0/en/model_doc/hunyuan_v1_dense#transformers.HunYuanDenseV1ForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/hunyuan_v1_dense/modeling_hunyuan_v1_dense.py#L531)
...
### OPT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/opt.md
