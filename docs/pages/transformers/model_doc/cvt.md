...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cvt/configuration_cvt.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cvt/modeling_cvt.py#L499)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cvt/modeling_cvt.py#L510)
...
elements depending on the configuration ([CvtConfig](/docs/transformers/v5.17.0/en/model_doc/cvt#transformers.CvtConfig)) and inputs.

The [CvtModel](/docs/transformers/v5.17.0/en/model_doc/cvt#transformers.CvtModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cvt/modeling_cvt.py#L549)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/cvt/modeling_cvt.py#L564)
...
The [CvtForImageClassification](/docs/transformers/v5.17.0/en/model_doc/cvt#transformers.CvtForImageClassification) forward method, overrides the `__call__` special method.
...
### M2M100
https://huggingface.co/docs/transformers/v5.17.0/model_doc/m2m_100.md
