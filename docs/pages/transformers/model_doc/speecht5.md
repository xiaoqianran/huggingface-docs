...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/configuration_speecht5.py#L27)
...
num_mel_bins (`int`, *optional*, defaults to 80) : Number of mel features used per input features. Used by the speech decoder pre-net. Should correspond to the value used in the [SpeechT5Processor](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5Processor) class.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/configuration_speecht5.py#L225)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/tokenization_speecht5.py#L30)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/feature_extraction_speecht5.py#L29)
...
return_attention_mask (`bool`, *optional*, defaults to `True`) : Whether or not [__call__()](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5FeatureExtractor.__call__) should return `attention_mask`.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/feature_extraction_speecht5.py#L159)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/processing_speecht5.py#L21)
...
[~SpeechT5FeatureExtractor](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5FeatureExtractor) and [~SpeechT5Tokenizer](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5Tokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/processing_speecht5.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/processing_speecht5.py#L74)

Collates the audio and text inputs, as well as their targets, into a padded batch.

Audio inputs are padded by SpeechT5FeatureExtractor's [pad()](/docs/transformers/v5.15.0/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor.pad). Text inputs are padded
by SpeechT5Tokenizer's [pad()](/docs/transformers/v5.15.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.pad).
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L1852)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L1894)
...
elements depending on the configuration ([SpeechT5Config](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5Config)) and inputs.

The [SpeechT5Model](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5Model) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L1998)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2034)
...
The [SpeechT5ForSpeechToText](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5ForSpeechToText) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2310)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2341)
...
**Returns:** [Seq2SeqSpectrogramOutput](/docs/transformers/v5.15.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSpectrogramOutput) or `tuple(torch.FloatTensor)`

A [Seq2SeqSpectrogramOutput](/docs/transformers/v5.15.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSpectrogramOutput) or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([SpeechT5Config](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5Config)) and inputs.

The [SpeechT5ForTextToSpeech](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5ForTextToSpeech) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2464)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2658)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2678)
...
The [SpeechT5ForSpeechToSpeech](/docs/transformers/v5.15.0/en/model_doc/speecht5#transformers.SpeechT5ForSpeechToSpeech) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2796)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L2954)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/speecht5/modeling_speecht5.py#L3022)
...
https://huggingface.co/docs/transformers/v5.15.0/model_doc/cwm.md
