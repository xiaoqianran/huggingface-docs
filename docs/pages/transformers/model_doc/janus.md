...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/configuration_janus.py#L105)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/configuration_janus.py#L33)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/configuration_janus.py#L66)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/processing_janus.py#L54)
...
[~JanusImageProcessor](/docs/transformers/v5.15.0/en/model_doc/janus#transformers.JanusImageProcessor) and [~TokenizersBackend](/docs/transformers/v5.15.0/en/main_classes/tokenizer#transformers.TokenizersBackend) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/processing_janus.py#L80)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/image_processing_janus.py#L47)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/image_processing_pil_janus.py#L55)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/image_processing_pil_janus.py#L76)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L421)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L441)
...
elements depending on the configuration ([JanusConfig](/docs/transformers/v5.15.0/en/model_doc/janus#transformers.JanusConfig)) and inputs.

The [JanusVisionModel](/docs/transformers/v5.15.0/en/model_doc/janus#transformers.JanusVisionModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L850)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L907)
...
The [JanusVQVAE](/docs/transformers/v5.15.0/en/model_doc/janus#transformers.JanusVQVAE) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L960)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L1016)
...
The [JanusModel](/docs/transformers/v5.15.0/en/model_doc/janus#transformers.JanusModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L982)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L1065)
...
[Source](https://github.com/huggingface/transformers/blob/v5.15.0/src/transformers/models/janus/modeling_janus.py#L1084)
...
The [JanusForConditionalGeneration](/docs/transformers/v5.15.0/en/model_doc/janus#transformers.JanusForConditionalGeneration) forward method, overrides the `__call__` special method.
...
### ColQwen2
https://huggingface.co/docs/transformers/v5.15.0/model_doc/colqwen2.md
