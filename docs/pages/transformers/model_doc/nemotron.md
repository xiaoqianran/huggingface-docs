...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/configuration_nemotron.py#L26)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L374)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L398)
...
elements depending on the configuration ([NemotronConfig](/docs/transformers/v5.17.0/en/model_doc/nemotron#transformers.NemotronConfig)) and inputs.

The [NemotronModel](/docs/transformers/v5.17.0/en/model_doc/nemotron#transformers.NemotronModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L456)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L468)
...
The [NemotronForCausalLM](/docs/transformers/v5.17.0/en/model_doc/nemotron#transformers.NemotronForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L531)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L534)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/nemotron/modeling_nemotron.py#L538)
...
### Pixtral
https://huggingface.co/docs/transformers/v5.17.0/model_doc/pixtral.md
