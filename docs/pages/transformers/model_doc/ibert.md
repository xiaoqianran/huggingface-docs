...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/configuration_ibert.py#L26)
...
type_vocab_size (`int`, *optional*, defaults to 2) : The vocabulary size of the `token_type_ids` passed when calling [IBertModel](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertModel)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L621)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L654)
...
elements depending on the configuration ([IBertConfig](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertConfig)) and inputs.

The [IBertModel](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L728)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L750)
...
The [IBertForMaskedLM](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertForMaskedLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L830)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L841)
...
The [IBertForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L911)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L922)
...
The [IBertForMultipleChoice](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertForMultipleChoice) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L1013)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L1025)
...
The [IBertForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertForTokenClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L1098)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/ibert/modeling_ibert.py#L1109)
...
The [IBertForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/ibert#transformers.IBertForQuestionAnswering) forward method, overrides the `__call__` special method.
...
### LeViT
https://huggingface.co/docs/transformers/v5.17.0/model_doc/levit.md
