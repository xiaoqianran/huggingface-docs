...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timesfm/configuration_timesfm.py#L24)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timesfm/modeling_timesfm.py#L332)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timesfm/modeling_timesfm.py#L368)
...
elements depending on the configuration ([TimesFmConfig](/docs/transformers/v5.17.0/en/model_doc/timesfm#transformers.TimesFmConfig)) and inputs.

The [TimesFmModel](/docs/transformers/v5.17.0/en/model_doc/timesfm#transformers.TimesFmModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timesfm/modeling_timesfm.py#L569)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/timesfm/modeling_timesfm.py#L651)
...
The [TimesFmModelForPrediction](/docs/transformers/v5.17.0/en/model_doc/timesfm#transformers.TimesFmModelForPrediction) forward method, overrides the `__call__` special method.
...
### GPT-J
https://huggingface.co/docs/transformers/v5.17.0/model_doc/gptj.md
