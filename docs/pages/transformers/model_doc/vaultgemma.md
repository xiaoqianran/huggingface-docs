...
The example below demonstrates how to chat with the model with [Pipeline](/docs/transformers/v5.17.0/en/main_classes/pipelines#transformers.Pipeline), the [AutoModel](/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModel) class, or from the
command line.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vaultgemma/configuration_vaultgemma.py#L31)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vaultgemma/modeling_vaultgemma.py#L372)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vaultgemma/modeling_vaultgemma.py#L391)
...
elements depending on the configuration ([VaultGemmaConfig](/docs/transformers/v5.17.0/en/model_doc/vaultgemma#transformers.VaultGemmaConfig)) and inputs.

The [VaultGemmaModel](/docs/transformers/v5.17.0/en/model_doc/vaultgemma#transformers.VaultGemmaModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vaultgemma/modeling_vaultgemma.py#L457)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/vaultgemma/modeling_vaultgemma.py#L472)
...
The [VaultGemmaForCausalLM](/docs/transformers/v5.17.0/en/model_doc/vaultgemma#transformers.VaultGemmaForCausalLM) forward method, overrides the `__call__` special method.
...
### RAG
https://huggingface.co/docs/transformers/v5.17.0/model_doc/rag.md
