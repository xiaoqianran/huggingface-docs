...
[LayoutXLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer)/[LayoutXLMTokenizerFast](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer). You can initialize it as
follows:
...
Similar to LayoutLMv2, you can use [LayoutXLMProcessor](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMProcessor) (which internally applies
[LayoutLMv2ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/layoutlmv2#transformers.LayoutLMv2ImageProcessor) and
[LayoutXLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer)/[LayoutXLMTokenizerFast](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer) in sequence) to prepare all
data for the model.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/configuration_layoutxlm.py#L35)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L140)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L413)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L892)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L918)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/processing_layoutxlm.py#L24)
...
[~LayoutLMv2ImageProcessor](/docs/transformers/v5.17.0/en/model_doc/layoutlmv2#transformers.LayoutLMv2ImageProcessor) and [~LayoutXLMTokenizer](/docs/transformers/v5.17.0/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer) for more information.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/layoutxlm/processing_layoutxlm.py#L28)
...
### Mask2Former
https://huggingface.co/docs/transformers/v5.17.0/model_doc/mask2former.md
