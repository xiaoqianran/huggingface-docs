...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/configuration_gpt_neox.py#L25)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/tokenization_gpt_neox.py#L28)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L305)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L320)
...
elements depending on the configuration ([GPTNeoXConfig](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXConfig)) and inputs.

The [GPTNeoXModel](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXModel) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L387)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L407)
...
The [GPTNeoXForCausalLM](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXForCausalLM) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L619)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L629)
...
The [GPTNeoXForQuestionAnswering](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXForQuestionAnswering) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L485)
...
[GPTNeoXForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXForSequenceClassification) uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L495)
...
The [GPTNeoXForSequenceClassification](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXForSequenceClassification) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L559)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L571)
...
The [GPTNeoXForTokenClassification](/docs/transformers/v5.17.0/en/model_doc/gpt_neox#transformers.GPTNeoXForTokenClassification) forward method, overrides the `__call__` special method.
...
### MusicGen Melody
https://huggingface.co/docs/transformers/v5.17.0/model_doc/musicgen_melody.md
