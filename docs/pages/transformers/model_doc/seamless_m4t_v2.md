...
[SeamlessM4Tv2Model](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2Model) can perform all the above tasks, but each task also has its own dedicated sub-model.
...
[SeamlessM4Tv2Model](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2Model) can *seamlessly* generate text or speech with few or no changes. Let's target Russian voice translation:
...
Similarly, you can generate translated text from audio files or from text with the same model. You only have to pass `generate_speech=False` to [SeamlessM4Tv2Model.generate()](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2Model.generate).
...
[SeamlessM4Tv2Model](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2Model) is transformers top level model to generate speech and text, but you can also use dedicated models that perform the task without additional components, thus reducing the memory footprint.
...
Feel free to try out [SeamlessM4Tv2ForSpeechToText](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2ForSpeechToText) and [SeamlessM4Tv2ForTextToSpeech](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2ForTextToSpeech) as well.
...
Use `return_intermediate_token_ids=True` with [SeamlessM4Tv2Model](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2Model) to return both speech and text !
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L3661)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L3855)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2980)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L3114)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L3318)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L3451)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2497)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2533)
...
elements depending on the configuration ([SeamlessM4Tv2Config](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2Config)) and inputs.

The [SeamlessM4Tv2ForTextToText](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2ForTextToText) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2615)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2732)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2770)
...
The [SeamlessM4Tv2ForSpeechToText](/docs/transformers/v5.17.0/en/model_doc/seamless_m4t_v2#transformers.SeamlessM4Tv2ForSpeechToText) forward method, overrides the `__call__` special method.
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/modeling_seamless_m4t_v2.py#L2861)
...
[Source](https://github.com/huggingface/transformers/blob/v5.17.0/src/transformers/models/seamless_m4t_v2/configuration_seamless_m4t_v2.py#L24)
...
### Nemotron
https://huggingface.co/docs/transformers/v5.17.0/model_doc/nemotron.md
