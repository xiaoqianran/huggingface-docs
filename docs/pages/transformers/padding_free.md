...
- Browse the [DataCollatorWithFlattening](/docs/transformers/v5.17.0/en/main_classes/data_collator#transformers.DataCollatorWithFlattening) API reference for the full set of arguments.
...
### Models timeline
https://huggingface.co/docs/transformers/v5.17.0/models_timeline.md
