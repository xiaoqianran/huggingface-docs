...
```python
safetensors.paddle.load_file(filename: typing.Union[str, os.PathLike], device = 'cpu', backend: str = 'mmap')
```
...
```python
safetensors.paddle.load(data: bytes, device: str = 'cpu')
```
...
```python
safetensors.paddle.save_file(tensors: typing.Dict[str, paddle.Tensor], filename: typing.Union[str, os.PathLike], metadata: typing.Optional[typing.Dict[str, str]] = None)
```
...
```python
safetensors.paddle.save(tensors: typing.Dict[str, paddle.Tensor], metadata: typing.Optional[typing.Dict[str, str]] = None)
```
