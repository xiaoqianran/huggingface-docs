...
Pretrained models can be loaded using [create_model()](/docs/timm/v1.0.30/en/reference/models#timm.create_model).
...
To list models packaged with `timm`, you can use [list_models()](/docs/timm/v1.0.30/en/reference/models#timm.list_models). If you specify `pretrained=True`, this function will only return model names that have associated pretrained weights available. 
...
To transform images into valid inputs for a model, you can use [timm.data.create_transform()](/docs/timm/v1.0.30/en/reference/data#timm.data.create_transform), providing the desired `input_size` that the model expects.
...
We can then resolve only the data related configuration by using [timm.data.resolve_data_config()](/docs/timm/v1.0.30/en/reference/data#timm.data.resolve_data_config).
...
We can pass this data config to [timm.data.create_transform()](/docs/timm/v1.0.30/en/reference/data#timm.data.create_transform) to initialize the model's associated transform.
...
### timm
https://huggingface.co/docs/timm/v1.0.30/index.md
