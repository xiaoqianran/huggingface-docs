...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/scheduler_factory.py#L51)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/scheduler_factory.py#L63)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/cosine_lr.py#L19)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/multistep_lr.py#L10)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/plateau_lr.py#L13)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/poly_lr.py#L19)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/step_lr.py#L15)
...
[Source](https://github.com/huggingface/pytorch-image-models/blob/v1.0.30/timm/scheduler/tanh_lr.py#L19)

Hyberbolic-Tangent decay with restarts.
This is described in the paper https://arxiv.org/abs/1806.01593

### Models[[timm.create_model]]
https://huggingface.co/docs/timm/v1.0.30/reference/models.md
