...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/_oauth.py#L124)
...
- If user is logged in, an [OAuthInfo](/docs/huggingface_hub/v1.32.0/en/package_reference/oauth#huggingface_hub.OAuthInfo) object is returned with the user's info. If not, `None` is returned.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/_oauth.py#L191)

Returns the information from a logged-in user as a [OAuthInfo](/docs/huggingface_hub/v1.32.0/en/package_reference/oauth#huggingface_hub.OAuthInfo) object.
...
See [attach_huggingface_oauth()](/docs/huggingface_hub/v1.32.0/en/package_reference/oauth#huggingface_hub.attach_huggingface_oauth) for an example on how to use this method.
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/_oauth.py#L23)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/_oauth.py#L57)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v1.32.0/src/huggingface_hub/_oauth.py#L100)
...
user_info ([OAuthUserInfo](/docs/huggingface_hub/v1.32.0/en/package_reference/oauth#huggingface_hub.OAuthUserInfo)) : The user information.
...
### Sandboxes
https://huggingface.co/docs/huggingface_hub/v1.32.0/package_reference/sandbox.md
