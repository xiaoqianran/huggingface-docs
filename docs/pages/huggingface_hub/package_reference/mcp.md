...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/inference/_mcp/mcp_client.py#L55)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/inference/_mcp/mcp_client.py#L123)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/inference/_mcp/mcp_client.py#L109)
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/inference/_mcp/mcp_client.py#L252)
...
[ChatCompletionStreamOutput](/docs/huggingface_hub/v2.0.0/en/package_reference/inference_types#huggingface_hub.ChatCompletionStreamOutput) chunks or [ChatCompletionInputMessage](/docs/huggingface_hub/v2.0.0/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputMessage) objects
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/inference/_mcp/agent.py#L13)
...
Implementation of a Simple Agent, which is a simple while loop built right on top of an [MCPClient](/docs/huggingface_hub/v2.0.0/en/package_reference/mcp#huggingface_hub.MCPClient).
...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/inference/_mcp/agent.py#L57)
...
### Downloading files
https://huggingface.co/docs/huggingface_hub/v2.0.0/package_reference/file_download.md
