...
[ChatCompletionStreamOutput](/docs/huggingface_hub/v1.30.0/en/package_reference/inference_types#huggingface_hub.ChatCompletionStreamOutput) chunks or [ChatCompletionInputMessage](/docs/huggingface_hub/v1.30.0/en/package_reference/inference_types#huggingface_hub.ChatCompletionInputMessage) objects
...
Implementation of a Simple Agent, which is a simple while loop built right on top of an [MCPClient](/docs/huggingface_hub/v1.30.0/en/package_reference/mcp#huggingface_hub.MCPClient).
