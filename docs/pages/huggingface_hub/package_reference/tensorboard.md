...
[Source](https://github.com/huggingface/huggingface_hub/blob/v2.0.0/src/huggingface_hub/_tensorboard_logger.py#L39)
...
https://huggingface.co/docs/huggingface_hub/v2.0.0/package_reference/collections.md
