...
[Source](https://github.com/huggingface/peft/blob/v0.21.0/src/peft/tuners/road/config.py#L28)
...
This is the configuration class to store the configuration of a [RoadModel](/docs/peft/v0.21.0/en/package_reference/road#peft.RoadModel). RoAd adapter is proposed in
...
[Source](https://github.com/huggingface/peft/blob/v0.21.0/src/peft/tuners/road/model.py#L39)

### DeLoRA: Decoupled Low-rank Adaptation
https://huggingface.co/docs/peft/v0.21.0/package_reference/delora.md
