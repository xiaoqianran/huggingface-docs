...
[Source](https://github.com/huggingface/peft/blob/v0.21.0/src/peft/tuners/tuners_utils.py#L2705)
...
[Source](https://github.com/huggingface/peft/blob/v0.21.0/src/peft/tuners/tuners_utils.py#L2666)
...
[Source](https://github.com/huggingface/peft/blob/v0.21.0/src/peft/tuners/tuners_utils.py#L2615)
...
model ([PeftModel](/docs/peft/v0.21.0/en/package_reference/peft_model#peft.PeftModel)) : The Peft model.

peft_model_state_dict (`dict`) : The state dict of the Peft model.

adapter_name (`str`, *optional*, defaults to `"default"`) : The name of the adapter whose state dict should be set.

ignore_mismatched_sizes (`bool`, *optional*, defaults to `False`) : Whether to ignore mismatched sizes in the state dict.
...
Given a PEFT `state_dict` (as returned by [get_peft_model_state_dict()](/docs/peft/v0.21.0/en/package_reference/functional#peft.get_peft_model_state_dict)), insert the weights into the model. The
model needs to have the PEFT adapters already in place (e.g. via [inject_adapter_in_model()](/docs/peft/v0.21.0/en/package_reference/functional#peft.inject_adapter_in_model)).
...
### LoKr
https://huggingface.co/docs/peft/v0.21.0/package_reference/lokr.md
