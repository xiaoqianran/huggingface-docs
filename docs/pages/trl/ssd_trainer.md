...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/ssd/ssd_config.py#L24)

**Parameters that control generation and rollout reuse:**

model_init_kwargs (`dict[str, Any]`, *optional*) : Keyword arguments used when the `model` argument is passed as a string. The `revision` value is also used when loading the processing class.
...
Configuration class for [experimental.ssd.SSDTrainer](/docs/trl/v1.13.0/en/ssd_trainer#trl.experimental.ssd.SSDTrainer).
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/ssd/ssd_trainer.py#L74)
...
### SDFT
https://huggingface.co/docs/trl/v1.13.0/sdft_trainer.md
