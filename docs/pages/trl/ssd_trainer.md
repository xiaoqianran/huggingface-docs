...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/experimental/ssd/ssd_config.py#L24)
...
Configuration class for [experimental.ssd.SSDTrainer](/docs/trl/v1.14.0/en/ssd_trainer#trl.experimental.ssd.SSDTrainer).
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/experimental/ssd/ssd_trainer.py#L74)
...
### SDFT
https://huggingface.co/docs/trl/v1.14.0/sdft_trainer.md
