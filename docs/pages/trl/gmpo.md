...
To use GMPO, you can use the [experimental.gmpo.GMPOTrainer](/docs/trl/v1.13.0/en/gmpo#trl.experimental.gmpo.GMPOTrainer) class in `trl.experimental.gmpo`.
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/gmpo/gmpo_trainer.py#L22)
...
The only change w.r.t. [GRPOTrainer](/docs/trl/v1.13.0/en/grpo_trainer#trl.GRPOTrainer) is `_compute_loss`. Everything else (generation, reward computation, weight
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/gmpo/gmpo_config.py#L21)
...
Configuration class for the [experimental.gmpo.GMPOTrainer](/docs/trl/v1.13.0/en/gmpo#trl.experimental.gmpo.GMPOTrainer).

[experimental.gmpo.GMPOConfig](/docs/trl/v1.13.0/en/gmpo#trl.experimental.gmpo.GMPOConfig) inherits every parameter from [GRPOConfig](/docs/trl/v1.13.0/en/grpo_trainer#trl.GRPOConfig); it only changes the meaning and
...
### Async Distillation
https://huggingface.co/docs/trl/v1.13.0/async_distillation_trainer.md
