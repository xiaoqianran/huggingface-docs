...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/a2po/a2po_trainer.py#L48)

**Parameters:**

model (`PreTrainedModel` or `str`) : Model to be trained, or a model identifier (string) passed to [from_pretrained](https://huggingface.co/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModelForCausalLM.from_pretrained).
...
args ([experimental.a2po.A2POConfig](/docs/trl/v1.13.0/en/a2po_trainer#trl.experimental.a2po.A2POConfig), *optional*) : Configuration for this trainer. If `None`, a default configuration is used.
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/a2po/a2po_trainer.py#L361)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/a2po/a2po_config.py#L21)

**Parameters that control the model and reference model:**

model_init_kwargs (`dict[str, Any]`, *optional*) : Keyword arguments for [from_pretrained](https://huggingface.co/docs/transformers/v5.17.0/en/model_doc/auto#transformers.AutoModelForCausalLM.from_pretrained), used when the `model` argument of the [experimental.a2po.A2POTrainer](/docs/trl/v1.13.0/en/a2po_trainer#trl.experimental.a2po.A2POTrainer) is provided as a string. The `revision` value is also used when loading the processing class.
...
Configuration class for the [experimental.a2po.A2POTrainer](/docs/trl/v1.13.0/en/a2po_trainer#trl.experimental.a2po.A2POTrainer).
...
### Chat Templates
https://huggingface.co/docs/trl/v1.13.0/chat_templates.md
