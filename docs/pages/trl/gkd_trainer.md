...
The [experimental.gkd.GKDTrainer](/docs/trl/v1.13.0/en/gkd_trainer#trl.experimental.gkd.GKDTrainer) is a wrapper around the [SFTTrainer](/docs/trl/v1.13.0/en/sft_trainer#trl.SFTTrainer) class that takes in a teacher model argument. It needs three parameters to be set via the [experimental.gkd.GKDConfig](/docs/trl/v1.13.0/en/gkd_trainer#trl.experimental.gkd.GKDConfig) namely:
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/gkd/gkd_trainer.py#L55)
...
args ([experimental.gkd.GKDConfig](/docs/trl/v1.13.0/en/gkd_trainer#trl.experimental.gkd.GKDConfig), *optional*) : Training arguments.
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/gkd/gkd_config.py#L22)
...
Configuration class for [experimental.gkd.GKDTrainer](/docs/trl/v1.13.0/en/gkd_trainer#trl.experimental.gkd.GKDTrainer).
...
### Training with Jobs
https://huggingface.co/docs/trl/v1.13.0/jobs_training.md
