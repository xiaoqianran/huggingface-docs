...
generation_config ([GenerationConfig](https://huggingface.co/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig), *optional*) : The generation config to use for generating completions.
...
A [TrainerCallback](https://huggingface.co/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) that logs completions to Weights & Biases and/or Comet.
...
A [TrainerCallback](https://huggingface.co/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) that implements [BEMA](https://huggingface.co/papers/2508.00180)
...
generation_config ([GenerationConfig](https://huggingface.co/docs/transformers/v5.17.0/en/main_classes/text_generation#transformers.GenerationConfig), *optional*) : Generation config to use for generating completions.
...
A [TrainerCallback](https://huggingface.co/docs/transformers/v5.17.0/en/main_classes/callback#transformers.TrainerCallback) that logs traces and evaluations to W&B Weave. The callback uses
