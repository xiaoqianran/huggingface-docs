...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L146)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L234)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L303)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/_hf_argparser.py#L298)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L361)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L414)

**Parameters:**

mixture_config ([DatasetMixtureConfig](/docs/trl/v1.13.0/en/script_utils#trl.DatasetMixtureConfig)) : Script arguments containing dataset configuration.
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L40)
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/scripts/utils.py#L81)
...
https://huggingface.co/docs/trl/v1.13.0/reducing_memory_usage.md
