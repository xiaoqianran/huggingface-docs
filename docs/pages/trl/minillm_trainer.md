...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/experimental/minillm/minillm_trainer.py#L48)
...
args ([experimental.minillm.MiniLLMConfig](/docs/trl/v1.14.0/en/minillm_trainer#trl.experimental.minillm.MiniLLMConfig), *optional*) : Configuration for this trainer. If `None`, a default configuration is used.
...
Configuration class for [experimental.minillm.MiniLLMTrainer](/docs/trl/v1.14.0/en/minillm_trainer#trl.experimental.minillm.MiniLLMTrainer).

This class includes only the parameters that are specific to MiniLLM training. For a full list of training
arguments, please refer to the [TrainingArguments](https://huggingface.co/docs/transformers/v5.17.0/en/main_classes/trainer#transformers.TrainingArguments) and [GRPOConfig](/docs/trl/v1.14.0/en/grpo_trainer#trl.GRPOConfig) documentation.

### Unsloth Integration
https://huggingface.co/docs/trl/v1.14.0/unsloth_integration.md
