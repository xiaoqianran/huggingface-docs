...
This module contains some useful reward functions, primarily intended for use with the [GRPOTrainer](/docs/trl/v1.14.0/en/grpo_trainer#trl.GRPOTrainer) and [RLOOTrainer](/docs/trl/v1.14.0/en/rloo_trainer#trl.RLOOTrainer).
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/rewards/accuracy_rewards.py#L28)
...
- ****kwargs** : Additional keyword arguments. This function does not use them, but they are required in the function signature to ensure compatibility with trainers like [GRPOTrainer](/docs/trl/v1.14.0/en/grpo_trainer#trl.GRPOTrainer).
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/rewards/accuracy_rewards.py#L223)
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/rewards/accuracy_rewards.py#L118)
...
Correctness is determined by math verification (as in [accuracy_reward()](/docs/trl/v1.14.0/en/rewards#trl.rewards.accuracy_reward)), and the length is the number
...
parseable, the example is skipped (reward `None`), as in [accuracy_reward()](/docs/trl/v1.14.0/en/rewards#trl.rewards.accuracy_reward).
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/rewards/format_rewards.py#L18)
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/rewards/other_rewards.py#L18)
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/rewards/other_rewards.py#L83)
...
### MiniLLM Trainer
https://huggingface.co/docs/trl/v1.14.0/minillm_trainer.md
