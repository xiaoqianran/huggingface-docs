...
The [DPOTrainer](/docs/trl/v1.14.0/en/bema_for_reference_model#trl.DPOTrainer) implements preference learning from human feedback.
...
Pass the `quantization_config` directly to the trainer alongside `peft_config` — the trainer loads and quantizes the model for you. The same `quantization_config` argument is available on [SFTTrainer](/docs/trl/v1.14.0/en/sft_trainer#trl.SFTTrainer), [DPOTrainer](/docs/trl/v1.14.0/en/bema_for_reference_model#trl.DPOTrainer), [GRPOTrainer](/docs/trl/v1.14.0/en/grpo_trainer#trl.GRPOTrainer), and [RLOOTrainer](/docs/trl/v1.14.0/en/rloo_trainer#trl.RLOOTrainer).
...
https://huggingface.co/docs/trl/v1.14.0/speeding_up_training.md
