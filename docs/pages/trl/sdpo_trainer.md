...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/experimental/sdpo/sdpo_config.py#L24)
...
Configuration class for the [experimental.sdpo.SDPOTrainer](/docs/trl/v1.14.0/en/sdpo_trainer#trl.experimental.sdpo.SDPOTrainer).
...
[Source](https://github.com/huggingface/trl/blob/v1.14.0/trl/experimental/sdpo/sdpo_trainer.py#L322)
...
### GMPO
https://huggingface.co/docs/trl/v1.14.0/gmpo.md
