...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/sdpo/sdpo_config.py#L24)
...
model_init_kwargs (`dict[str, Any]`, *optional*) : Keyword arguments for `transformers.AutoModelForCausalLM.from_pretrained`, used when the `model` argument of the `SDPOTrainer` is provided as a string. The `revision` value is also used when loading processing classes.
...
Configuration class for the [experimental.sdpo.SDPOTrainer](/docs/trl/v1.13.0/en/sdpo_trainer#trl.experimental.sdpo.SDPOTrainer).
...
[Source](https://github.com/huggingface/trl/blob/v1.13.0/trl/experimental/sdpo/sdpo_trainer.py#L324)
...
### GMPO
https://huggingface.co/docs/trl/v1.13.0/gmpo.md
